...
type GetOAuthTokenRequest struct {
	...
	AuthorizationDetails credentials.AuthorizationDetailsArray
...
// without warning.
func (c *ApiClient) GetOAuthToken(authorizationDetails []credentials.AuthorizationDetails, token *oauth2.Token) (*credentials.OAuthToken, error) {
	path := "/oidc/v1/token"
