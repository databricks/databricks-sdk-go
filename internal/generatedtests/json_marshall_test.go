...
func TestJsonMarshall(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			value: jsonmarshallv2.RequiredFields{
				RequiredBool:      false,
				RequiredDuration:  *duration.New(0 * goTime.Second),
				RequiredFieldMask: fieldmask.FieldMask{Paths: []string{""}},
				RequiredInt32:     0,
				RequiredInt64:     0,
				RequiredListValue: []json.RawMessage{},
				RequiredMessage:   jsonmarshallv2.NestedMessage{},
				RequiredString:    "",
				RequiredStruct:    map[string]json.RawMessage{},
				RequiredTimestamp: *time.New(timeFromString("1970-01-01T00:00:00Z")),
