...
func (_m *MockLibrariesAPIInterface) UpdateAndWait(ctx context.Context, update compute.Update, options ...retries.Option[compute.ClusterLibraryStatuses]) error {
...
// MockLibrariesAPIInterface_UpdateAndWait_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateAndWait'
type MockLibrariesAPIInterface_UpdateAndWait_Call struct {
	*mock.Call
}
...
func (_e *MockLibrariesAPIInterface_Expecter) UpdateAndWait(ctx interface{}, update interface{}, options ...interface{}) *MockLibrariesAPIInterface_UpdateAndWait_Call {
	return &MockLibrariesAPIInterface_UpdateAndWait_Call{Call: _e.mock.On("UpdateAndWait",
		append([]interface{}{ctx, update}, options...)...)}
}

func (_c *MockLibrariesAPIInterface_UpdateAndWait_Call) Run(run func(ctx context.Context, update compute.Update, options ...retries.Option[compute.ClusterLibraryStatuses])) *MockLibrariesAPIInterface_UpdateAndWait_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockLibrariesAPIInterface_UpdateAndWait_Call) Return(_a0 error) *MockLibrariesAPIInterface_UpdateAndWait_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockLibrariesAPIInterface_UpdateAndWait_Call) RunAndReturn(run func(context.Context, compute.Update, ...retries.Option[compute.ClusterLibraryStatuses]) error) *MockLibrariesAPIInterface_UpdateAndWait_Call {
	_c.Call.Return(run)
	return _c
}
