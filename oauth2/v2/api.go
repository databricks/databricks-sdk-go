...
//
// This method is generated by Databricks SDK Code Generator.
func (a *AccountFederationPolicyAPI) List(ctx context.Context, request ListAccountFederationPoliciesRequest) listing.Iterator[FederationPolicy] {
	...
	getNextPage := func(ctx context.Context, req ListAccountFederationPoliciesRequest) (*ListFederationPoliciesResponse, error) {
		...
		return a.accountFederationPolicyImpl.List(ctx, req)
	}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *AccountFederationPolicyAPI) ListAll(ctx context.Context, request ListAccountFederationPoliciesRequest) ([]FederationPolicy, error) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ServicePrincipalFederationPolicyAPI) List(ctx context.Context, request ListServicePrincipalFederationPoliciesRequest) listing.Iterator[FederationPolicy] {
	...
	getNextPage := func(ctx context.Context, req ListServicePrincipalFederationPoliciesRequest) (*ListFederationPoliciesResponse, error) {
		ctx = useragent.InContext(ctx, "sdk-feature", "pagination")
		return a.servicePrincipalFederationPolicyImpl.List(ctx, req)
	}
	getItems := func(resp *ListFederationPoliciesResponse) []FederationPolicy {
		return resp.Policies
	}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ServicePrincipalFederationPolicyAPI) ListAll(ctx context.Context, request ListServicePrincipalFederationPoliciesRequest) ([]FederationPolicy, error) {
	iterator := a.List(ctx, request)
	return listing.ToSlice[FederationPolicy](ctx, iterator)
}
...
func (a *ServicePrincipalFederationPolicyAPI) ListByServicePrincipalId(ctx context.Context, servicePrincipalId int64) (*ListFederationPoliciesResponse, error) {
	return a.servicePrincipalFederationPolicyImpl.List(ctx, ListServicePrincipalFederationPoliciesRequest{
		ServicePrincipalId: servicePrincipalId,
	})
}
