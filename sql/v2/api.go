...
func NewAlerts(client *client.DatabricksClient,
) *AlertsAPI {
	return &AlertsAPI{
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *AlertsAPI) List(ctx context.Context, request ListAlertsRequest) listing.Iterator[ListAlertsResponseAlert] {

	getNextPage := func(ctx context.Context, req ListAlertsRequest) (*ListAlertsResponse, error) {
		ctx = useragent.InContext(ctx, "sdk-feature", "pagination")
		return a.alertsImpl.List(ctx, req)
	}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *AlertsAPI) ListAll(ctx context.Context, request ListAlertsRequest) ([]ListAlertsResponseAlert, error) {
...
func NewAlertsLegacy(client *client.DatabricksClient,
) *AlertsLegacyAPI {
...
func NewDashboardWidgets(client *client.DatabricksClient,
) *DashboardWidgetsAPI {
...
func NewDashboards(client *client.DatabricksClient,
) *DashboardsAPI {
...
func (a *DashboardsAPI) List(ctx context.Context, request ListDashboardsRequest) listing.Iterator[Dashboard] {
	...
	getNextPage := func(ctx context.Context, req ListDashboardsRequest) (*ListResponse, error) {
		ctx = useragent.InContext(ctx, "sdk-feature", "pagination")
		return a.dashboardsImpl.List(ctx, req)
	}
...
func NewDataSources(client *client.DatabricksClient,
) *DataSourcesAPI {
...
func NewDbsqlPermissions(client *client.DatabricksClient,
) *DbsqlPermissionsAPI {
...
func NewQueries(client *client.DatabricksClient,
) *QueriesAPI {
	return &QueriesAPI{
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *QueriesAPI) List(ctx context.Context, request ListQueriesRequest) listing.Iterator[ListQueryObjectsResponseQuery] {

	getNextPage := func(ctx context.Context, req ListQueriesRequest) (*ListQueryObjectsResponse, error) {
		ctx = useragent.InContext(ctx, "sdk-feature", "pagination")
		return a.queriesImpl.List(ctx, req)
	}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *QueriesAPI) ListAll(ctx context.Context, request ListQueriesRequest) ([]ListQueryObjectsResponseQuery, error) {
	iterator := a.List(ctx, request)
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *QueriesAPI) ListVisualizations(ctx context.Context, request ListVisualizationsForQueryRequest) listing.Iterator[Visualization] {

	getNextPage := func(ctx context.Context, req ListVisualizationsForQueryRequest) (*ListVisualizationsForQueryResponse, error) {
		ctx = useragent.InContext(ctx, "sdk-feature", "pagination")
		return a.queriesImpl.ListVisualizations(ctx, req)
	}
...
func (a *QueriesAPI) ListVisualizationsById(ctx context.Context, id string) (*ListVisualizationsForQueryResponse, error) {
	return a.queriesImpl.ListVisualizations(ctx, ListVisualizationsForQueryRequest{
		Id: id,
	})
}
...
func NewQueriesLegacy(client *client.DatabricksClient,
) *QueriesLegacyAPI {
...
//
// [Learn more]: https://docs.databricks.com/en/sql/dbsql-api-latest.html
func (a *QueriesLegacyAPI) List(ctx context.Context, request ListQueriesLegacyRequest) listing.Iterator[LegacyQuery] {

	request.Page = 1 // start iterating from the first page

	getNextPage := func(ctx context.Context, req ListQueriesLegacyRequest) (*QueryList, error) {
		ctx = useragent.InContext(ctx, "sdk-feature", "pagination")
		return a.queriesLegacyImpl.List(ctx, req)
	}
...
//
// [Learn more]: https://docs.databricks.com/en/sql/dbsql-api-latest.html
func (a *QueriesLegacyAPI) ListAll(ctx context.Context, request ListQueriesLegacyRequest) ([]LegacyQuery, error) {
	iterator := a.List(ctx, request)
...
func NewQueryHistory(client *client.DatabricksClient,
) *QueryHistoryAPI {
...
func NewQueryVisualizations(client *client.DatabricksClient,
...
func NewQueryVisualizationsLegacy(client *client.DatabricksClient,
...
func NewStatementExecution(client *client.DatabricksClient,
...
func NewWarehouses(client *client.DatabricksClient,
) *WarehousesAPI {
...
func (a *WarehousesAPI) List(ctx context.Context, request ListWarehousesRequest) listing.Iterator[EndpointInfo] {
	...
	getNextPage := func(ctx context.Context, req ListWarehousesRequest) (*ListWarehousesResponse, error) {
		ctx = useragent.InContext(ctx, "sdk-feature", "pagination")
		return a.warehousesImpl.List(ctx, req)
	}
