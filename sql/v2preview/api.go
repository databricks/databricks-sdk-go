...
// These APIs allow you to manage Alerts Legacy Preview, Alerts Preview, Dashboard Widgets Preview, Dashboards Preview, Data Sources Preview, Dbsql Permissions Preview, Queries Legacy Preview, Queries Preview, Query History Preview, Query Visualizations Legacy Preview, Query Visualizations Preview, Redash Config Preview, Statement Execution Preview, Warehouses Preview, etc.
package sqlpreview
...
type AlertsLegacyPreviewInterface interface {
	...
	// LegacyAlertNameToIdMap calls [AlertsLegacyPreviewAPI.List] and creates a map of results with [LegacyAlert].Name as key and [LegacyAlert].Id as value.
	//
	...
	// GetByName calls [AlertsLegacyPreviewAPI.LegacyAlertNameToIdMap] and returns a single [LegacyAlert].
	//
	// Returns an error if there's more than one [LegacyAlert] with the same .Name.
	//
...
func NewAlertsLegacyPreview(client *client.DatabricksClient) *AlertsLegacyPreviewAPI {
	return &AlertsLegacyPreviewAPI{
		alertsLegacyPreviewImpl: alertsLegacyPreviewImpl{
			client: client,
		},
	}
}
...
//
// [Learn more]: https://docs.databricks.com/en/sql/dbsql-api-latest.html
type AlertsLegacyPreviewAPI struct {
	alertsLegacyPreviewImpl
}
...
//
// [Learn more]: https://docs.databricks.com/en/sql/dbsql-api-latest.html
func (a *AlertsLegacyPreviewAPI) DeleteByAlertId(ctx context.Context, alertId string) error {
	return a.alertsLegacyPreviewImpl.Delete(ctx, DeleteAlertsLegacyRequest{
		AlertId: alertId,
	})
}
...
//
// [Learn more]: https://docs.databricks.com/en/sql/dbsql-api-latest.html
func (a *AlertsLegacyPreviewAPI) GetByAlertId(ctx context.Context, alertId string) (*LegacyAlert, error) {
	return a.alertsLegacyPreviewImpl.Get(ctx, GetAlertsLegacyRequest{
		AlertId: alertId,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *AlertsLegacyPreviewAPI) LegacyAlertNameToIdMap(ctx context.Context) (map[string]string, error) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *AlertsLegacyPreviewAPI) GetByName(ctx context.Context, name string) (*LegacyAlert, error) {
...
type AlertsPreviewInterface interface {
	...
	// ListAlertsResponseAlertDisplayNameToIdMap calls [AlertsPreviewAPI.ListAll] and creates a map of results with [ListAlertsResponseAlert].DisplayName as key and [ListAlertsResponseAlert].Id as value.
	//
	...
	// GetByDisplayName calls [AlertsPreviewAPI.ListAlertsResponseAlertDisplayNameToIdMap] and returns a single [ListAlertsResponseAlert].
	//
	// Returns an error if there's more than one [ListAlertsResponseAlert] with the same .DisplayName.
	//
...
func NewAlertsPreview(client *client.DatabricksClient) *AlertsPreviewAPI {
	return &AlertsPreviewAPI{
		alertsPreviewImpl: alertsPreviewImpl{
			client: client,
		},
	}
}
...
// searches and list views, and can no longer trigger. You can restore a trashed
// alert through the UI. A trashed alert is permanently deleted after 30 days.
func (a *AlertsPreviewAPI) DeleteById(ctx context.Context, id string) error {
	return a.alertsPreviewImpl.Delete(ctx, TrashAlertRequest{
		Id: id,
	})
}
...
//
// Gets an alert.
func (a *AlertsPreviewAPI) GetById(ctx context.Context, id string) (*Alert, error) {
	return a.alertsPreviewImpl.Get(ctx, GetAlertRequest{
		Id: id,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *AlertsPreviewAPI) ListAlertsResponseAlertDisplayNameToIdMap(ctx context.Context, request ListAlertsRequest) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *AlertsPreviewAPI) GetByDisplayName(ctx context.Context, name string) (*ListAlertsResponseAlert, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "get-by-name")
...
type DashboardWidgetsPreviewInterface interface {
...
func NewDashboardWidgetsPreview(client *client.DatabricksClient) *DashboardWidgetsPreviewAPI {
	return &DashboardWidgetsPreviewAPI{
		dashboardWidgetsPreviewImpl: dashboardWidgetsPreviewImpl{
			client: client,
		},
	}
}
...
// change over time.
type DashboardWidgetsPreviewAPI struct {
	dashboardWidgetsPreviewImpl
}

// Remove widget.
func (a *DashboardWidgetsPreviewAPI) DeleteById(ctx context.Context, id string) error {
	return a.dashboardWidgetsPreviewImpl.Delete(ctx, DeleteDashboardWidgetRequest{
		Id: id,
	})
}

type DashboardsPreviewInterface interface {
	...
	// DashboardNameToIdMap calls [DashboardsPreviewAPI.ListAll] and creates a map of results with [Dashboard].Name as key and [Dashboard].Id as value.
	//
	...
	// GetByName calls [DashboardsPreviewAPI.DashboardNameToIdMap] and returns a single [Dashboard].
	//
	// Returns an error if there's more than one [Dashboard] with the same .Name.
	//
...
func NewDashboardsPreview(client *client.DatabricksClient) *DashboardsPreviewAPI {
	return &DashboardsPreviewAPI{
		dashboardsPreviewImpl: dashboardsPreviewImpl{
			client: client,
		},
	}
}
...
type DashboardsPreviewAPI struct {
	dashboardsPreviewImpl
}
...
// Moves a dashboard to the trash. Trashed dashboards do not appear in list
// views or searches, and cannot be shared.
func (a *DashboardsPreviewAPI) DeleteByDashboardId(ctx context.Context, dashboardId string) error {
	return a.dashboardsPreviewImpl.Delete(ctx, DeleteDashboardRequest{
...
// Returns a JSON representation of a dashboard object, including its
// visualization and query objects.
func (a *DashboardsPreviewAPI) GetByDashboardId(ctx context.Context, dashboardId string) (*Dashboard, error) {
	return a.dashboardsPreviewImpl.Get(ctx, GetDashboardRequest{
		DashboardId: dashboardId,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *DashboardsPreviewAPI) DashboardNameToIdMap(ctx context.Context, request ListDashboardsRequest) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
	result, err := a.ListAll(ctx, request)
	if err != nil {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *DashboardsPreviewAPI) GetByName(ctx context.Context, name string) (*Dashboard, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "get-by-name")
...
type DataSourcesPreviewInterface interface {
	...
	// DataSourceNameToIdMap calls [DataSourcesPreviewAPI.List] and creates a map of results with [DataSource].Name as key and [DataSource].Id as value.
	//
	...
	// GetByName calls [DataSourcesPreviewAPI.DataSourceNameToIdMap] and returns a single [DataSource].
	//
	// Returns an error if there's more than one [DataSource] with the same .Name.
	//
...
func NewDataSourcesPreview(client *client.DatabricksClient) *DataSourcesPreviewAPI {
	return &DataSourcesPreviewAPI{
		dataSourcesPreviewImpl: dataSourcesPreviewImpl{
			client: client,
		},
	}
}
...
//
// [Learn more]: https://docs.databricks.com/en/sql/dbsql-api-latest.html
type DataSourcesPreviewAPI struct {
	dataSourcesPreviewImpl
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *DataSourcesPreviewAPI) DataSourceNameToIdMap(ctx context.Context) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
	result, err := a.List(ctx)
	if err != nil {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *DataSourcesPreviewAPI) GetByName(ctx context.Context, name string) (*DataSource, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "get-by-name")
	result, err := a.List(ctx)
	if err != nil {
		return nil, err
...
type DbsqlPermissionsPreviewInterface interface {
...
func NewDbsqlPermissionsPreview(client *client.DatabricksClient) *DbsqlPermissionsPreviewAPI {
	return &DbsqlPermissionsPreviewAPI{
		dbsqlPermissionsPreviewImpl: dbsqlPermissionsPreviewImpl{
			client: client,
		},
	}
}
...
//
// [Learn more]: https://docs.databricks.com/en/sql/dbsql-api-latest.html
type DbsqlPermissionsPreviewAPI struct {
	dbsqlPermissionsPreviewImpl
}
...
//
// [Learn more]: https://docs.databricks.com/en/sql/dbsql-api-latest.html
func (a *DbsqlPermissionsPreviewAPI) GetByObjectTypeAndObjectId(ctx context.Context, objectType ObjectTypePlural, objectId string) (*GetResponse, error) {
	return a.dbsqlPermissionsPreviewImpl.Get(ctx, GetDbsqlPermissionRequest{
		ObjectType: objectType,
		ObjectId:   objectId,
	})
}

type QueriesLegacyPreviewInterface interface {
	...
	// LegacyQueryNameToIdMap calls [QueriesLegacyPreviewAPI.ListAll] and creates a map of results with [LegacyQuery].Name as key and [LegacyQuery].Id as value.
	//
	...
	// GetByName calls [QueriesLegacyPreviewAPI.LegacyQueryNameToIdMap] and returns a single [LegacyQuery].
	//
	// Returns an error if there's more than one [LegacyQuery] with the same .Name.
	//
...
func NewQueriesLegacyPreview(client *client.DatabricksClient) *QueriesLegacyPreviewAPI {
	return &QueriesLegacyPreviewAPI{
		queriesLegacyPreviewImpl: queriesLegacyPreviewImpl{
			client: client,
		},
	}
}
...
//
// [Learn more]: https://docs.databricks.com/en/sql/dbsql-api-latest.html
type QueriesLegacyPreviewAPI struct {
	queriesLegacyPreviewImpl
}
...
//
// [Learn more]: https://docs.databricks.com/en/sql/dbsql-api-latest.html
func (a *QueriesLegacyPreviewAPI) DeleteByQueryId(ctx context.Context, queryId string) error {
	return a.queriesLegacyPreviewImpl.Delete(ctx, DeleteQueriesLegacyRequest{
		QueryId: queryId,
	})
}
...
//
// [Learn more]: https://docs.databricks.com/en/sql/dbsql-api-latest.html
func (a *QueriesLegacyPreviewAPI) GetByQueryId(ctx context.Context, queryId string) (*LegacyQuery, error) {
	return a.queriesLegacyPreviewImpl.Get(ctx, GetQueriesLegacyRequest{
		QueryId: queryId,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *QueriesLegacyPreviewAPI) LegacyQueryNameToIdMap(ctx context.Context, request ListQueriesLegacyRequest) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
	result, err := a.ListAll(ctx, request)
	if err != nil {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *QueriesLegacyPreviewAPI) GetByName(ctx context.Context, name string) (*LegacyQuery, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "get-by-name")
...
type QueriesPreviewInterface interface {
	...
	// ListQueryObjectsResponseQueryDisplayNameToIdMap calls [QueriesPreviewAPI.ListAll] and creates a map of results with [ListQueryObjectsResponseQuery].DisplayName as key and [ListQueryObjectsResponseQuery].Id as value.
	//
	...
	// GetByDisplayName calls [QueriesPreviewAPI.ListQueryObjectsResponseQueryDisplayNameToIdMap] and returns a single [ListQueryObjectsResponseQuery].
	//
	// Returns an error if there's more than one [ListQueryObjectsResponseQuery] with the same .DisplayName.
	//
...
func NewQueriesPreview(client *client.DatabricksClient) *QueriesPreviewAPI {
	return &QueriesPreviewAPI{
		queriesPreviewImpl: queriesPreviewImpl{
			client: client,
		},
	}
}
...
// trashed query through the UI. A trashed query is permanently deleted after 30
// days.
func (a *QueriesPreviewAPI) DeleteById(ctx context.Context, id string) error {
	return a.queriesPreviewImpl.Delete(ctx, TrashQueryRequest{
		Id: id,
	})
}
...
//
// Gets a query.
func (a *QueriesPreviewAPI) GetById(ctx context.Context, id string) (*Query, error) {
	return a.queriesPreviewImpl.Get(ctx, GetQueryRequest{
		Id: id,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *QueriesPreviewAPI) ListQueryObjectsResponseQueryDisplayNameToIdMap(ctx context.Context, request ListQueriesRequest) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
	result, err := a.ListAll(ctx, request)
	if err != nil {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *QueriesPreviewAPI) GetByDisplayName(ctx context.Context, name string) (*ListQueryObjectsResponseQuery, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "get-by-name")
...
//
// Gets a list of visualizations on a query.
func (a *QueriesPreviewAPI) ListVisualizationsById(ctx context.Context, id string) (*ListVisualizationsForQueryResponse, error) {
	return a.queriesPreviewImpl.internalListVisualizations(ctx, ListVisualizationsForQueryRequest{
		Id: id,
	})
}

type QueryHistoryPreviewInterface interface {
...
func NewQueryHistoryPreview(client *client.DatabricksClient) *QueryHistoryPreviewAPI {
	return &QueryHistoryPreviewAPI{
		queryHistoryPreviewImpl: queryHistoryPreviewImpl{
			client: client,
		},
	}
}
...
type QueryHistoryPreviewAPI struct {
	queryHistoryPreviewImpl
}

type QueryVisualizationsLegacyPreviewInterface interface {
...
func NewQueryVisualizationsLegacyPreview(client *client.DatabricksClient) *QueryVisualizationsLegacyPreviewAPI {
	return &QueryVisualizationsLegacyPreviewAPI{
		queryVisualizationsLegacyPreviewImpl: queryVisualizationsLegacyPreviewImpl{
			client: client,
		},
	}
}
...
//
// [Learn more]: https://docs.databricks.com/en/sql/dbsql-api-latest.html
type QueryVisualizationsLegacyPreviewAPI struct {
	queryVisualizationsLegacyPreviewImpl
}
...
//
// [Learn more]: https://docs.databricks.com/en/sql/dbsql-api-latest.html
func (a *QueryVisualizationsLegacyPreviewAPI) DeleteById(ctx context.Context, id string) error {
	return a.queryVisualizationsLegacyPreviewImpl.Delete(ctx, DeleteQueryVisualizationsLegacyRequest{
		Id: id,
	})
}

type QueryVisualizationsPreviewInterface interface {
...
func NewQueryVisualizationsPreview(client *client.DatabricksClient) *QueryVisualizationsPreviewAPI {
	return &QueryVisualizationsPreviewAPI{
		queryVisualizationsPreviewImpl: queryVisualizationsPreviewImpl{
			client: client,
		},
	}
}
...
type QueryVisualizationsPreviewAPI struct {
	queryVisualizationsPreviewImpl
}

// Remove a visualization.
//
// Removes a visualization.
func (a *QueryVisualizationsPreviewAPI) DeleteById(ctx context.Context, id string) error {
	return a.queryVisualizationsPreviewImpl.Delete(ctx, DeleteVisualizationRequest{
		Id: id,
	})
}

type RedashConfigPreviewInterface interface {

	// Read workspace configuration for Redash-v2.
	GetConfig(ctx context.Context) (*ClientConfig, error)
}

func NewRedashConfigPreview(client *client.DatabricksClient) *RedashConfigPreviewAPI {
	return &RedashConfigPreviewAPI{
		redashConfigPreviewImpl: redashConfigPreviewImpl{
			client: client,
		},
	}
}
...
type RedashConfigPreviewAPI struct {
	redashConfigPreviewImpl
}

type StatementExecutionPreviewInterface interface {
...
func NewStatementExecutionPreview(client *client.DatabricksClient) *StatementExecutionPreviewAPI {
	return &StatementExecutionPreviewAPI{
		statementExecutionPreviewImpl: statementExecutionPreviewImpl{
			client: client,
		},
	}
}
...
type StatementExecutionPreviewAPI struct {
	statementExecutionPreviewImpl
}
...
// **NOTE** This call currently might take up to 5 seconds to get the latest
// status and result.
func (a *StatementExecutionPreviewAPI) GetStatementByStatementId(ctx context.Context, statementId string) (*StatementResponse, error) {
	return a.statementExecutionPreviewImpl.GetStatement(ctx, GetStatementRequest{
...
// similarly includes the `next_chunk_index` and `next_chunk_internal_link`
// fields for simple iteration through the result set.
func (a *StatementExecutionPreviewAPI) GetStatementResultChunkNByStatementIdAndChunkIndex(ctx context.Context, statementId string, chunkIndex int) (*ResultData, error) {
	return a.statementExecutionPreviewImpl.GetStatementResultChunkN(ctx, GetStatementResultChunkNRequest{
		StatementId: statementId,
		ChunkIndex:  chunkIndex,
	})
}

type WarehousesPreviewInterface interface {
	...
	// EndpointInfoNameToIdMap calls [WarehousesPreviewAPI.ListAll] and creates a map of results with [EndpointInfo].Name as key and [EndpointInfo].Id as value.
	//
	...
	// GetByName calls [WarehousesPreviewAPI.EndpointInfoNameToIdMap] and returns a single [EndpointInfo].
	//
	// Returns an error if there's more than one [EndpointInfo] with the same .Name.
	//
...
func NewWarehousesPreview(client *client.DatabricksClient) *WarehousesPreviewAPI {
	return &WarehousesPreviewAPI{
		warehousesPreviewImpl: warehousesPreviewImpl{
			client: client,
		},
	}
}
...
type WarehousesPreviewAPI struct {
	warehousesPreviewImpl
}

// Delete a warehouse.
//
// Deletes a SQL warehouse.
func (a *WarehousesPreviewAPI) DeleteById(ctx context.Context, id string) error {
	return a.warehousesPreviewImpl.Delete(ctx, DeleteWarehouseRequest{
		Id: id,
	})
}
...
//
// Gets the information for a single SQL warehouse.
func (a *WarehousesPreviewAPI) GetById(ctx context.Context, id string) (*GetWarehouseResponse, error) {
	return a.warehousesPreviewImpl.Get(ctx, GetWarehouseRequest{
		Id: id,
	})
}
...
//
// Gets the permission levels that a user can have on an object.
func (a *WarehousesPreviewAPI) GetPermissionLevelsByWarehouseId(ctx context.Context, warehouseId string) (*GetWarehousePermissionLevelsResponse, error) {
	return a.warehousesPreviewImpl.GetPermissionLevels(ctx, GetWarehousePermissionLevelsRequest{
...
// Gets the permissions of a SQL warehouse. SQL warehouses can inherit
// permissions from their root object.
func (a *WarehousesPreviewAPI) GetPermissionsByWarehouseId(ctx context.Context, warehouseId string) (*WarehousePermissions, error) {
	return a.warehousesPreviewImpl.GetPermissions(ctx, GetWarehousePermissionsRequest{
		WarehouseId: warehouseId,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *WarehousesPreviewAPI) EndpointInfoNameToIdMap(ctx context.Context, request ListWarehousesRequest) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
	result, err := a.ListAll(ctx, request)
	if err != nil {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *WarehousesPreviewAPI) GetByName(ctx context.Context, name string) (*EndpointInfo, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "get-by-name")
