...
// These APIs allow you to manage Jobs Preview, Policy Compliance For Jobs Preview, etc.
package jobspreview
...
type JobsPreviewInterface interface {
	...
	// BaseJobSettingsNameToJobIdMap calls [JobsPreviewAPI.ListAll] and creates a map of results with [BaseJob].Settings.Name as key and [BaseJob].JobId as value.
	//
	...
	// GetBySettingsName calls [JobsPreviewAPI.BaseJobSettingsNameToJobIdMap] and returns a single [BaseJob].
	//
	// Returns an error if there's more than one [BaseJob] with the same .Settings.Name.
	//
...
func NewJobsPreview(client *client.DatabricksClient) *JobsPreviewAPI {
	return &JobsPreviewAPI{
		jobsPreviewImpl: jobsPreviewImpl{
			client: client,
		},
	}
}
...
// Cancels a job run or a task run. The run is canceled asynchronously, so it
// may still be running when this request completes.
func (a *JobsPreviewAPI) CancelRunByRunId(ctx context.Context, runId int64) error {
	return a.jobsPreviewImpl.CancelRun(ctx, CancelRun{
		RunId: runId,
	})
}
...
//
// Deletes a job.
func (a *JobsPreviewAPI) DeleteByJobId(ctx context.Context, jobId int64) error {
	return a.jobsPreviewImpl.Delete(ctx, DeleteJob{
		JobId: jobId,
	})
}
...
//
// Deletes a non-active run. Returns an error if the run is active.
func (a *JobsPreviewAPI) DeleteRunByRunId(ctx context.Context, runId int64) error {
	return a.jobsPreviewImpl.DeleteRun(ctx, DeleteRun{
		RunId: runId,
	})
}
...
// subsequent requests. Arrays with fewer than 100 elements in a page will be
// empty on later pages.
func (a *JobsPreviewAPI) GetByJobId(ctx context.Context, jobId int64) (*Job, error) {
	return a.jobsPreviewImpl.Get(ctx, GetJobRequest{
		JobId: jobId,
	})
}
...
//
// Gets the permission levels that a user can have on an object.
func (a *JobsPreviewAPI) GetPermissionLevelsByJobId(ctx context.Context, jobId string) (*GetJobPermissionLevelsResponse, error) {
	return a.jobsPreviewImpl.GetPermissionLevels(ctx, GetJobPermissionLevelsRequest{
		JobId: jobId,
	})
}
...
// Gets the permissions of a job. Jobs can inherit permissions from their root
// object.
func (a *JobsPreviewAPI) GetPermissionsByJobId(ctx context.Context, jobId string) (*JobPermissions, error) {
	return a.jobsPreviewImpl.GetPermissions(ctx, GetJobPermissionsRequest{
		JobId: jobId,
	})
}
...
// automatically removed after 60 days. If you to want to reference them beyond
// 60 days, you must save old run results before they expire.
func (a *JobsPreviewAPI) GetRunOutputByRunId(ctx context.Context, runId int64) (*RunOutput, error) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *JobsPreviewAPI) BaseJobSettingsNameToJobIdMap(ctx context.Context, request ListJobsRequest) (map[string]int64, error) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *JobsPreviewAPI) GetBySettingsName(ctx context.Context, name string) (*BaseJob, error) {
...
type PolicyComplianceForJobsPreviewInterface interface {
...
func NewPolicyComplianceForJobsPreview(client *client.DatabricksClient) *PolicyComplianceForJobsPreviewAPI {
	return &PolicyComplianceForJobsPreviewAPI{
		policyComplianceForJobsPreviewImpl: policyComplianceForJobsPreviewImpl{
			client: client,
		},
	}
}
...
type PolicyComplianceForJobsPreviewAPI struct {
	policyComplianceForJobsPreviewImpl
}
...
// edited and some of its job clusters no longer comply with their updated
// policies.
func (a *PolicyComplianceForJobsPreviewAPI) GetComplianceByJobId(ctx context.Context, jobId int64) (*GetPolicyComplianceResponse, error) {
	return a.policyComplianceForJobsPreviewImpl.GetCompliance(ctx, GetPolicyComplianceRequest{
		JobId: jobId,
	})
}
