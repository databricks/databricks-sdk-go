...
type KeyConfigurationsService interface {
	...
	// This operation is available only if your account is on the E2 version of
	// the platform.
	ListKeyConfigs(ctx context.Context, request ListKeyConfigsRequest) ([]CustomerManagedKey, error)

	// ListKeyConfigsByAccountId calls ListKeyConfigs, but directly with primitive function arguments,
	// instead of constructing request instance.
	//
	// This method is generated by Databricks SDK Code Generator.
	ListKeyConfigsByAccountId(ctx context.Context, accountId string) ([]CustomerManagedKey, error)
}
...
type NetworkConfigurationsService interface {
	...
	// This operation is available only if your account is on the E2 version of
	// the platform.
	ListNetworkConfigs(ctx context.Context, request ListNetworkConfigsRequest) ([]Network, error)

	// ListNetworkConfigsByAccountId calls ListNetworkConfigs, but directly with primitive function arguments,
	// instead of constructing request instance.
	//
	// This method is generated by Databricks SDK Code Generator.
	ListNetworkConfigsByAccountId(ctx context.Context, accountId string) ([]Network, error)

	// NetworkNetworkNameToNetworkIdMap retrieves a mapping to access ID by name
	//
	// This method is generated by Databricks SDK Code Generator.
	NetworkNetworkNameToNetworkIdMap(ctx context.Context, request ListNetworkConfigsRequest) (map[string]string, error)
...
type PrivateAccessSettingsService interface {
	...
	// (Public Preview). Contact your Databricks representative to enable your
	// account for PrivateLink.
	ListPrivateAccessSettings(ctx context.Context, request ListPrivateAccessSettingsRequest) ([]PrivateAccessSettings, error)

	// ListPrivateAccessSettingsByAccountId calls ListPrivateAccessSettings, but directly with primitive function arguments,
	// instead of constructing request instance.
	//
	// This method is generated by Databricks SDK Code Generator.
	ListPrivateAccessSettingsByAccountId(ctx context.Context, accountId string) ([]PrivateAccessSettings, error)

	// PrivateAccessSettingsPrivateAccessSettingsNameToPrivateAccessSettingsIdMap retrieves a mapping to access ID by name
	//
	// This method is generated by Databricks SDK Code Generator.
	PrivateAccessSettingsPrivateAccessSettingsNameToPrivateAccessSettingsIdMap(ctx context.Context, request ListPrivateAccessSettingsRequest) (map[string]string, error)
...
type StorageConfigurationsService interface {
	...
	// specified by ID.
	ListStorageConfigs(ctx context.Context, request ListStorageConfigsRequest) ([]StorageConfiguration, error)

	// ListStorageConfigsByAccountId calls ListStorageConfigs, but directly with primitive function arguments,
	// instead of constructing request instance.
	//
	// This method is generated by Databricks SDK Code Generator.
	ListStorageConfigsByAccountId(ctx context.Context, accountId string) ([]StorageConfiguration, error)

	// StorageConfigurationStorageConfigurationNameToStorageConfigurationIdMap retrieves a mapping to access ID by name
	//
	// This method is generated by Databricks SDK Code Generator.
	StorageConfigurationStorageConfigurationNameToStorageConfigurationIdMap(ctx context.Context, request ListStorageConfigsRequest) (map[string]string, error)
...
type VpcEndpointsService interface {
	...
	// (Public Preview). Contact your Databricks representative to enable your
	// account for PrivateLink.
	ListVpcEndpoints(ctx context.Context, request ListVpcEndpointsRequest) ([]VpcEndpoint, error)

	// ListVpcEndpointsByAccountId calls ListVpcEndpoints, but directly with primitive function arguments,
	// instead of constructing request instance.
	//
	// This method is generated by Databricks SDK Code Generator.
	ListVpcEndpointsByAccountId(ctx context.Context, accountId string) ([]VpcEndpoint, error)
}
...
type WorkspacesService interface {
	...
	// CreateWorkspaceAndWait calls CreateWorkspace() and waits to reach RUNNING state
	//
	// This method is generated by Databricks SDK Code Generator.
	CreateWorkspaceAndWait(ctx context.Context, request CreateWorkspaceRequest, options ...retries.Option[Workspace]) (*Workspace, error)
	...
	// DeleteWorkspaceByAccountIdAndWorkspaceId calls DeleteWorkspace, but directly with primitive function arguments,
	// instead of constructing request instance.
	//
	// This method is generated by Databricks SDK Code Generator.
	...
	// the platform or on a select custom plan that allows multiple workspaces
	// per account.
	GetAllWorkspaces(ctx context.Context, request GetAllWorkspacesRequest) ([]Workspace, error)

	// GetAllWorkspacesByAccountId calls GetAllWorkspaces, but directly with primitive function arguments,
	// instead of constructing request instance.
	//
	// This method is generated by Databricks SDK Code Generator.
	GetAllWorkspacesByAccountId(ctx context.Context, accountId string) ([]Workspace, error)

	// WorkspaceWorkspaceNameToWorkspaceIdMap retrieves a mapping to access ID by name
	//
	// This method is generated by Databricks SDK Code Generator.
	WorkspaceWorkspaceNameToWorkspaceIdMap(ctx context.Context, request GetAllWorkspacesRequest) (map[string]int64, error)

	// GetWorkspaceByWorkspaceName retrieves Workspace by name.
	//
	// This method is generated by Databricks SDK Code Generator.
	GetWorkspaceByWorkspaceName(ctx context.Context, name string) (*Workspace, error)
	...
	// GetWorkspaceByAccountIdAndWorkspaceId calls GetWorkspace, but directly with primitive function arguments,
	// instead of constructing request instance.
	//
	// This method is generated by Databricks SDK Code Generator.
	...
	// GetWorkspaceKeyHistoryByAccountIdAndWorkspaceId calls GetWorkspaceKeyHistory, but directly with primitive function arguments,
	// instead of constructing request instance.
	//
	// This method is generated by Databricks SDK Code Generator.
