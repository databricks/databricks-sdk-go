...
func (a *AccountIpAccessListsAPI) List(ctx context.Context) (it listing.Iterator[IpAccessListInfo]) {
	request := struct{}{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *IpAccessListsAPI) List(ctx context.Context) (it listing.Iterator[IpAccessListInfo]) {
	request := struct{}{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *TokenManagementAPI) List(ctx context.Context, request ListTokenManagementRequest) (it listing.Iterator[TokenInfo]) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *TokensAPI) List(ctx context.Context) (it listing.Iterator[TokenInfo]) {
	request := struct{}{}
