...
func (a *AccountIpAccessListsAPI) List(ctx context.Context) *listing.IteratorImpl[struct{}, *GetIpAccessListsResponse, IpAccessListInfo] {
	request := struct{}{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *IpAccessListsAPI) List(ctx context.Context) *listing.IteratorImpl[struct{}, *ListIpAccessListResponse, IpAccessListInfo] {
	request := struct{}{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *TokenManagementAPI) List(ctx context.Context, request ListTokenManagementRequest) *listing.IteratorImpl[ListTokenManagementRequest, *ListTokensResponse, TokenInfo] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *TokensAPI) List(ctx context.Context) *listing.IteratorImpl[struct{}, *ListTokensResponse, TokenInfo] {
	request := struct{}{}
