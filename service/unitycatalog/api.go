...
// a Metastore admin, the owner of the schema, or a user that has the USE_SCHEMA
...
// also be the owner or have the USE_CATALOG privilege on the parent catalog and
...
// ownership or USE_SCHEMA privilege on the Schema, provided that the user also
