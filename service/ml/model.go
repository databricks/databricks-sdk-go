...
// Get a batch of logged models
type GetLoggedModelsRequest struct {
	// The IDs of the logged models to retrieve. Max threshold is 100.
	ModelIds []string `json:"-" tf:"-"`
}

func (st *GetLoggedModelsRequest) UnmarshalJSON(b []byte) error {
	if st == nil {
		return fmt.Errorf("json.Unmarshal on nil pointer")
	}
	...
	tmp, err := getLoggedModelsRequestFromPb(pb)
	if err != nil {
		return err
	}
	*st = *tmp
...
func (st GetLoggedModelsRequest) MarshalJSON() ([]byte, error) {
	pb, err := getLoggedModelsRequestToPb(&st)
	if err != nil {
		return nil, err
	}
	return json.Marshal(pb)
...
func (st *GetLoggedModelsRequestResponse) UnmarshalJSON(b []byte) error {
	if st == nil {
		return fmt.Errorf("json.Unmarshal on nil pointer")
	}
	...
	tmp, err := getLoggedModelsRequestResponseFromPb(pb)
	if err != nil {
		return err
	}
	*st = *tmp
...
func (st GetLoggedModelsRequestResponse) MarshalJSON() ([]byte, error) {
	pb, err := getLoggedModelsRequestResponseToPb(&st)
	if err != nil {
		return nil, err
	}
	return json.Marshal(pb)
