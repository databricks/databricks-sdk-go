...
func listLoggedModelArtifactsRequestToPb(st *ListLoggedModelArtifactsRequest) (*listLoggedModelArtifactsRequestPb, error) {
	if st == nil {
		return nil, nil
	}
...
func listLoggedModelArtifactsRequestFromPb(pb *listLoggedModelArtifactsRequestPb) (*ListLoggedModelArtifactsRequest, error) {
	if pb == nil {
		return nil, nil
	}
	st := &ListLoggedModelArtifactsRequest{}
	st.ArtifactDirectoryPath = pb.ArtifactDirectoryPath
	st.ModelId = pb.ModelId
	st.PageToken = pb.PageToken
...
func (st *listLoggedModelArtifactsRequestPb) UnmarshalJSON(b []byte) error {
	return marshal.Unmarshal(b, st)
}

func (st listLoggedModelArtifactsRequestPb) MarshalJSON() ([]byte, error) {
	return marshal.Marshal(st)
}

func listLoggedModelArtifactsResponseToPb(st *ListLoggedModelArtifactsResponse) (*listLoggedModelArtifactsResponsePb, error) {
	if st == nil {
		return nil, nil
	}
...
func listLoggedModelArtifactsResponseFromPb(pb *listLoggedModelArtifactsResponsePb) (*ListLoggedModelArtifactsResponse, error) {
	if pb == nil {
		return nil, nil
	}
	st := &ListLoggedModelArtifactsResponse{}
	st.Files = pb.Files
	st.NextPageToken = pb.NextPageToken
	st.RootUri = pb.RootUri
...
func (st *listLoggedModelArtifactsResponsePb) UnmarshalJSON(b []byte) error {
	return marshal.Unmarshal(b, st)
}

func (st listLoggedModelArtifactsResponsePb) MarshalJSON() ([]byte, error) {
	return marshal.Marshal(st)
}
