...
func featureToPb(st *Feature) (*featurePb, error) {
	if st == nil {
		return nil, nil
	}
	pb := &featurePb{}
...
func featureFromPb(pb *featurePb) (*Feature, error) {
	if pb == nil {
		return nil, nil
	}
	st := &Feature{}
...
func featureListToPb(st *FeatureList) (*featureListPb, error) {
	if st == nil {
		return nil, nil
	}
	pb := &featureListPb{}
	pb.Features = st.Features
...
func featureListFromPb(pb *featureListPb) (*FeatureList, error) {
	if pb == nil {
		return nil, nil
	}
	st := &FeatureList{}
	st.Features = pb.Features
...
func modelVersionDatabricksToPb(st *ModelVersionDatabricks) (*modelVersionDatabricksPb, error) {
	...
	pb.CurrentStage = st.CurrentStage
	pb.Description = st.Description
	pb.EmailSubscriptionStatus = st.EmailSubscriptionStatus
	pb.FeatureList = st.FeatureList
	pb.LastUpdatedTimestamp = st.LastUpdatedTimestamp
	pb.Name = st.Name
	pb.OpenRequests = st.OpenRequests
	pb.PermissionLevel = st.PermissionLevel
	pb.RunId = st.RunId
	pb.RunLink = st.RunLink
	pb.Source = st.Source
...
func modelVersionDatabricksFromPb(pb *modelVersionDatabricksPb) (*ModelVersionDatabricks, error) {
	...
	st.CurrentStage = pb.CurrentStage
	st.Description = pb.Description
	st.EmailSubscriptionStatus = pb.EmailSubscriptionStatus
	st.FeatureList = pb.FeatureList
	st.LastUpdatedTimestamp = pb.LastUpdatedTimestamp
	st.Name = pb.Name
	st.OpenRequests = pb.OpenRequests
	st.PermissionLevel = pb.PermissionLevel
	st.RunId = pb.RunId
	st.RunLink = pb.RunLink
	st.Source = pb.Source
...
func transitionStageResponseToPb(st *TransitionStageResponse) (*transitionStageResponsePb, error) {
	...
	pb.ModelVersionDatabricks = st.ModelVersionDatabricks
...
func transitionStageResponseFromPb(pb *transitionStageResponsePb) (*TransitionStageResponse, error) {
	...
	st.ModelVersionDatabricks = pb.ModelVersionDatabricks
