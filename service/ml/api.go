...
type ExperimentsInterface interface {
	...
	// ``artifact_directory_path`` prefix which if specified, the response contains
	// only artifacts with the specified prefix.
	ListLoggedModelArtifactsByModelId(ctx context.Context, modelId string) (*ListLoggedModelArtifactsResponse, error)
...
// “artifact_directory_path“ prefix which if specified, the response contains
// only artifacts with the specified prefix.
func (a *ExperimentsAPI) ListLoggedModelArtifactsByModelId(ctx context.Context, modelId string) (*ListLoggedModelArtifactsResponse, error) {
	return a.experimentsImpl.ListLoggedModelArtifacts(ctx, ListLoggedModelArtifactsRequest{
		ModelId: modelId,
	})
}
