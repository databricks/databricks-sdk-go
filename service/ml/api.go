...
func (a *ExperimentsAPI) GetHistory(ctx context.Context, request GetHistoryRequest) *listing.IteratorImpl[GetHistoryRequest, *GetMetricHistoryResponse, Metric] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ExperimentsAPI) ListArtifacts(ctx context.Context, request ListArtifactsRequest) *listing.IteratorImpl[ListArtifactsRequest, *ListArtifactsResponse, FileInfo] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ExperimentsAPI) ListExperiments(ctx context.Context, request ListExperimentsRequest) *listing.IteratorImpl[ListExperimentsRequest, *ListExperimentsResponse, Experiment] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ExperimentsAPI) SearchExperiments(ctx context.Context, request SearchExperiments) *listing.IteratorImpl[SearchExperiments, *SearchExperimentsResponse, Experiment] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ExperimentsAPI) SearchRuns(ctx context.Context, request SearchRuns) *listing.IteratorImpl[SearchRuns, *SearchRunsResponse, Run] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ModelRegistryAPI) GetLatestVersions(ctx context.Context, request GetLatestVersionsRequest) *listing.IteratorImpl[GetLatestVersionsRequest, *GetLatestVersionsResponse, ModelVersion] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ModelRegistryAPI) ListModels(ctx context.Context, request ListModelsRequest) *listing.IteratorImpl[ListModelsRequest, *ListModelsResponse, Model] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ModelRegistryAPI) ListTransitionRequests(ctx context.Context, request ListTransitionRequestsRequest) *listing.IteratorImpl[ListTransitionRequestsRequest, *ListTransitionRequestsResponse, Activity] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ModelRegistryAPI) ListWebhooks(ctx context.Context, request ListWebhooksRequest) *listing.IteratorImpl[ListWebhooksRequest, *ListRegistryWebhooks, RegistryWebhook] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ModelRegistryAPI) SearchModelVersions(ctx context.Context, request SearchModelVersionsRequest) *listing.IteratorImpl[SearchModelVersionsRequest, *SearchModelVersionsResponse, ModelVersion] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ModelRegistryAPI) SearchModels(ctx context.Context, request SearchModelsRequest) *listing.IteratorImpl[SearchModelsRequest, *SearchModelsResponse, Model] {
