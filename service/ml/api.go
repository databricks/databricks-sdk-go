...
func (a *ExperimentsAPI) GetHistory(ctx context.Context, request GetHistoryRequest) *listing.Iterator[GetHistoryRequest, *GetMetricHistoryResponse, Metric] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ExperimentsAPI) ListArtifacts(ctx context.Context, request ListArtifactsRequest) *listing.Iterator[ListArtifactsRequest, *ListArtifactsResponse, FileInfo] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ExperimentsAPI) ListExperiments(ctx context.Context, request ListExperimentsRequest) *listing.Iterator[ListExperimentsRequest, *ListExperimentsResponse, Experiment] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ExperimentsAPI) SearchExperiments(ctx context.Context, request SearchExperiments) *listing.Iterator[SearchExperiments, *SearchExperimentsResponse, Experiment] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ExperimentsAPI) SearchRuns(ctx context.Context, request SearchRuns) *listing.Iterator[SearchRuns, *SearchRunsResponse, Run] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ModelRegistryAPI) GetLatestVersions(ctx context.Context, request GetLatestVersionsRequest) *listing.Iterator[GetLatestVersionsRequest, *GetLatestVersionsResponse, ModelVersion] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ModelRegistryAPI) ListModels(ctx context.Context, request ListModelsRequest) *listing.Iterator[ListModelsRequest, *ListModelsResponse, Model] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ModelRegistryAPI) ListTransitionRequests(ctx context.Context, request ListTransitionRequestsRequest) *listing.Iterator[ListTransitionRequestsRequest, *ListTransitionRequestsResponse, Activity] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ModelRegistryAPI) ListWebhooks(ctx context.Context, request ListWebhooksRequest) *listing.Iterator[ListWebhooksRequest, *ListRegistryWebhooks, RegistryWebhook] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ModelRegistryAPI) SearchModelVersions(ctx context.Context, request SearchModelVersionsRequest) *listing.Iterator[SearchModelVersionsRequest, *SearchModelVersionsResponse, ModelVersion] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ModelRegistryAPI) SearchModels(ctx context.Context, request SearchModelsRequest) *listing.Iterator[SearchModelsRequest, *SearchModelsResponse, Model] {
