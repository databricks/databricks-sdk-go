...
func (a *ExperimentsAPI) ListArtifactsAll(ctx context.Context, listing ListArtifactsRequest) ([]FileInfo, error) {
	var results []FileInfo
	request := ListArtifactsInternal{
		Path:    listing.Path,
		RunId:   listing.RunId,
		RunUuid: listing.RunUuid,
	}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ExperimentsAPI) ListExperimentsAll(ctx context.Context, listing ListExperimentsRequest) ([]Experiment, error) {
	var results []Experiment
	request := ListExperimentsInternal{
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ExperimentsAPI) SearchExperimentsAll(ctx context.Context, listing SearchExperiments) ([]Experiment, error) {
	var results []Experiment
	request := SearchExperimentsInternal{
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ExperimentsAPI) SearchRunsAll(ctx context.Context, listing SearchRuns) ([]Run, error) {
	var results []Run
	request := SearchRunsInternal{
		ExperimentIds: listing.ExperimentIds,
		Filter:        listing.Filter,
		MaxResults:    listing.MaxResults,
		OrderBy:       listing.OrderBy,
		RunViewType:   listing.RunViewType,
	}
	ctx = useragent.InContext(ctx, "sdk-feature", "pagination")
	for {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ModelRegistryAPI) GetLatestVersionsAll(ctx context.Context, listing GetLatestVersionsRequest) ([]ModelVersion, error) {
	response, err := a.impl.GetLatestVersions(ctx, listing)
	if err != nil {
		return nil, err
	}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ModelRegistryAPI) ListModelsAll(ctx context.Context, listing ListModelsRequest) ([]Model, error) {
	var results []Model
	request := ListModelsInternal{
		MaxResults: listing.MaxResults,
	}
	ctx = useragent.InContext(ctx, "sdk-feature", "pagination")
	for {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ModelRegistryAPI) ListTransitionRequestsAll(ctx context.Context, listing ListTransitionRequestsRequest) ([]Activity, error) {
	response, err := a.impl.ListTransitionRequests(ctx, listing)
	if err != nil {
		return nil, err
	}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ModelRegistryAPI) ListWebhooksAll(ctx context.Context, listing ListWebhooksRequest) ([]RegistryWebhook, error) {
	var results []RegistryWebhook
	request := ListWebhooksInternal{
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ModelRegistryAPI) SearchModelVersionsAll(ctx context.Context, listing SearchModelVersionsRequest) ([]ModelVersion, error) {
	var results []ModelVersion
	request := SearchModelVersionsInternal{
		Filter:     listing.Filter,
		MaxResults: listing.MaxResults,
		OrderBy:    listing.OrderBy,
	}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ModelRegistryAPI) SearchModelsAll(ctx context.Context, listing SearchModelsRequest) ([]Model, error) {
	var results []Model
	request := SearchModelsInternal{
		Filter:     listing.Filter,
		MaxResults: listing.MaxResults,
		OrderBy:    listing.OrderBy,
	}
