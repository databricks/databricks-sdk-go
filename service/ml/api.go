...
type FeatureEngineeringInterface interface {
	BackfillFeatures(ctx context.Context, request BackfillFeaturesRequest) (BackfillFeaturesOperationInterface, error)
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	ListKafkaConfigs(ctx context.Context, request ListKafkaConfigsRequest) listing.Iterator[KafkaConfig]
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	ListKafkaConfigsAll(ctx context.Context, request ListKafkaConfigsRequest) ([]KafkaConfig, error)

	// List materialized features.
	//
	// This method is generated by Databricks SDK Code Generator.
	ListMaterializedFeatures(ctx context.Context, request ListMaterializedFeaturesRequest) listing.Iterator[MaterializedFeature]

	// List materialized features.
	//
	// This method is generated by Databricks SDK Code Generator.
	ListMaterializedFeaturesAll(ctx context.Context, request ListMaterializedFeaturesRequest) ([]MaterializedFeature, error)

	// List Streams under a given catalog.schema parent.
	//
	// This method is generated by Databricks SDK Code Generator.
	ListStreams(ctx context.Context, request ListStreamsRequest) listing.Iterator[Stream]

	// List Streams under a given catalog.schema parent.
	//
	// This method is generated by Databricks SDK Code Generator.
	ListStreamsAll(ctx context.Context, request ListStreamsRequest) ([]Stream, error)

	PurgeFeatureEntities(ctx context.Context, request PurgeFeatureEntitiesRequest) (PurgeFeatureEntitiesOperationInterface, error)
...
func (a *FeatureEngineeringAPI) BackfillFeatures(ctx context.Context, request BackfillFeaturesRequest) (BackfillFeaturesOperationInterface, error) {
	operation, err := a.featureEngineeringImpl.BackfillFeatures(ctx, request)
	if err != nil {
		return nil, err
	}
	return &backfillFeaturesOperation{
		impl:      &a.featureEngineeringImpl,
		operation: operation,
	}, nil
}

type BackfillFeaturesOperationInterface interface {
	...
	Wait(ctx context.Context, opts ...api.Option) (*BackfillFeaturesResponse, error)
	...
	Metadata() (*BackfillOperationMetadata, error)
...
// didn't finish within the timeout, this function will return an error, otherwise
// returns successful response and any errors encountered.
func (a *backfillFeaturesOperation) Wait(ctx context.Context, opts ...api.Option) (*BackfillFeaturesResponse, error) {
	...
	call := func(ctx context.Context) error {
		...
		var backfillFeaturesResponse BackfillFeaturesResponse
		err = json.Unmarshal(operation.Response, &backfillFeaturesResponse)
		if err != nil {
			return fmt.Errorf("failed to unmarshal backfillFeaturesResponse response: %w", err)
		}

		result = &backfillFeaturesResponse
...
// Starts asynchronous cancellation on a long-running operation. The server
// makes a best effort to cancel the operation, but success is not guaranteed.
func (a *backfillFeaturesOperation) Cancel(ctx context.Context) error {
...
// Name returns the name of the long-running operation. The name is assigned
// by the server and is unique within the service from which the operation is created.
func (a *backfillFeaturesOperation) Name() string {
	return a.operation.Name
}

// Metadata returns metadata associated with the long-running operation.
// If the metadata is not available, the returned metadata and error are both nil.
func (a *backfillFeaturesOperation) Metadata() (*BackfillOperationMetadata, error) {
	if a.operation.Metadata == nil {
		return nil, nil
	}

	var metadata BackfillOperationMetadata
...
// Done reports whether the long-running operation has completed.
func (a *backfillFeaturesOperation) Done() (bool, error) {
...
func (a *FeatureEngineeringAPI) PurgeFeatureEntities(ctx context.Context, request PurgeFeatureEntitiesRequest) (PurgeFeatureEntitiesOperationInterface, error) {
	operation, err := a.featureEngineeringImpl.PurgeFeatureEntities(ctx, request)
	if err != nil {
		return nil, err
	}
...
type PurgeFeatureEntitiesOperationInterface interface {

	// Wait blocks until the long-running operation is completed. If no timeout is
	// specified, this will poll indefinitely. If a timeout is provided and the operation
	// didn't finish within the timeout, this function will return an error, otherwise
	// returns successful response and any errors encountered.
	Wait(ctx context.Context, opts ...api.Option) (*PurgeFeatureEntitiesResponse, error)
	...
	// Metadata returns metadata associated with the long-running operation.
	// If the metadata is not available, the returned metadata and error are both nil.
	Metadata() (*PurgeFeatureEntitiesMetadata, error)
...
// didn't finish within the timeout, this function will return an error, otherwise
// returns successful response and any errors encountered.
func (a *purgeFeatureEntitiesOperation) Wait(ctx context.Context, opts ...api.Option) (*PurgeFeatureEntitiesResponse, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "long-running")
	...
	call := func(ctx context.Context) error {
		...
		var purgeFeatureEntitiesResponse PurgeFeatureEntitiesResponse
		err = json.Unmarshal(operation.Response, &purgeFeatureEntitiesResponse)
		if err != nil {
			return fmt.Errorf("failed to unmarshal purgeFeatureEntitiesResponse response: %w", err)
		}

		result = &purgeFeatureEntitiesResponse
...
// Name returns the name of the long-running operation. The name is assigned
// by the server and is unique within the service from which the operation is created.
func (a *purgeFeatureEntitiesOperation) Name() string {
	return a.operation.Name
}

// Metadata returns metadata associated with the long-running operation.
// If the metadata is not available, the returned metadata and error are both nil.
func (a *purgeFeatureEntitiesOperation) Metadata() (*PurgeFeatureEntitiesMetadata, error) {
	if a.operation.Metadata == nil {
		return nil, nil
	}

	var metadata PurgeFeatureEntitiesMetadata
	err := json.Unmarshal(a.operation.Metadata, &metadata)
	if err != nil {
		return nil, fmt.Errorf("failed to unmarshal operation metadata: %w", err)
	}
...
// Done reports whether the long-running operation has completed.
func (a *purgeFeatureEntitiesOperation) Done() (bool, error) {
	// Refresh the operation state first
	operation, err := a.impl.GetOperation(context.Background(), GetOperationRequest{
		Name: a.operation.Name,
	})
