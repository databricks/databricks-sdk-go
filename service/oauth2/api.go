...
func (a *CustomAppIntegrationAPI) List(ctx context.Context) (it listing.Iterator[GetCustomAppIntegrationOutput]) {
	request := struct{}{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *OAuthPublishedAppsAPI) List(ctx context.Context, request ListOAuthPublishedAppsRequest) (it listing.Iterator[PublishedAppOutput]) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *PublishedAppIntegrationAPI) List(ctx context.Context) (it listing.Iterator[GetPublishedAppIntegrationOutput]) {
	request := struct{}{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ServicePrincipalSecretsAPI) List(ctx context.Context, request ListServicePrincipalSecretsRequest) (it listing.Iterator[SecretInfo]) {
