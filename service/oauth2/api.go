...
type ServicePrincipalSecretsProxyInterface interface {
...
func NewServicePrincipalSecretsProxy(client *client.DatabricksClient) *ServicePrincipalSecretsProxyAPI {
	return &ServicePrincipalSecretsProxyAPI{
		servicePrincipalSecretsProxyImpl: servicePrincipalSecretsProxyImpl{
			client: client,
		},
	}
}
...
// [Authentication using OAuth tokens for service principals]: https://docs.databricks.com/dev-tools/authentication-oauth.html
// [Databricks Terraform Provider]: https://github.com/databricks/terraform-provider-databricks/blob/master/docs/index.md#authenticating-with-service-principal
type ServicePrincipalSecretsProxyAPI struct {
	servicePrincipalSecretsProxyImpl
}
