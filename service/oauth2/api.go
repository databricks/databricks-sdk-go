...
func (a *CustomAppIntegrationAPI) List(ctx context.Context) *listing.IteratorImpl[struct{}, *GetCustomAppIntegrationsOutput, GetCustomAppIntegrationOutput] {
	request := struct{}{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *OAuthPublishedAppsAPI) List(ctx context.Context, request ListOAuthPublishedAppsRequest) *listing.IteratorImpl[ListOAuthPublishedAppsRequest, *GetPublishedAppsOutput, PublishedAppOutput] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *PublishedAppIntegrationAPI) List(ctx context.Context) *listing.IteratorImpl[struct{}, *GetPublishedAppIntegrationsOutput, GetPublishedAppIntegrationOutput] {
	request := struct{}{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ServicePrincipalSecretsAPI) List(ctx context.Context, request ListServicePrincipalSecretsRequest) *listing.IteratorImpl[ListServicePrincipalSecretsRequest, *ListServicePrincipalSecretsResponse, SecretInfo] {
