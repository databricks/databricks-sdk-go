...
type AccountSettingsV2Interface interface {
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	ListAccountUserPreferencesMetadata(ctx context.Context, request ListAccountUserPreferencesMetadataRequest) listing.Iterator[SettingsMetadata]
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	ListAccountUserPreferencesMetadataAll(ctx context.Context, request ListAccountUserPreferencesMetadataRequest) ([]SettingsMetadata, error)
