...
func (s *CreateUsagePolicyRequest) UnmarshalJSON(b []byte) error {
	return marshal.Unmarshal(b, s)
}

func (s CreateUsagePolicyRequest) MarshalJSON() ([]byte, error) {
	return marshal.Marshal(s)
}
...
func (s *ListUsagePoliciesRequest) UnmarshalJSON(b []byte) error {
	return marshal.Unmarshal(b, s)
}

func (s ListUsagePoliciesRequest) MarshalJSON() ([]byte, error) {
	return marshal.Marshal(s)
}
...
type ListUsagePoliciesResponse struct {
	...
	Policies []UsagePolicy `json:"policies,omitempty"`
	// A token that can be sent as `page_token` to retrieve the previous page.
	PreviousPageToken string `json:"previous_page_token,omitempty"`
...
func (s *ListUsagePoliciesResponse) UnmarshalJSON(b []byte) error {
	return marshal.Unmarshal(b, s)
}

func (s ListUsagePoliciesResponse) MarshalJSON() ([]byte, error) {
	return marshal.Marshal(s)
}
...
type UpdateBudgetPolicyRequest struct {
	...
	// unique.
	PolicyId string `json:"-" url:"-"`
	// Field mask specifying which fields to update. When not provided, all
	// fields are updated.
...
func (s UpdateBudgetPolicyRequest) MarshalJSON() ([]byte, error) {
	return marshal.Marshal(s)
}
...
func (s *UsagePolicy) UnmarshalJSON(b []byte) error {
	return marshal.Unmarshal(b, s)
}

func (s UsagePolicy) MarshalJSON() ([]byte, error) {
	return marshal.Marshal(s)
}
