...
func (a *BudgetsAPI) List(ctx context.Context) *listing.IteratorImpl[struct{}, *BudgetList, BudgetWithStatus] {
	request := struct{}{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *LogDeliveryAPI) List(ctx context.Context, request ListLogDeliveryRequest) *listing.IteratorImpl[ListLogDeliveryRequest, *WrappedLogDeliveryConfigurations, LogDeliveryConfiguration] {
