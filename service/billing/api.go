...
func (a *BudgetsAPI) List(ctx context.Context) (it listing.Iterator[BudgetWithStatus]) {
	request := struct{}{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *LogDeliveryAPI) List(ctx context.Context, request ListLogDeliveryRequest) (it listing.Iterator[LogDeliveryConfiguration]) {
