...
func (a *BudgetsAPI) List(ctx context.Context) *listing.Iterator[struct{}, *BudgetList, BudgetWithStatus] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *LogDeliveryAPI) List(ctx context.Context, request ListLogDeliveryRequest) *listing.Iterator[ListLogDeliveryRequest, *WrappedLogDeliveryConfigurations, LogDeliveryConfiguration] {
