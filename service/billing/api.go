...
func (a *BudgetsAPI) ListBudgets(ctx context.Context, request ListBudgetsRequest) (*BudgetList, error) {
...
func (a *BudgetsAPI) ListBudgetsAll(ctx context.Context, request ListBudgetsRequest) ([]BudgetWithStatus, error) {
	response, err := a.ListBudgets(ctx, request)
	if err != nil {
		return nil, err
	}
...
// Gets all budgets associated with this account, including noncumulative status
// for each day that the budget is configured to include.
func (a *BudgetsAPI) ListBudgetsByAccountId(ctx context.Context, accountId string) (*BudgetList, error) {
	return a.ListBudgets(ctx, ListBudgetsRequest{
		AccountId: accountId,
	})
}
...
// Gets all Databricks log delivery configurations associated with an account
// specified by ID.
func (a *LogDeliveryAPI) ListLogDeliveryConfigsByAccountId(ctx context.Context, accountId string) (*WrappedLogDeliveryConfigurations, error) {
	return a.ListLogDeliveryConfigs(ctx, ListLogDeliveryConfigsRequest{
		AccountId: accountId,
	})
}
