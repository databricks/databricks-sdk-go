...
// These APIs allow you to manage Billable Usage, Budget Policy, Budgets, Log Delivery, Usage Dashboards, Usage Policy, etc.
package billing
...
type UsagePolicyInterface interface {
	...
	// Retrieves a usage policy by it's ID.
	GetByPolicyId(ctx context.Context, policyId string) (*UsagePolicy, error)

	// Lists all usage policies. Policies are returned in the alphabetically
	// ascending order of their names.
	//
	// This method is generated by Databricks SDK Code Generator.
	List(ctx context.Context, request ListUsagePoliciesRequest) listing.Iterator[UsagePolicy]

	// Lists all usage policies. Policies are returned in the alphabetically
	// ascending order of their names.
	//
	// This method is generated by Databricks SDK Code Generator.
	ListAll(ctx context.Context, request ListUsagePoliciesRequest) ([]UsagePolicy, error)

	// Updates a usage policy
	Update(ctx context.Context, request UpdateUsagePolicyRequest) (*UsagePolicy, error)
}

func NewUsagePolicy(client *client.DatabricksClient) *UsagePolicyAPI {
	return &UsagePolicyAPI{
		usagePolicyImpl: usagePolicyImpl{
			client: client,
		},
	}
}
...
type UsagePolicyAPI struct {
	usagePolicyImpl
}

// Deletes a usage policy
func (a *UsagePolicyAPI) DeleteByPolicyId(ctx context.Context, policyId string) error {
	return a.usagePolicyImpl.Delete(ctx, DeleteUsagePolicyRequest{
		PolicyId: policyId,
	})
}

// Retrieves a usage policy by it's ID.
func (a *UsagePolicyAPI) GetByPolicyId(ctx context.Context, policyId string) (*UsagePolicy, error) {
	return a.usagePolicyImpl.Get(ctx, GetUsagePolicyRequest{
		PolicyId: policyId,
	})
}
