...
// BudgetWithStatusNameToBudgetIdMap calls [BudgetsAPI.ListBudgetsAll] and creates a map of results with [BudgetWithStatus].Name as key and [BudgetWithStatus].BudgetId as value.
//
// Note: All [BudgetWithStatus] are loaded into memory before creating a map.
//
// This method is generated by Databricks SDK Code Generator.
func (a *BudgetsAPI) BudgetWithStatusNameToBudgetIdMap(ctx context.Context) (map[string]string, error) {
	mapping := map[string]string{}
	result, err := a.ListBudgetsAll(ctx)
	if err != nil {
		return nil, err
	}
...
// GetBudgetWithStatusByName calls [BudgetsAPI.BudgetWithStatusNameToBudgetIdMap] and returns a single [BudgetWithStatus].
//
// Note: All [BudgetWithStatus] are loaded into memory before creating a map.
//
// This method is generated by Databricks SDK Code Generator.
...
// LogDeliveryConfigurationConfigNameToConfigIdMap calls [LogDeliveryAPI.ListLogDeliveryConfigsAll] and creates a map of results with [LogDeliveryConfiguration].ConfigName as key and [LogDeliveryConfiguration].ConfigId as value.
//
// Note: All [LogDeliveryConfiguration] are loaded into memory before creating a map.
//
// This method is generated by Databricks SDK Code Generator.
func (a *LogDeliveryAPI) LogDeliveryConfigurationConfigNameToConfigIdMap(ctx context.Context, request ListLogDeliveryConfigsRequest) (map[string]string, error) {
	mapping := map[string]string{}
	result, err := a.ListLogDeliveryConfigsAll(ctx, request)
	if err != nil {
		return nil, err
	}
	for _, v := range result {
		mapping[v.ConfigName] = v.ConfigId
	}
	return mapping, nil
}

// GetLogDeliveryConfigurationByConfigName calls [LogDeliveryAPI.LogDeliveryConfigurationConfigNameToConfigIdMap] and returns a single [LogDeliveryConfiguration].
//
// Note: All [LogDeliveryConfiguration] are loaded into memory before creating a map.
//
// This method is generated by Databricks SDK Code Generator.
func (a *LogDeliveryAPI) GetLogDeliveryConfigurationByConfigName(ctx context.Context, name string) (*LogDeliveryConfiguration, error) {
	result, err := a.ListLogDeliveryConfigsAll(ctx, ListLogDeliveryConfigsRequest{})
	if err != nil {
		return nil, err
	}
	for _, v := range result {
