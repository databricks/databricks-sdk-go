...
type BudgetsInterface interface {
	...
	List(ctx context.Context) *listing.PaginatingIterator[struct{}, *BudgetList, BudgetWithStatus]
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *BudgetsAPI) List(ctx context.Context) *listing.PaginatingIterator[struct{}, *BudgetList, BudgetWithStatus] {
	request := struct{}{}

	getNextPage := func(ctx context.Context, req struct{}) (*BudgetList, error) {
		ctx = useragent.InContext(ctx, "sdk-feature", "pagination")
		return a.impl.List(ctx)
	}
	getItems := func(resp *BudgetList) []BudgetWithStatus {
		return resp.Budgets
	}
...
func (a *BudgetsAPI) ListAll(ctx context.Context) ([]BudgetWithStatus, error) {
	iterator := a.List(ctx)
	return listing.ToSlice[BudgetWithStatus](ctx, iterator)
}
...
type LogDeliveryInterface interface {
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	List(ctx context.Context, request ListLogDeliveryRequest) *listing.PaginatingIterator[ListLogDeliveryRequest, *WrappedLogDeliveryConfigurations, LogDeliveryConfiguration]
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *LogDeliveryAPI) List(ctx context.Context, request ListLogDeliveryRequest) *listing.PaginatingIterator[ListLogDeliveryRequest, *WrappedLogDeliveryConfigurations, LogDeliveryConfiguration] {
