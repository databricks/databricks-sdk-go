...
type IpAccessListsService interface {
	...
	// Adds an IP access list for this workspace. A list can be an allow list or
	// a block list. See the top of this file for a description of how the
	// server treats allow lists and block lists at runtime. When creating or
	// updating an IP access list: * For all allow lists and block lists
	...
	// changes to take effect. **Note**: Your new IP access list has no effect
	...
	// Modifies an existing IP access list, specified by its ID. A list can
