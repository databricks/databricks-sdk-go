...
type CleanRoomsNotebookTaskCleanRoomsNotebookTaskOutput struct {
	...
	// Information on how to access the shared output schema for the clean room
	// run
	SharedOutputSchemaInfo *OutputSchemaInfo `json:"shared_output_schema_info,omitempty"`
}
