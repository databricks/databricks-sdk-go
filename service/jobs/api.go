...
func (a *JobsAPI) ListAll(ctx context.Context, listing ListJobsRequest) ([]BaseJob, error) {
	var results []BaseJob
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *JobsAPI) BaseJobSettingsNameToJobIdMap(ctx context.Context, listing ListJobsRequest) (map[string]int64, error) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *JobsAPI) ListRunsAll(ctx context.Context, listing ListRunsRequest) ([]BaseRun, error) {
	var results []BaseRun
	request := ListRunsInternal{
		ActiveOnly:    listing.ActiveOnly,
		...
		StartTimeTo:   listing.StartTimeTo,
	}
	var totalCount int = 0
	ctx = useragent.InContext(ctx, "sdk-feature", "pagination")
	for {
