...
//
// Note: All [Job] are loaded into memory before creating a map.
//
// This method is generated by Databricks SDK Code Generator.
func (a *JobsAPI) JobSettingsNameToJobIdMap(ctx context.Context, request ListRequest) (map[string]int64, error) {
	...
	for _, v := range result {
		mapping[v.Settings.Name] = v.JobId
	}
	return mapping, nil
}
