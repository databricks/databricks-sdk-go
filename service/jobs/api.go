...
//
// This method is generated by Databricks SDK Code Generator.
func (a *JobsAPI) List(ctx context.Context, request ListJobsRequest) *listing.PaginatingIterator[ListJobsRequest, *ListJobsResponse, BaseJob] {
...
func (a *JobsAPI) ListAll(ctx context.Context, request ListJobsRequest) ([]BaseJob, error) {
	...
	return listing.ToSliceN[BaseJob, int](ctx, iterator, request.Limit)
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *JobsAPI) ListRuns(ctx context.Context, request ListRunsRequest) *listing.PaginatingIterator[ListRunsRequest, *ListRunsResponse, BaseRun] {
...
func (a *JobsAPI) ListRunsAll(ctx context.Context, request ListRunsRequest) ([]BaseRun, error) {
	...
	return listing.ToSliceN[BaseRun, int](ctx, iterator, request.Limit)
