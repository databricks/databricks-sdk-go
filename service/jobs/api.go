...
// GetBySettingsName calls [JobsAPI.JobSettingsNameToJobIdMap] and returns a single [Job].
//
// Returns an error if there's more than one [Job] with the same .Settings.Name.
//
// Note: All [Job] instances are loaded into memory before returning matching by name.
//
// This method is generated by Databricks SDK Code Generator.
func (a *JobsAPI) GetBySettingsName(ctx context.Context, name string) (*Job, error) {
