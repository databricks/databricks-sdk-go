...
func (a *JobsAPI) List(ctx context.Context, request ListJobsRequest) *listing.IteratorImpl[ListJobsRequest, *ListJobsResponse, BaseJob] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *JobsAPI) ListRuns(ctx context.Context, request ListRunsRequest) *listing.IteratorImpl[ListRunsRequest, *ListRunsResponse, BaseRun] {
