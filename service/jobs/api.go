...
func (a *JobsAPI) List(ctx context.Context, request ListJobsRequest) (it listing.Iterator[BaseJob]) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *JobsAPI) ListRuns(ctx context.Context, request ListRunsRequest) (it listing.Iterator[BaseRun]) {
