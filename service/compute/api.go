...
type LibrariesInterface interface {
	...
	// jobs. This process will asynchronously generate a cache to optimize
	...
	// may be used by downstream workloads. Please ensure that the deletion is
	// intentional.
	DeleteDefaultBaseEnvironmentById(ctx context.Context, id string) error
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	ListDefaultBaseEnvironments(ctx context.Context, request ListDefaultBaseEnvironmentsRequest) listing.Iterator[DefaultBaseEnvironment]

	// List default base environments defined in the workspaces for the requested
	// user.
	//
	// This method is generated by Databricks SDK Code Generator.
	ListDefaultBaseEnvironmentsAll(ctx context.Context, request ListDefaultBaseEnvironmentsRequest) ([]DefaultBaseEnvironment, error)
	...
	// will asynchronously regenerate the caches. The existing caches remains
	// available until it expires.
	RefreshDefaultBaseEnvironmentsByIds(ctx context.Context, ids []string) error
...
// may be used by downstream workloads. Please ensure that the deletion is
// intentional.
func (a *LibrariesAPI) DeleteDefaultBaseEnvironmentById(ctx context.Context, id string) error {
	return a.librariesImpl.DeleteDefaultBaseEnvironment(ctx, DeleteDefaultBaseEnvironmentRequest{
		Id: id,
	})
}
...
// will asynchronously regenerate the caches. The existing caches remains
// available until it expires.
func (a *LibrariesAPI) RefreshDefaultBaseEnvironmentsByIds(ctx context.Context, ids []string) error {
	return a.librariesImpl.RefreshDefaultBaseEnvironments(ctx, RefreshDefaultBaseEnvironmentsRequest{
		Ids: ids,
	})
}
