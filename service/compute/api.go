...
type ClusterPoliciesAPIInterface interface {
	// WithImpl could be used to override low-level API implementations for unit
	// testing purposes with [github.com/golang/mock] or other mocking frameworks.
	WithImpl(impl ClusterPoliciesService) ClusterPoliciesAPIInterface
	...
	List(ctx context.Context, request ListClusterPoliciesRequest) *listing.PaginatingIterator[ListClusterPoliciesRequest, *ListPoliciesResponse, Policy]
...
// WithImpl could be used to override low-level API implementations for unit
// testing purposes with [github.com/golang/mock] or other mocking frameworks.
func (a *ClusterPoliciesAPI) WithImpl(impl ClusterPoliciesService) ClusterPoliciesAPIInterface {
	a.impl = impl
	return a
}
...
type ClustersAPIInterface interface {
	...
	Delete(ctx context.Context, deleteCluster DeleteCluster) (*WaitGetClusterTerminated[any], error)
	...
	Edit(ctx context.Context, editCluster EditCluster) (*WaitGetClusterRunning[any], error)
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	Events(ctx context.Context, request GetEvents) *listing.PaginatingIterator[GetEvents, *GetEventsResponse, ClusterEvent]
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	List(ctx context.Context, request ListClustersRequest) *listing.PaginatingIterator[ListClustersRequest, *ListClustersResponse, ClusterDetails]
	...
	Resize(ctx context.Context, resizeCluster ResizeCluster) (*WaitGetClusterRunning[any], error)
	...
	Restart(ctx context.Context, restartCluster RestartCluster) (*WaitGetClusterRunning[any], error)
	...
	Start(ctx context.Context, startCluster StartCluster) (*WaitGetClusterRunning[any], error)
...
// WithImpl could be used to override low-level API implementations for unit
// testing purposes with [github.com/golang/mock] or other mocking frameworks.
func (a *ClustersAPI) WithImpl(impl ClustersService) ClustersAPIInterface {
	a.impl = impl
	return a
}
...
type CommandExecutionAPIInterface interface {
	...
	Cancel(ctx context.Context, cancelCommand CancelCommand) (*WaitCommandStatusCommandExecutionCancelled[any], error)
...
// WithImpl could be used to override low-level API implementations for unit
// testing purposes with [github.com/golang/mock] or other mocking frameworks.
func (a *CommandExecutionAPI) WithImpl(impl CommandExecutionService) CommandExecutionAPIInterface {
	a.impl = impl
	return a
}
...
type GlobalInitScriptsAPIInterface interface {
	// WithImpl could be used to override low-level API implementations for unit
	// testing purposes with [github.com/golang/mock] or other mocking frameworks.
	WithImpl(impl GlobalInitScriptsService) GlobalInitScriptsAPIInterface
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	List(ctx context.Context) *listing.PaginatingIterator[struct{}, *ListGlobalInitScriptsResponse, GlobalInitScriptDetails]
...
// WithImpl could be used to override low-level API implementations for unit
// testing purposes with [github.com/golang/mock] or other mocking frameworks.
func (a *GlobalInitScriptsAPI) WithImpl(impl GlobalInitScriptsService) GlobalInitScriptsAPIInterface {
	a.impl = impl
	return a
}
...
type InstancePoolsAPIInterface interface {
	// WithImpl could be used to override low-level API implementations for unit
	// testing purposes with [github.com/golang/mock] or other mocking frameworks.
	WithImpl(impl InstancePoolsService) InstancePoolsAPIInterface
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	List(ctx context.Context) *listing.PaginatingIterator[struct{}, *ListInstancePools, InstancePoolAndStats]
...
// WithImpl could be used to override low-level API implementations for unit
// testing purposes with [github.com/golang/mock] or other mocking frameworks.
func (a *InstancePoolsAPI) WithImpl(impl InstancePoolsService) InstancePoolsAPIInterface {
	a.impl = impl
	return a
}
...
type InstanceProfilesAPIInterface interface {
	// WithImpl could be used to override low-level API implementations for unit
	// testing purposes with [github.com/golang/mock] or other mocking frameworks.
	WithImpl(impl InstanceProfilesService) InstanceProfilesAPIInterface
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	List(ctx context.Context) *listing.PaginatingIterator[struct{}, *ListInstanceProfilesResponse, InstanceProfile]
...
// WithImpl could be used to override low-level API implementations for unit
// testing purposes with [github.com/golang/mock] or other mocking frameworks.
func (a *InstanceProfilesAPI) WithImpl(impl InstanceProfilesService) InstanceProfilesAPIInterface {
	a.impl = impl
	return a
}
...
type LibrariesAPIInterface interface {
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	ClusterStatus(ctx context.Context, request ClusterStatusRequest) *listing.PaginatingIterator[ClusterStatusRequest, *ClusterLibraryStatuses, LibraryFullStatus]
...
// WithImpl could be used to override low-level API implementations for unit
// testing purposes with [github.com/golang/mock] or other mocking frameworks.
func (a *LibrariesAPI) WithImpl(impl LibrariesService) LibrariesAPIInterface {
	a.impl = impl
	return a
}
...
type PolicyFamiliesAPIInterface interface {
	// WithImpl could be used to override low-level API implementations for unit
	// testing purposes with [github.com/golang/mock] or other mocking frameworks.
	WithImpl(impl PolicyFamiliesService) PolicyFamiliesAPIInterface
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	List(ctx context.Context, request ListPolicyFamiliesRequest) *listing.PaginatingIterator[ListPolicyFamiliesRequest, *ListPolicyFamiliesResponse, PolicyFamily]
...
// WithImpl could be used to override low-level API implementations for unit
// testing purposes with [github.com/golang/mock] or other mocking frameworks.
func (a *PolicyFamiliesAPI) WithImpl(impl PolicyFamiliesService) PolicyFamiliesAPIInterface {
	a.impl = impl
	return a
}
