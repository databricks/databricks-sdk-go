...
func (a *ClusterPoliciesAPI) List(ctx context.Context, request ListClusterPoliciesRequest) *listing.PaginatingIterator[ListClusterPoliciesRequest, *ListPoliciesResponse, Policy] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ClustersAPI) Events(ctx context.Context, request GetEvents) *listing.PaginatingIterator[GetEvents, *GetEventsResponse, ClusterEvent] {
...
func (a *ClustersAPI) EventsAll(ctx context.Context, request GetEvents) ([]ClusterEvent, error) {
	...
	return listing.ToSliceN(ctx, iterator, request.Limit)
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ClustersAPI) List(ctx context.Context, request ListClustersRequest) *listing.PaginatingIterator[ListClustersRequest, *ListClustersResponse, ClusterDetails] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *GlobalInitScriptsAPI) List(ctx context.Context) *listing.PaginatingIterator[struct{}, *ListGlobalInitScriptsResponse, GlobalInitScriptDetails] {
	request := struct{}{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *InstancePoolsAPI) List(ctx context.Context) *listing.PaginatingIterator[struct{}, *ListInstancePools, InstancePoolAndStats] {
	request := struct{}{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *InstanceProfilesAPI) List(ctx context.Context) *listing.PaginatingIterator[struct{}, *ListInstanceProfilesResponse, InstanceProfile] {
	request := struct{}{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *LibrariesAPI) ClusterStatus(ctx context.Context, request ClusterStatusRequest) *listing.PaginatingIterator[ClusterStatusRequest, *ClusterLibraryStatuses, LibraryFullStatus] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *PolicyFamiliesAPI) List(ctx context.Context, request ListPolicyFamiliesRequest) *listing.PaginatingIterator[ListPolicyFamiliesRequest, *ListPolicyFamiliesResponse, PolicyFamily] {
...
func (a *PolicyFamiliesAPI) ListAll(ctx context.Context, request ListPolicyFamiliesRequest) ([]PolicyFamily, error) {
	iterator := a.List(ctx, request)
	return listing.ToSliceN(ctx, iterator, request.MaxResults)
