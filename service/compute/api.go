...
func (a *ClusterPoliciesAPI) List(ctx context.Context, request ListClusterPoliciesRequest) *listing.IteratorImpl[ListClusterPoliciesRequest, *ListPoliciesResponse, Policy] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ClustersAPI) Events(ctx context.Context, request GetEvents) *listing.IteratorImpl[GetEvents, *GetEventsResponse, ClusterEvent] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ClustersAPI) List(ctx context.Context, request ListClustersRequest) *listing.IteratorImpl[ListClustersRequest, *ListClustersResponse, ClusterDetails] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *GlobalInitScriptsAPI) List(ctx context.Context) *listing.IteratorImpl[struct{}, *ListGlobalInitScriptsResponse, GlobalInitScriptDetails] {
	request := struct{}{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *InstancePoolsAPI) List(ctx context.Context) *listing.IteratorImpl[struct{}, *ListInstancePools, InstancePoolAndStats] {
	request := struct{}{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *InstanceProfilesAPI) List(ctx context.Context) *listing.IteratorImpl[struct{}, *ListInstanceProfilesResponse, InstanceProfile] {
	request := struct{}{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *LibrariesAPI) ClusterStatus(ctx context.Context, request ClusterStatusRequest) *listing.IteratorImpl[ClusterStatusRequest, *ClusterLibraryStatuses, LibraryFullStatus] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *PolicyFamiliesAPI) List(ctx context.Context, request ListPolicyFamiliesRequest) *listing.IteratorImpl[ListPolicyFamiliesRequest, *ListPolicyFamiliesResponse, PolicyFamily] {
