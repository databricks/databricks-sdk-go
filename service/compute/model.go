...
const ListOrderAsc ListOrder = `ASC`

const ListOrderDesc ListOrder = `DESC`
...
type ListPolicies struct {
	...
	// by policy name.
	SortColumn PolicySortColumn `json:"-" url:"sort_column,omitempty"`
	...
	SortOrder ListOrder `json:"-" url:"sort_order,omitempty"`
}
...
func (s *ListPolicyFamilies) UnmarshalJSON(b []byte) error {
	return marshal.Unmarshal(b, s)
}

func (s ListPolicyFamilies) MarshalJSON() ([]byte, error) {
	return marshal.Marshal(s)
}
...
const PolicySortColumnPolicyCreationTime PolicySortColumn = `POLICY_CREATION_TIME`

const PolicySortColumnPolicyName PolicySortColumn = `POLICY_NAME`
...
// Set raw string value and validate it against allowed values
func (f *PolicySortColumn) Set(v string) error {
	switch v {
	case `POLICY_CREATION_TIME`, `POLICY_NAME`:
		*f = PolicySortColumn(v)
		return nil
	default:
...
// Type always returns PolicySortColumn to satisfy [pflag.Value] interface
func (f *PolicySortColumn) Type() string {
	return "PolicySortColumn"
}
