...
func (a *librariesImpl) GetDefaultBaseEnvironment(ctx context.Context, request GetDefaultBaseEnvironmentRequest) (*DefaultBaseEnvironment, error) {
	var defaultBaseEnvironment DefaultBaseEnvironment
	path := "/api/2.0/default-base-environments:getDefaultBaseEnvironment"
	queryParams := make(map[string]any)
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, request, &defaultBaseEnvironment)
	return &defaultBaseEnvironment, err
}
...
func (a *librariesImpl) UpdateDefaultDefaultBaseEnvironment(ctx context.Context, request UpdateDefaultDefaultBaseEnvironmentRequest) (*DefaultBaseEnvironment, error) {
	var defaultBaseEnvironment DefaultBaseEnvironment
	path := "/api/2.0/default-base-environments:setDefault"
	queryParams := make(map[string]any)
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
