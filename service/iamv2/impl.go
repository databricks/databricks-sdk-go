...
func (a *accountIamV2Impl) SyncGroup(ctx context.Context, request SyncGroupRequest) (*SyncGroupResponse, error) {
	var syncGroupResponse SyncGroupResponse
	path := fmt.Sprintf("/api/2.0/identity/accounts/%v/groups/syncByExternalId", a.client.ConfiguredAccountID())
	queryParams := make(map[string]any)
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, request, &syncGroupResponse)
	return &syncGroupResponse, err
}

func (a *accountIamV2Impl) SyncServicePrincipal(ctx context.Context, request SyncServicePrincipalRequest) (*SyncServicePrincipalResponse, error) {
	var syncServicePrincipalResponse SyncServicePrincipalResponse
	path := fmt.Sprintf("/api/2.0/identity/accounts/%v/servicePrincipals/syncByExternalId", a.client.ConfiguredAccountID())
	queryParams := make(map[string]any)
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, request, &syncServicePrincipalResponse)
	return &syncServicePrincipalResponse, err
}

func (a *accountIamV2Impl) SyncUser(ctx context.Context, request SyncUserRequest) (*SyncUserResponse, error) {
	var syncUserResponse SyncUserResponse
	path := fmt.Sprintf("/api/2.0/identity/accounts/%v/users/syncByExternalId", a.client.ConfiguredAccountID())
	queryParams := make(map[string]any)
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, request, &syncUserResponse)
...
func (a *workspaceIamV2Impl) SyncGroupProxy(ctx context.Context, request SyncGroupProxyRequest) (*SyncGroupResponse, error) {
	var syncGroupResponse SyncGroupResponse
	path := "/api/2.0/identity/groups/syncByExternalId"
	queryParams := make(map[string]any)
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
...
func (a *workspaceIamV2Impl) SyncServicePrincipalProxy(ctx context.Context, request SyncServicePrincipalProxyRequest) (*SyncServicePrincipalResponse, error) {
	var syncServicePrincipalResponse SyncServicePrincipalResponse
	path := "/api/2.0/identity/servicePrincipals/syncByExternalId"
	queryParams := make(map[string]any)
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
...
func (a *workspaceIamV2Impl) SyncUserProxy(ctx context.Context, request SyncUserProxyRequest) (*SyncUserResponse, error) {
	var syncUserResponse SyncUserResponse
	path := "/api/2.0/identity/users/syncByExternalId"
	queryParams := make(map[string]any)
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
