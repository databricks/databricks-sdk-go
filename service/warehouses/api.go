...
func NewQueryHistory(client *client.DatabricksClient) QueryHistoryService {
...
// ListQueriesAll returns all QueryInfo instances by calling ListQueries for every result page
//
