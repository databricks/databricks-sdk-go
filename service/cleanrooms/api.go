...
type CleanRoomTaskRunsInterface interface {
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	ListCleanRoomTaskRunsHandler(ctx context.Context, request ListCleanRoomTaskRunsRequest) listing.Iterator[CleanRoomTaskRun]

	// List all the historical task runs in a clean room.
	//
	// This method is generated by Databricks SDK Code Generator.
	ListCleanRoomTaskRunsHandlerAll(ctx context.Context, request ListCleanRoomTaskRunsRequest) ([]CleanRoomTaskRun, error)
}
