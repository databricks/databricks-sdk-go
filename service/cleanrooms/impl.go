...
func (a *cleanRoomAssetsImpl) Create(ctx context.Context, request CreateCleanRoomAssetRequest) (*CleanRoomAsset, error) {
	...
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb).Asset, &cleanRoomAssetPb)
	if err != nil {
		return nil, err
	}
	respField, err := cleanRoomAssetFromPb(&cleanRoomAssetPb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *cleanRoomAssetsImpl) Delete(ctx context.Context, request DeleteCleanRoomAssetRequest) error {
	...
	path := fmt.Sprintf("/api/2.0/clean-rooms/%v/assets/%v/%v", requestPb.CleanRoomName, requestPb.AssetType, requestPb.AssetFullName)
	queryParams := make(map[string]any)
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodDelete, path, headers, queryParams, (*requestPb), &deleteCleanRoomAssetResponsePb)
	if err != nil {
		return err
	}
...
func (a *cleanRoomAssetsImpl) Get(ctx context.Context, request GetCleanRoomAssetRequest) (*CleanRoomAsset, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &cleanRoomAssetPb)
	if err != nil {
		return nil, err
	}
	respField, err := cleanRoomAssetFromPb(&cleanRoomAssetPb)
...
func (a *cleanRoomAssetsImpl) internalList(ctx context.Context, request ListCleanRoomAssetsRequest) (*ListCleanRoomAssetsResponse, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &listCleanRoomAssetsResponsePb)
	if err != nil {
		return nil, err
	}
	respField, err := listCleanRoomAssetsResponseFromPb(&listCleanRoomAssetsResponsePb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *cleanRoomAssetsImpl) Update(ctx context.Context, request UpdateCleanRoomAssetRequest) (*CleanRoomAsset, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPatch, path, headers, queryParams, (*requestPb).Asset, &cleanRoomAssetPb)
	if err != nil {
		return nil, err
	}
	respField, err := cleanRoomAssetFromPb(&cleanRoomAssetPb)
...
func (a *cleanRoomTaskRunsImpl) internalList(ctx context.Context, request ListCleanRoomNotebookTaskRunsRequest) (*ListCleanRoomNotebookTaskRunsResponse, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &listCleanRoomNotebookTaskRunsResponsePb)
	if err != nil {
		return nil, err
	}
	respField, err := listCleanRoomNotebookTaskRunsResponseFromPb(&listCleanRoomNotebookTaskRunsResponsePb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *cleanRoomsImpl) Create(ctx context.Context, request CreateCleanRoomRequest) (*CleanRoom, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb).CleanRoom, &cleanRoomPb)
	if err != nil {
		return nil, err
	}
	respField, err := cleanRoomFromPb(&cleanRoomPb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *cleanRoomsImpl) CreateOutputCatalog(ctx context.Context, request CreateCleanRoomOutputCatalogRequest) (*CreateCleanRoomOutputCatalogResponse, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb).OutputCatalog, &createCleanRoomOutputCatalogResponsePb)
	if err != nil {
		return nil, err
	}
	respField, err := createCleanRoomOutputCatalogResponseFromPb(&createCleanRoomOutputCatalogResponsePb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *cleanRoomsImpl) Get(ctx context.Context, request GetCleanRoomRequest) (*CleanRoom, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &cleanRoomPb)
	if err != nil {
		return nil, err
	}
	respField, err := cleanRoomFromPb(&cleanRoomPb)
...
func (a *cleanRoomsImpl) internalList(ctx context.Context, request ListCleanRoomsRequest) (*ListCleanRoomsResponse, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &listCleanRoomsResponsePb)
	if err != nil {
		return nil, err
	}
	respField, err := listCleanRoomsResponseFromPb(&listCleanRoomsResponsePb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *cleanRoomsImpl) Update(ctx context.Context, request UpdateCleanRoomRequest) (*CleanRoom, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPatch, path, headers, queryParams, (*requestPb), &cleanRoomPb)
	if err != nil {
		return nil, err
	}
	respField, err := cleanRoomFromPb(&cleanRoomPb)
