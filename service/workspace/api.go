...
func (a *GitCredentialsAPI) List(ctx context.Context) *listing.IteratorImpl[struct{}, *GetCredentialsResponse, CredentialInfo] {
	request := struct{}{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ReposAPI) List(ctx context.Context, request ListReposRequest) *listing.IteratorImpl[ListReposRequest, *ListReposResponse, RepoInfo] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *SecretsAPI) ListAcls(ctx context.Context, request ListAclsRequest) *listing.IteratorImpl[ListAclsRequest, *ListAclsResponse, AclItem] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *SecretsAPI) ListScopes(ctx context.Context) *listing.IteratorImpl[struct{}, *ListScopesResponse, SecretScope] {
	request := struct{}{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *SecretsAPI) ListSecrets(ctx context.Context, request ListSecretsRequest) *listing.IteratorImpl[ListSecretsRequest, *ListSecretsResponse, SecretMetadata] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *WorkspaceAPI) List(ctx context.Context, request ListWorkspaceRequest) *listing.IteratorImpl[ListWorkspaceRequest, *ListResponse, ObjectInfo] {
