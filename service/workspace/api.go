...
type WorkspaceService interface {
	...
	// can only export a directory in ``DBC`` format. If the exported data
	...
	// download the exported file by enabling ``direct_download``: .. code ::
	...
	// &#34;path&#34;: &#34;/Users/user@example.com/&#34; } Example of response: .. code ::
	// json { &#34;objects&#34;: [ { &#34;path&#34;: &#34;/Users/user@example.com/project&#34;,
...
func New(client *client.DatabricksClient) WorkspaceService {
	return &WorkspaceAPI{
		client: client,
	}
}
...
// Gets the status of an object or a directory. If ``path`` does not exist,
// this call returns an error ``RESOURCE_DOES_NOT_EXIST``. Example of request:
// .. code :: json { &#34;path&#34;:
// &#34;/Users/user@example.com/project/ScaleExampleNotebook&#34; } Example of
// response: .. code :: json { &#34;path&#34;:
...
// &#34;/Users/user@example.com/project/ScalaExampleNotebook&#34;, &#34;language&#34;: &#34;SCALA&#34;,
// &#34;overwrite&#34;: true, &#34;format&#34;: &#34;SOURCE&#34; } Alternatively, one can import a
// local file directly: .. code :: shell curl -n -F
...
// input path, this call returns an error ``RESOURCE_ALREADY_EXISTS``. Note
