...
type GitCredentialsInterface interface {
	...
	List(ctx context.Context, request ListCredentialsRequest) listing.Iterator[CredentialInfo]

	// Lists the calling user's Git credentials.
	//
	// This method is generated by Databricks SDK Code Generator.
	ListAll(ctx context.Context, request ListCredentialsRequest) ([]CredentialInfo, error)
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	CredentialInfoGitProviderToCredentialIdMap(ctx context.Context, request ListCredentialsRequest) (map[string]int64, error)
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *GitCredentialsAPI) CredentialInfoGitProviderToCredentialIdMap(ctx context.Context, request ListCredentialsRequest) (map[string]int64, error) {
...
func (a *GitCredentialsAPI) GetByGitProvider(ctx context.Context, name string) (*CredentialInfo, error) {
	...
	result, err := a.ListAll(ctx, ListCredentialsRequest{})
	if err != nil {
		return nil, err
	}
