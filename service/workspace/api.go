...
func (a *GitCredentialsAPI) List(ctx context.Context) *listing.Iterator[struct{}, *GetCredentialsResponse, CredentialInfo] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ReposAPI) List(ctx context.Context, request ListReposRequest) *listing.Iterator[ListReposRequest, *ListReposResponse, RepoInfo] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *SecretsAPI) ListAcls(ctx context.Context, request ListAclsRequest) *listing.Iterator[ListAclsRequest, *ListAclsResponse, AclItem] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *SecretsAPI) ListScopes(ctx context.Context) *listing.Iterator[struct{}, *ListScopesResponse, SecretScope] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *SecretsAPI) ListSecrets(ctx context.Context, request ListSecretsRequest) *listing.Iterator[ListSecretsRequest, *ListSecretsResponse, SecretMetadata] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *WorkspaceAPI) List(ctx context.Context, request ListWorkspaceRequest) *listing.Iterator[ListWorkspaceRequest, *ListResponse, ObjectInfo] {
