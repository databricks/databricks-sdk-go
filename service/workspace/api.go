...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ReposAPI) ListAll(ctx context.Context, listing ListReposRequest) ([]RepoInfo, error) {
	var results []RepoInfo
	request := ListReposInternal{
		PathPrefix: listing.PathPrefix,
	}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ReposAPI) RepoInfoPathToIdMap(ctx context.Context, listing ListReposRequest) (map[string]int64, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]int64{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *SecretsAPI) ListAclsAll(ctx context.Context, listing ListAclsRequest) ([]AclItem, error) {
	response, err := a.impl.ListAcls(ctx, listing)
	if err != nil {
		return nil, err
	}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *SecretsAPI) ListSecretsAll(ctx context.Context, listing ListSecretsRequest) ([]SecretMetadata, error) {
	response, err := a.impl.ListSecrets(ctx, listing)
	if err != nil {
		return nil, err
	}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *WorkspaceAPI) ListAll(ctx context.Context, listing ListWorkspaceRequest) ([]ObjectInfo, error) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *WorkspaceAPI) ObjectInfoPathToObjectIdMap(ctx context.Context, listing ListWorkspaceRequest) (map[string]int64, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]int64{}
	result, err := a.ListAll(ctx, listing)
	if err != nil {
