...
func (a *credentialsImpl) Create(ctx context.Context, request CreateCredentialRequest) (*Credential, error) {
	...
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb), &credentialPb)
	if err != nil {
		return nil, err
	}
	respField, err := credentialFromPb(&credentialPb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *credentialsImpl) Get(ctx context.Context, request GetCredentialRequest) (*Credential, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &credentialPb)
	if err != nil {
		return nil, err
	}
	respField, err := credentialFromPb(&credentialPb)
...
func (a *credentialsImpl) List(ctx context.Context) ([]Credential, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, nil, nil, &credentialListPb)
	if err != nil {
		return nil, err
	}
	var resp []Credential
	for _, item := range credentialListPb {
		itemField, err := credentialFromPb(&item)
		if err != nil {
			return nil, err
		}
		if itemField != nil {
...
func (a *encryptionKeysImpl) Create(ctx context.Context, request CreateCustomerManagedKeyRequest) (*CustomerManagedKey, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb), &customerManagedKeyPb)
	if err != nil {
		return nil, err
	}
	respField, err := customerManagedKeyFromPb(&customerManagedKeyPb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *encryptionKeysImpl) Get(ctx context.Context, request GetEncryptionKeyRequest) (*CustomerManagedKey, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &customerManagedKeyPb)
	if err != nil {
		return nil, err
	}
	respField, err := customerManagedKeyFromPb(&customerManagedKeyPb)
...
func (a *encryptionKeysImpl) List(ctx context.Context) ([]CustomerManagedKey, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, nil, nil, &customerManagedKeyListPb)
	if err != nil {
		return nil, err
	}
	var resp []CustomerManagedKey
	for _, item := range customerManagedKeyListPb {
		itemField, err := customerManagedKeyFromPb(&item)
		if err != nil {
			return nil, err
		}
		if itemField != nil {
...
func (a *networksImpl) Create(ctx context.Context, request CreateNetworkRequest) (*Network, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb), &networkPb)
	if err != nil {
		return nil, err
	}
	respField, err := networkFromPb(&networkPb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *networksImpl) Get(ctx context.Context, request GetNetworkRequest) (*Network, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &networkPb)
	if err != nil {
		return nil, err
	}
	respField, err := networkFromPb(&networkPb)
...
func (a *networksImpl) List(ctx context.Context) ([]Network, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, nil, nil, &networkListPb)
	if err != nil {
		return nil, err
	}
	var resp []Network
	for _, item := range networkListPb {
		itemField, err := networkFromPb(&item)
		if err != nil {
			return nil, err
		}
		if itemField != nil {
...
func (a *privateAccessImpl) Create(ctx context.Context, request UpsertPrivateAccessSettingsRequest) (*PrivateAccessSettings, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb), &privateAccessSettingsPb)
	if err != nil {
		return nil, err
	}
	respField, err := privateAccessSettingsFromPb(&privateAccessSettingsPb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *privateAccessImpl) Get(ctx context.Context, request GetPrivateAccesRequest) (*PrivateAccessSettings, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &privateAccessSettingsPb)
	if err != nil {
		return nil, err
	}
	respField, err := privateAccessSettingsFromPb(&privateAccessSettingsPb)
...
func (a *privateAccessImpl) List(ctx context.Context) ([]PrivateAccessSettings, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, nil, nil, &privateAccessSettingsListPb)
	if err != nil {
		return nil, err
	}
	var resp []PrivateAccessSettings
	for _, item := range privateAccessSettingsListPb {
		itemField, err := privateAccessSettingsFromPb(&item)
		if err != nil {
			return nil, err
		}
		if itemField != nil {
...
func (a *storageImpl) Create(ctx context.Context, request CreateStorageConfigurationRequest) (*StorageConfiguration, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb), &storageConfigurationPb)
	if err != nil {
		return nil, err
	}
	respField, err := storageConfigurationFromPb(&storageConfigurationPb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *storageImpl) Get(ctx context.Context, request GetStorageRequest) (*StorageConfiguration, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &storageConfigurationPb)
	if err != nil {
		return nil, err
	}
	respField, err := storageConfigurationFromPb(&storageConfigurationPb)
...
func (a *storageImpl) List(ctx context.Context) ([]StorageConfiguration, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, nil, nil, &storageConfigurationListPb)
	if err != nil {
		return nil, err
	}
	var resp []StorageConfiguration
	for _, item := range storageConfigurationListPb {
		itemField, err := storageConfigurationFromPb(&item)
		if err != nil {
			return nil, err
		}
		if itemField != nil {
...
func (a *vpcEndpointsImpl) Create(ctx context.Context, request CreateVpcEndpointRequest) (*VpcEndpoint, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb), &vpcEndpointPb)
	if err != nil {
		return nil, err
	}
	respField, err := vpcEndpointFromPb(&vpcEndpointPb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *vpcEndpointsImpl) Get(ctx context.Context, request GetVpcEndpointRequest) (*VpcEndpoint, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &vpcEndpointPb)
	if err != nil {
		return nil, err
	}
	respField, err := vpcEndpointFromPb(&vpcEndpointPb)
...
func (a *vpcEndpointsImpl) List(ctx context.Context) ([]VpcEndpoint, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, nil, nil, &vpcEndpointListPb)
	if err != nil {
		return nil, err
	}
	var resp []VpcEndpoint
	for _, item := range vpcEndpointListPb {
		itemField, err := vpcEndpointFromPb(&item)
		if err != nil {
			return nil, err
		}
		if itemField != nil {
...
func (a *workspacesImpl) Create(ctx context.Context, request CreateWorkspaceRequest) (*Workspace, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb), &workspacePb)
	if err != nil {
		return nil, err
	}
	respField, err := workspaceFromPb(&workspacePb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *workspacesImpl) Get(ctx context.Context, request GetWorkspaceRequest) (*Workspace, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &workspacePb)
	if err != nil {
		return nil, err
	}
	respField, err := workspaceFromPb(&workspacePb)
...
func (a *workspacesImpl) List(ctx context.Context) ([]Workspace, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, nil, nil, &workspaceListPb)
	if err != nil {
		return nil, err
	}
	var resp []Workspace
	for _, item := range workspaceListPb {
		itemField, err := workspaceFromPb(&item)
		if err != nil {
			return nil, err
		}
		if itemField != nil {
