...
type VectorSearchEndpointsService interface {
	...
	// Update an endpoint
	PatchEndpoint(ctx context.Context, request PatchEndpointRequest) (*EndpointInfo, error)
...
//     Delta Table, automatically and incrementally updating the index as the
//     underlying data in the Delta Table changes.
//   - **Direct Vector Access Index**: An index that supports direct read and
