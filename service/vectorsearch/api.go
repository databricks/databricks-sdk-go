...
type VectorSearchEndpointsInterface interface {
	...
	ListEndpoints(ctx context.Context, request ListEndpointsRequest) *listing.PaginatingIterator[ListEndpointsRequest, *ListEndpointResponse, EndpointInfo]
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *VectorSearchEndpointsAPI) ListEndpoints(ctx context.Context, request ListEndpointsRequest) *listing.PaginatingIterator[ListEndpointsRequest, *ListEndpointResponse, EndpointInfo] {
...
type VectorSearchIndexesInterface interface {
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	ListIndexes(ctx context.Context, request ListIndexesRequest) *listing.PaginatingIterator[ListIndexesRequest, *ListVectorIndexesResponse, MiniVectorIndex]
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *VectorSearchIndexesAPI) ListIndexes(ctx context.Context, request ListIndexesRequest) *listing.PaginatingIterator[ListIndexesRequest, *ListVectorIndexesResponse, MiniVectorIndex] {
