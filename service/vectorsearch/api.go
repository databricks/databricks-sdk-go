...
type VectorSearchEndpointsInterface interface {
	...
	// Gets the permission levels that a user can have on an object.
	GetPermissionLevelsByEndpointId(ctx context.Context, endpointId string) (*GetVectorSearchEndpointPermissionLevelsResponse, error)
	...
	// Gets the permissions of a vector search endpoint. Vector search endpoints can
	// inherit permissions from their root object.
	GetPermissionsByEndpointId(ctx context.Context, endpointId string) (*VectorSearchEndpointPermissions, error)
...
// Gets the permission levels that a user can have on an object.
func (a *VectorSearchEndpointsAPI) GetPermissionLevelsByEndpointId(ctx context.Context, endpointId string) (*GetVectorSearchEndpointPermissionLevelsResponse, error) {
	return a.vectorSearchEndpointsImpl.GetPermissionLevels(ctx, GetVectorSearchEndpointPermissionLevelsRequest{
...
// Gets the permissions of a vector search endpoint. Vector search endpoints can
// inherit permissions from their root object.
func (a *VectorSearchEndpointsAPI) GetPermissionsByEndpointId(ctx context.Context, endpointId string) (*VectorSearchEndpointPermissions, error) {
	return a.vectorSearchEndpointsImpl.GetPermissions(ctx, GetVectorSearchEndpointPermissionsRequest{
		EndpointId: endpointId,
	})
}
