...
func getIndexRequestToPb(st *GetIndexRequest) (*getIndexRequestPb, error) {
	...
	pb.EnsureRerankerCompatible = st.EnsureRerankerCompatible
	pb.IndexName = st.IndexName
...
func getIndexRequestFromPb(pb *getIndexRequestPb) (*GetIndexRequest, error) {
	...
	st := &GetIndexRequest{}
	st.EnsureRerankerCompatible = pb.EnsureRerankerCompatible
	st.IndexName = pb.IndexName
...
func (st *getIndexRequestPb) UnmarshalJSON(b []byte) error {
	return marshal.Unmarshal(b, st)
}

func (st getIndexRequestPb) MarshalJSON() ([]byte, error) {
	return marshal.Marshal(st)
}
...
func rerankerConfigToPb(st *RerankerConfig) (*rerankerConfigPb, error) {
	if st == nil {
		return nil, nil
	}
	pb := &rerankerConfigPb{}
...
func rerankerConfigFromPb(pb *rerankerConfigPb) (*RerankerConfig, error) {
	if pb == nil {
		return nil, nil
	}
	st := &RerankerConfig{}
...
func (st *rerankerConfigPb) UnmarshalJSON(b []byte) error {
	return marshal.Unmarshal(b, st)
}

func (st rerankerConfigPb) MarshalJSON() ([]byte, error) {
	return marshal.Marshal(st)
}

func rerankerConfigRerankerParametersToPb(st *RerankerConfigRerankerParameters) (*rerankerConfigRerankerParametersPb, error) {
	if st == nil {
		return nil, nil
	}
...
type rerankerConfigRerankerParametersPb struct {
	ColumnsToRerank []string `json:"columns_to_rerank,omitempty"`
}

func rerankerConfigRerankerParametersFromPb(pb *rerankerConfigRerankerParametersPb) (*RerankerConfigRerankerParameters, error) {
	if pb == nil {
		return nil, nil
	}
	st := &RerankerConfigRerankerParameters{}
	st.ColumnsToRerank = pb.ColumnsToRerank
