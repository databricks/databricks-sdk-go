...
type AlertsService interface {
	...
	// restored.
	//
	// **Note:** Unlike queries and dashboards, alerts cannot be moved to the
	// trash.
	...
	// AlertNameToIdMap retrieves a mapping to access ID by name
	//
	// This method is generated by Databricks SDK Code Generator.
	AlertNameToIdMap(ctx context.Context) (map[string]string, error)

	// GetAlertByName retrieves Alert by name.
	//
	// This method is generated by Databricks SDK Code Generator.
...
type DashboardsService interface {
	...
	// DashboardNameToIdMap retrieves a mapping to access ID by name
	//
	// This method is generated by Databricks SDK Code Generator.
	DashboardNameToIdMap(ctx context.Context, request ListDashboardsRequest) (map[string]string, error)

	// GetDashboardByName retrieves Dashboard by name.
	//
	// This method is generated by Databricks SDK Code Generator.
...
type DataSourcesService interface {
	...
	// DataSourceNameToIdMap retrieves a mapping to access ID by name
	//
	// This method is generated by Databricks SDK Code Generator.
	DataSourceNameToIdMap(ctx context.Context) (map[string]string, error)

	// GetDataSourceByName retrieves DataSource by name.
	//
	// This method is generated by Databricks SDK Code Generator.
...
type QueriesService interface {
	...
	// QueryNameToIdMap retrieves a mapping to access ID by name
	//
	// This method is generated by Databricks SDK Code Generator.
	QueryNameToIdMap(ctx context.Context, request ListQueriesRequest) (map[string]string, error)

	// GetQueryByName retrieves Query by name.
	//
	// This method is generated by Databricks SDK Code Generator.
