...
func (a *alertsImpl) Create(ctx context.Context, request CreateAlertRequest) (*Alert, error) {
	...
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb), &alertPb)
	if err != nil {
		return nil, err
	}
	respField, err := alertFromPb(&alertPb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *alertsImpl) Get(ctx context.Context, request GetAlertRequest) (*Alert, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &alertPb)
	if err != nil {
		return nil, err
	}
	respField, err := alertFromPb(&alertPb)
...
func (a *alertsImpl) internalList(ctx context.Context, request ListAlertsRequest) (*ListAlertsResponse, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &listAlertsResponsePb)
	if err != nil {
		return nil, err
	}
	respField, err := listAlertsResponseFromPb(&listAlertsResponsePb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *alertsImpl) Update(ctx context.Context, request UpdateAlertRequest) (*Alert, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPatch, path, headers, queryParams, (*requestPb), &alertPb)
	if err != nil {
		return nil, err
	}
	respField, err := alertFromPb(&alertPb)
...
func (a *alertsLegacyImpl) Create(ctx context.Context, request CreateAlert) (*LegacyAlert, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb), &legacyAlertPb)
	if err != nil {
		return nil, err
	}
	respField, err := legacyAlertFromPb(&legacyAlertPb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *alertsLegacyImpl) Get(ctx context.Context, request GetAlertsLegacyRequest) (*LegacyAlert, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &legacyAlertPb)
	if err != nil {
		return nil, err
	}
	respField, err := legacyAlertFromPb(&legacyAlertPb)
...
func (a *alertsLegacyImpl) List(ctx context.Context) ([]LegacyAlert, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, nil, nil, &legacyAlertListPb)
	if err != nil {
		return nil, err
	}
	var resp []LegacyAlert
	for _, item := range legacyAlertListPb {
		itemField, err := legacyAlertFromPb(&item)
		if err != nil {
			return nil, err
		}
		if itemField != nil {
			resp = append(resp, *itemField)
		}
	}
...
func (a *alertsV2Impl) CreateAlert(ctx context.Context, request CreateAlertV2Request) (*AlertV2, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb), &alertV2Pb)
	if err != nil {
		return nil, err
	}
	respField, err := alertV2FromPb(&alertV2Pb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *alertsV2Impl) GetAlert(ctx context.Context, request GetAlertV2Request) (*AlertV2, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &alertV2Pb)
	if err != nil {
		return nil, err
	}
	respField, err := alertV2FromPb(&alertV2Pb)
...
func (a *alertsV2Impl) internalListAlerts(ctx context.Context, request ListAlertsV2Request) (*ListAlertsV2Response, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &listAlertsV2ResponsePb)
	if err != nil {
		return nil, err
	}
	respField, err := listAlertsV2ResponseFromPb(&listAlertsV2ResponsePb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *alertsV2Impl) UpdateAlert(ctx context.Context, request UpdateAlertV2Request) (*AlertV2, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPatch, path, headers, queryParams, (*requestPb), &alertV2Pb)
	if err != nil {
		return nil, err
	}
	respField, err := alertV2FromPb(&alertV2Pb)
...
func (a *dashboardWidgetsImpl) Create(ctx context.Context, request CreateWidget) (*Widget, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb), &widgetPb)
	if err != nil {
		return nil, err
	}
	respField, err := widgetFromPb(&widgetPb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *dashboardsImpl) internalList(ctx context.Context, request ListDashboardsRequest) (*ListResponse, error) {
	...
	respField, err := listResponseFromPb(&listResponsePb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *dashboardsImpl) Restore(ctx context.Context, request RestoreDashboardRequest) error {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, nil, &restoreResponsePb)
	if err != nil {
		return err
	}
...
func (a *dataSourcesImpl) List(ctx context.Context) ([]DataSource, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, nil, nil, &dataSourceListPb)
	if err != nil {
		return nil, err
	}
	var resp []DataSource
	for _, item := range dataSourceListPb {
		itemField, err := dataSourceFromPb(&item)
		if err != nil {
			return nil, err
		}
		if itemField != nil {
...
func (a *dbsqlPermissionsImpl) Get(ctx context.Context, request GetDbsqlPermissionRequest) (*GetResponse, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &getResponsePb)
	if err != nil {
		return nil, err
	}
	respField, err := getResponseFromPb(&getResponsePb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *dbsqlPermissionsImpl) Set(ctx context.Context, request SetRequest) (*SetResponse, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb), &setResponsePb)
	if err != nil {
		return nil, err
	}
	respField, err := setResponseFromPb(&setResponsePb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *dbsqlPermissionsImpl) TransferOwnership(ctx context.Context, request TransferOwnershipRequest) (*Success, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb), &successPb)
	if err != nil {
		return nil, err
	}
	respField, err := successFromPb(&successPb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *queriesImpl) Create(ctx context.Context, request CreateQueryRequest) (*Query, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb), &queryPb)
	if err != nil {
		return nil, err
	}
	respField, err := queryFromPb(&queryPb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *queriesImpl) Get(ctx context.Context, request GetQueryRequest) (*Query, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &queryPb)
	if err != nil {
		return nil, err
	}
	respField, err := queryFromPb(&queryPb)
...
func (a *queriesImpl) internalList(ctx context.Context, request ListQueriesRequest) (*ListQueryObjectsResponse, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &listQueryObjectsResponsePb)
	if err != nil {
		return nil, err
	}
	respField, err := listQueryObjectsResponseFromPb(&listQueryObjectsResponsePb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *queriesImpl) internalListVisualizations(ctx context.Context, request ListVisualizationsForQueryRequest) (*ListVisualizationsForQueryResponse, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &listVisualizationsForQueryResponsePb)
	if err != nil {
		return nil, err
	}
	respField, err := listVisualizationsForQueryResponseFromPb(&listVisualizationsForQueryResponsePb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *queriesImpl) Update(ctx context.Context, request UpdateQueryRequest) (*Query, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPatch, path, headers, queryParams, (*requestPb), &queryPb)
	if err != nil {
		return nil, err
	}
	respField, err := queryFromPb(&queryPb)
...
func (a *queriesLegacyImpl) Create(ctx context.Context, request QueryPostContent) (*LegacyQuery, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb), &legacyQueryPb)
	if err != nil {
		return nil, err
	}
	respField, err := legacyQueryFromPb(&legacyQueryPb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *queriesLegacyImpl) Get(ctx context.Context, request GetQueriesLegacyRequest) (*LegacyQuery, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &legacyQueryPb)
	if err != nil {
		return nil, err
	}
	respField, err := legacyQueryFromPb(&legacyQueryPb)
...
func (a *queriesLegacyImpl) internalList(ctx context.Context, request ListQueriesLegacyRequest) (*QueryList, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &queryListPb)
	if err != nil {
		return nil, err
	}
	respField, err := queryListFromPb(&queryListPb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *queryHistoryImpl) List(ctx context.Context, request ListQueryHistoryRequest) (*ListQueriesResponse, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &listQueriesResponsePb)
	if err != nil {
		return nil, err
	}
	respField, err := listQueriesResponseFromPb(&listQueriesResponsePb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *queryVisualizationsImpl) Create(ctx context.Context, request CreateVisualizationRequest) (*Visualization, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb), &visualizationPb)
	if err != nil {
		return nil, err
	}
	respField, err := visualizationFromPb(&visualizationPb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *queryVisualizationsImpl) Update(ctx context.Context, request UpdateVisualizationRequest) (*Visualization, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPatch, path, headers, queryParams, (*requestPb), &visualizationPb)
	if err != nil {
		return nil, err
	}
	respField, err := visualizationFromPb(&visualizationPb)
...
func (a *queryVisualizationsLegacyImpl) Create(ctx context.Context, request CreateQueryVisualizationsLegacyRequest) (*LegacyVisualization, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb), &legacyVisualizationPb)
	if err != nil {
		return nil, err
	}
	respField, err := legacyVisualizationFromPb(&legacyVisualizationPb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *redashConfigImpl) GetConfig(ctx context.Context) (*ClientConfig, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, nil, nil, &clientConfigPb)
	if err != nil {
		return nil, err
	}
	respField, err := clientConfigFromPb(&clientConfigPb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *statementExecutionImpl) CancelExecution(ctx context.Context, request CancelExecutionRequest) error {
	...
	queryParams := make(map[string]any)
	headers := make(map[string]string)
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, nil, &cancelExecutionResponsePb)
	if err != nil {
		return err
	}
...
func (a *statementExecutionImpl) ExecuteStatement(ctx context.Context, request ExecuteStatementRequest) (*StatementResponse, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb), &statementResponsePb)
	if err != nil {
		return nil, err
	}
	respField, err := StatementResponseFromPb(&statementResponsePb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *statementExecutionImpl) GetStatement(ctx context.Context, request GetStatementRequest) (*StatementResponse, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &statementResponsePb)
	if err != nil {
		return nil, err
	}
	respField, err := StatementResponseFromPb(&statementResponsePb)
...
func (a *statementExecutionImpl) GetStatementResultChunkN(ctx context.Context, request GetStatementResultChunkNRequest) (*ResultData, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &resultDataPb)
	if err != nil {
		return nil, err
	}
	respField, err := resultDataFromPb(&resultDataPb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *warehousesImpl) Create(ctx context.Context, request CreateWarehouseRequest) (*CreateWarehouseResponse, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb), &createWarehouseResponsePb)
	if err != nil {
		return nil, err
	}
	respField, err := createWarehouseResponseFromPb(&createWarehouseResponsePb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *warehousesImpl) Delete(ctx context.Context, request DeleteWarehouseRequest) error {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodDelete, path, headers, queryParams, (*requestPb), &deleteWarehouseResponsePb)
	if err != nil {
		return err
	}
...
func (a *warehousesImpl) Edit(ctx context.Context, request EditWarehouseRequest) error {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, (*requestPb), &editWarehouseResponsePb)
	if err != nil {
		return err
	}
...
func (a *warehousesImpl) Get(ctx context.Context, request GetWarehouseRequest) (*GetWarehouseResponse, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &getWarehouseResponsePb)
	if err != nil {
		return nil, err
	}
	respField, err := getWarehouseResponseFromPb(&getWarehouseResponsePb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *warehousesImpl) GetPermissionLevels(ctx context.Context, request GetWarehousePermissionLevelsRequest) (*GetWarehousePermissionLevelsResponse, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &getWarehousePermissionLevelsResponsePb)
	if err != nil {
		return nil, err
	}
	respField, err := getWarehousePermissionLevelsResponseFromPb(&getWarehousePermissionLevelsResponsePb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *warehousesImpl) GetPermissions(ctx context.Context, request GetWarehousePermissionsRequest) (*WarehousePermissions, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &warehousePermissionsPb)
	if err != nil {
		return nil, err
	}
	respField, err := warehousePermissionsFromPb(&warehousePermissionsPb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *warehousesImpl) GetWorkspaceWarehouseConfig(ctx context.Context) (*GetWorkspaceWarehouseConfigResponse, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, nil, nil, &getWorkspaceWarehouseConfigResponsePb)
	if err != nil {
		return nil, err
	}
	respField, err := getWorkspaceWarehouseConfigResponseFromPb(&getWorkspaceWarehouseConfigResponsePb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *warehousesImpl) internalList(ctx context.Context, request ListWarehousesRequest) (*ListWarehousesResponse, error) {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodGet, path, headers, queryParams, (*requestPb), &listWarehousesResponsePb)
	if err != nil {
		return nil, err
	}
	respField, err := listWarehousesResponseFromPb(&listWarehousesResponsePb)
	if err != nil {
		return nil, err
	}
	resp := respField
...
func (a *warehousesImpl) SetPermissions(ctx context.Context, request WarehousePermissionsRequest) (*WarehousePermissions, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPut, path, headers, queryParams, (*requestPb), &warehousePermissionsPb)
	if err != nil {
		return nil, err
	}
	respField, err := warehousePermissionsFromPb(&warehousePermissionsPb)
...
func (a *warehousesImpl) SetWorkspaceWarehouseConfig(ctx context.Context, request SetWorkspaceWarehouseConfigRequest) error {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPut, path, headers, queryParams, (*requestPb), &setWorkspaceWarehouseConfigResponsePb)
	if err != nil {
		return err
	}
...
func (a *warehousesImpl) Start(ctx context.Context, request StartRequest) error {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, nil, &startWarehouseResponsePb)
	if err != nil {
		return err
	}
...
func (a *warehousesImpl) Stop(ctx context.Context, request StopRequest) error {
	...
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodPost, path, headers, queryParams, nil, &stopWarehouseResponsePb)
	if err != nil {
		return err
	}
...
func (a *warehousesImpl) UpdatePermissions(ctx context.Context, request WarehousePermissionsRequest) (*WarehousePermissions, error) {
	...
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPatch, path, headers, queryParams, (*requestPb), &warehousePermissionsPb)
	if err != nil {
		return nil, err
	}
	respField, err := warehousePermissionsFromPb(&warehousePermissionsPb)
