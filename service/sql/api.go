...
type AlertsV2Interface interface {
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	ListAlerts(ctx context.Context, request ListAlertsV2Request) listing.Iterator[ListAlertsV2ResponseAlert]
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	ListAlertsAll(ctx context.Context, request ListAlertsV2Request) ([]ListAlertsV2ResponseAlert, error)

	// ListAlertsV2ResponseAlertDisplayNameToIdMap calls [AlertsV2API.ListAlertsAll] and creates a map of results with [ListAlertsV2ResponseAlert].DisplayName as key and [ListAlertsV2ResponseAlert].Id as value.
	//
	// Returns an error if there's more than one [ListAlertsV2ResponseAlert] with the same .DisplayName.
	//
	// Note: All [ListAlertsV2ResponseAlert] instances are loaded into memory before creating a map.
	//
	// This method is generated by Databricks SDK Code Generator.
	ListAlertsV2ResponseAlertDisplayNameToIdMap(ctx context.Context, request ListAlertsV2Request) (map[string]string, error)

	// GetByDisplayName calls [AlertsV2API.ListAlertsV2ResponseAlertDisplayNameToIdMap] and returns a single [ListAlertsV2ResponseAlert].
	//
	// Returns an error if there's more than one [ListAlertsV2ResponseAlert] with the same .DisplayName.
	//
	// Note: All [ListAlertsV2ResponseAlert] instances are loaded into memory before returning matching by name.
	//
	// This method is generated by Databricks SDK Code Generator.
	GetByDisplayName(ctx context.Context, name string) (*ListAlertsV2ResponseAlert, error)
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *AlertsV2API) ListAlertsV2ResponseAlertDisplayNameToIdMap(ctx context.Context, request ListAlertsV2Request) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *AlertsV2API) GetByDisplayName(ctx context.Context, name string) (*ListAlertsV2ResponseAlert, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "get-by-name")
	result, err := a.ListAlertsAll(ctx, ListAlertsV2Request{})
	if err != nil {
		return nil, err
	}
	tmp := map[string][]ListAlertsV2ResponseAlert{}
	for _, v := range result {
		key := v.DisplayName
		tmp[key] = append(tmp[key], v)
	}
	alternatives, ok := tmp[name]
	if !ok || len(alternatives) == 0 {
		return nil, fmt.Errorf("ListAlertsV2ResponseAlert named '%s' does not exist", name)
	}
	if len(alternatives) > 1 {
		return nil, fmt.Errorf("there are %d instances of ListAlertsV2ResponseAlert named '%s'", len(alternatives), name)
	}
	return &alternatives[0], nil
}
