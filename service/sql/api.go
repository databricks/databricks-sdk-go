...
//
// This method is generated by Databricks SDK Code Generator.
func (a *DashboardsAPI) ListAll(ctx context.Context, listing ListDashboardsRequest) ([]Dashboard, error) {
	var results []Dashboard
	request := ListDashboardsInternal{
		Order: listing.Order,
		Q:     listing.Q,
	}
	...
	for {
		...
		count := int(len(response.Results))
		totalCount += count
		request.Page++
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *DashboardsAPI) DashboardNameToIdMap(ctx context.Context, listing ListDashboardsRequest) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *QueriesAPI) ListAll(ctx context.Context, listing ListQueriesRequest) ([]Query, error) {
	var results []Query
	request := ListQueriesInternal{
		Order: listing.Order,
		Q:     listing.Q,
	}
	var totalCount int = 0
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *QueriesAPI) QueryNameToIdMap(ctx context.Context, listing ListQueriesRequest) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
	result, err := a.ListAll(ctx, listing)
	if err != nil {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *QueryHistoryAPI) ListAll(ctx context.Context, listing ListQueryHistoryRequest) ([]QueryInfo, error) {
	var results []QueryInfo
	request := ListQueryHistoryInternal{
		FilterBy:       listing.FilterBy,
		IncludeMetrics: listing.IncludeMetrics,
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *WarehousesAPI) ListAll(ctx context.Context, listing ListWarehousesRequest) ([]EndpointInfo, error) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *WarehousesAPI) EndpointInfoNameToIdMap(ctx context.Context, listing ListWarehousesRequest) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
	result, err := a.ListAll(ctx, listing)
	if err != nil {
