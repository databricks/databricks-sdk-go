...
func (a *AccountGroupsAPI) List(ctx context.Context, request ListAccountGroupsRequest) (it listing.Iterator[Group]) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *AccountServicePrincipalsAPI) List(ctx context.Context, request ListAccountServicePrincipalsRequest) (it listing.Iterator[ServicePrincipal]) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *AccountUsersAPI) List(ctx context.Context, request ListAccountUsersRequest) (it listing.Iterator[User]) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *GroupsAPI) List(ctx context.Context, request ListGroupsRequest) (it listing.Iterator[Group]) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ServicePrincipalsAPI) List(ctx context.Context, request ListServicePrincipalsRequest) (it listing.Iterator[ServicePrincipal]) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *UsersAPI) List(ctx context.Context, request ListUsersRequest) (it listing.Iterator[User]) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *WorkspaceAssignmentAPI) List(ctx context.Context, request ListWorkspaceAssignmentRequest) (it listing.Iterator[PermissionAssignment]) {
