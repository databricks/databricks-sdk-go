...
type WorkspaceAssignmentInterface interface {
	...
	// Get an array of workspace permissions for the specified account and
	// workspace.
	GetByWorkspaceId(ctx context.Context, workspaceId int64) (*ListWorkspacePermissionsResponse, error)
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	List(ctx context.Context, request GetWorkspacePermissionAssignments) listing.Iterator[WorkspacePermissionAssignmentOutput]
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	ListAll(ctx context.Context, request GetWorkspacePermissionAssignments) ([]WorkspacePermissionAssignmentOutput, error)

	// Get permission assignments.
	//
	// Get the permission assignments for the specified Databricks account and
	// Databricks workspace.
	ListByWorkspaceId(ctx context.Context, workspaceId int64) (*GetWorkspacePermissionAssignmentsResponse, error)
...
// Deletes the workspace permissions assignment in a given account and workspace
// for the specified principal.
func (a *WorkspaceAssignmentAPI) Delete(ctx context.Context, request DeleteWorkspacePermissionAssignment) error {
	return a.impl.Delete(ctx, request)
}
...
// Get an array of workspace permissions for the specified account and
// workspace.
func (a *WorkspaceAssignmentAPI) Get(ctx context.Context, request ListWorkspacePermissions) (*ListWorkspacePermissionsResponse, error) {
	return a.impl.Get(ctx, request)
}
...
// Get an array of workspace permissions for the specified account and
// workspace.
func (a *WorkspaceAssignmentAPI) GetByWorkspaceId(ctx context.Context, workspaceId int64) (*ListWorkspacePermissionsResponse, error) {
	return a.impl.Get(ctx, ListWorkspacePermissions{
		WorkspaceId: workspaceId,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *WorkspaceAssignmentAPI) List(ctx context.Context, request GetWorkspacePermissionAssignments) listing.Iterator[WorkspacePermissionAssignmentOutput] {

	getNextPage := func(ctx context.Context, req GetWorkspacePermissionAssignments) (*GetWorkspacePermissionAssignmentsResponse, error) {
		ctx = useragent.InContext(ctx, "sdk-feature", "pagination")
		return a.impl.List(ctx, req)
	}
	getItems := func(resp *GetWorkspacePermissionAssignmentsResponse) []WorkspacePermissionAssignmentOutput {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *WorkspaceAssignmentAPI) ListAll(ctx context.Context, request GetWorkspacePermissionAssignments) ([]WorkspacePermissionAssignmentOutput, error) {
	iterator := a.List(ctx, request)
	return listing.ToSlice[WorkspacePermissionAssignmentOutput](ctx, iterator)
}
...
// Get the permission assignments for the specified Databricks account and
// Databricks workspace.
func (a *WorkspaceAssignmentAPI) ListByWorkspaceId(ctx context.Context, workspaceId int64) (*GetWorkspacePermissionAssignmentsResponse, error) {
	return a.impl.List(ctx, GetWorkspacePermissionAssignments{
		WorkspaceId: workspaceId,
	})
}
...
// Creates or updates the workspace permissions assignment in a given account
// and workspace for the specified principal.
func (a *WorkspaceAssignmentAPI) Update(ctx context.Context, request UpdateWorkspacePermissionAssignment) (*UpdateWorkspacePermissionAssignmentResponse, error) {
	return a.impl.Update(ctx, request)
}
