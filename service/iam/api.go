...
type AccountGroupsV2Interface interface {
	...
	// Gets the information for a specific group in the Databricks account.
	GetById(ctx context.Context, id string) (*AccountGroup, error)
...
// Deletes a group from the Databricks account.
func (a *AccountGroupsV2API) DeleteById(ctx context.Context, id string) error {
	return a.accountGroupsV2Impl.Delete(ctx, DeleteAccountGroupRequest{
		Id: id,
	})
}

// Gets the information for a specific group in the Databricks account.
func (a *AccountGroupsV2API) GetById(ctx context.Context, id string) (*AccountGroup, error) {
	return a.accountGroupsV2Impl.Get(ctx, GetAccountGroupRequest{
		Id: id,
	})
}
...
type AccountServicePrincipalsV2Interface interface {
	...
	// Gets the details for a single service principal define in the Databricks
	// account.
	GetById(ctx context.Context, id string) (*AccountServicePrincipal, error)
...
// Delete a single service principal in the Databricks account.
func (a *AccountServicePrincipalsV2API) DeleteById(ctx context.Context, id string) error {
	return a.accountServicePrincipalsV2Impl.Delete(ctx, DeleteAccountServicePrincipalRequest{
		Id: id,
	})
}
...
// Gets the details for a single service principal define in the Databricks
// account.
func (a *AccountServicePrincipalsV2API) GetById(ctx context.Context, id string) (*AccountServicePrincipal, error) {
	return a.accountServicePrincipalsV2Impl.Get(ctx, GetAccountServicePrincipalRequest{
		Id: id,
	})
}
...
type AccountUsersV2Interface interface {
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	List(ctx context.Context, request ListAccountUsersRequest) listing.Iterator[AccountGroup]

	// Gets details for all the users associated with a Databricks account.
	//
	// This method is generated by Databricks SDK Code Generator.
	ListAll(ctx context.Context, request ListAccountUsersRequest) ([]AccountGroup, error)
...
// Deletes a user. Deleting a user from a Databricks account also removes
// objects associated with the user.
func (a *AccountUsersV2API) DeleteById(ctx context.Context, id string) error {
	return a.accountUsersV2Impl.Delete(ctx, DeleteAccountUserRequest{
		Id: id,
	})
}

// Gets information for a specific user in Databricks account.
func (a *AccountUsersV2API) GetById(ctx context.Context, id string) (*AccountUser, error) {
	return a.accountUsersV2Impl.Get(ctx, GetAccountUserRequest{
		Id: id,
	})
}
...
// Deletes a group from the Databricks workspace.
func (a *GroupsV2API) DeleteById(ctx context.Context, id string) error {
	return a.groupsV2Impl.Delete(ctx, DeleteGroupRequest{
		Id: id,
	})
}

// Gets the information for a specific group in the Databricks workspace.
func (a *GroupsV2API) GetById(ctx context.Context, id string) (*Group, error) {
	return a.groupsV2Impl.Get(ctx, GetGroupRequest{
		Id: id,
	})
}
...
// Delete a single service principal in the Databricks workspace.
func (a *ServicePrincipalsV2API) DeleteById(ctx context.Context, id string) error {
	return a.servicePrincipalsV2Impl.Delete(ctx, DeleteServicePrincipalRequest{
		Id: id,
	})
}
...
// Gets the details for a single service principal define in the Databricks
// workspace.
func (a *ServicePrincipalsV2API) GetById(ctx context.Context, id string) (*ServicePrincipal, error) {
	return a.servicePrincipalsV2Impl.Get(ctx, GetServicePrincipalRequest{
		Id: id,
	})
}
...
// Deletes a user. Deleting a user from a Databricks workspace also removes
// objects associated with the user.
func (a *UsersV2API) DeleteById(ctx context.Context, id string) error {
	return a.usersV2Impl.Delete(ctx, DeleteUserRequest{
		Id: id,
	})
}

// Gets information for a specific user in Databricks workspace.
func (a *UsersV2API) GetById(ctx context.Context, id string) (*User, error) {
	return a.usersV2Impl.Get(ctx, GetUserRequest{
		Id: id,
	})
}
