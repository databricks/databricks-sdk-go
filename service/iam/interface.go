...
//     policies.
//   - **Spark Declarative Pipelines permissions** — Manage which users can
//     view, manage, run, cancel, or own a Spark Declarative Pipeline.
//   - **Job permissions** — Manage which users can view, manage, trigger,
//     cancel, or own a job.
//   - **MLflow experiment permissions** — Manage which users can read, edit,
//     or manage MLflow experiments.
...
//     manage a repo.
//   - **Serving endpoint permissions** — Manage which users can view, query,
