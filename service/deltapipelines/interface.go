...
type DeltaPipelinesService interface {
	...
	CreatePipelineAndWait(ctx context.Context, request CreatePipelineRequest, timeout ...time.Duration) (*GetPipelineResponse, error)
	...
	ResetPipelineAndWait(ctx context.Context, request ResetPipelineRequest, timeout ...time.Duration) (*GetPipelineResponse, error)
	...
	StopPipelineAndWait(ctx context.Context, request StopPipelineRequest, timeout ...time.Duration) (*GetPipelineResponse, error)
}
