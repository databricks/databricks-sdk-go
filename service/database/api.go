...
// These APIs allow you to manage Database, Database Project, etc.
package database
...
type DatabaseProjectInterface interface {
...
func NewDatabaseProject(client *client.DatabricksClient) *DatabaseProjectAPI {
	return &DatabaseProjectAPI{
		databaseProjectImpl: databaseProjectImpl{
			client: client,
		},
	}
}
...
type DatabaseProjectAPI struct {
	databaseProjectImpl
}
