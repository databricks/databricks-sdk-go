...
func databaseInstanceToPb(st *DatabaseInstance) (*databaseInstancePb, error) {
	...
	pb.EffectiveEnablePgNativeLogin = st.EffectiveEnablePgNativeLogin
	...
	pb.EnablePgNativeLogin = st.EnablePgNativeLogin
...
func databaseInstanceFromPb(pb *databaseInstancePb) (*DatabaseInstance, error) {
	...
	st.EffectiveEnablePgNativeLogin = pb.EffectiveEnablePgNativeLogin
	...
	st.EnablePgNativeLogin = pb.EnablePgNativeLogin
...
func failoverDatabaseInstanceRequestToPb(st *FailoverDatabaseInstanceRequest) (*failoverDatabaseInstanceRequestPb, error) {
	if st == nil {
		return nil, nil
	}
...
func failoverDatabaseInstanceRequestFromPb(pb *failoverDatabaseInstanceRequestPb) (*FailoverDatabaseInstanceRequest, error) {
	if pb == nil {
		return nil, nil
	}
	st := &FailoverDatabaseInstanceRequest{}
	st.FailoverTargetDatabaseInstanceName = pb.FailoverTargetDatabaseInstanceName
	st.Name = pb.Name
...
func (st *failoverDatabaseInstanceRequestPb) UnmarshalJSON(b []byte) error {
	return marshal.Unmarshal(b, st)
}

func (st failoverDatabaseInstanceRequestPb) MarshalJSON() ([]byte, error) {
	return marshal.Marshal(st)
}
