...
type ConsumerInstallationsInterface interface {
	...
	// the fields not included in the installation table
	//
	//  1. the token will be rotate if the rotateToken flag is true
	//  2. the token will be forcibly rotate if the rotateToken flag is true and the
	//     tokenInfo field is empty
...
type ConsumerProvidersInterface interface {
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	List(ctx context.Context, request ListConsumerProvidersRequest) listing.Iterator[ProviderInfo]

	// List all providers in the Databricks Marketplace with at least one visible
	// listing.
	//
	// This method is generated by Databricks SDK Code Generator.
	ListAll(ctx context.Context, request ListConsumerProvidersRequest) ([]ProviderInfo, error)
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	ProviderInfoNameToIdMap(ctx context.Context, request ListConsumerProvidersRequest) (map[string]string, error)
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ConsumerProvidersAPI) ProviderInfoNameToIdMap(ctx context.Context, request ListConsumerProvidersRequest) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
	result, err := a.ListAll(ctx, request)
	if err != nil {
...
func (a *ConsumerProvidersAPI) GetByName(ctx context.Context, name string) (*ProviderInfo, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "get-by-name")
	result, err := a.ListAll(ctx, ListConsumerProvidersRequest{})
	if err != nil {
		return nil, err
	}
