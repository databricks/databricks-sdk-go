...
type CleanRoomsInterface interface {
	...
	List(ctx context.Context, request ListCleanRoomsRequest) *listing.PaginatingIterator[ListCleanRoomsRequest, *ListCleanRoomsResponse, CleanRoomInfo]
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *CleanRoomsAPI) List(ctx context.Context, request ListCleanRoomsRequest) *listing.PaginatingIterator[ListCleanRoomsRequest, *ListCleanRoomsResponse, CleanRoomInfo] {
...
type ProvidersInterface interface {
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	List(ctx context.Context, request ListProvidersRequest) *listing.PaginatingIterator[ListProvidersRequest, *ListProvidersResponse, ProviderInfo]
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	ListShares(ctx context.Context, request ListSharesRequest) *listing.PaginatingIterator[ListSharesRequest, *ListProviderSharesResponse, ProviderShare]
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ProvidersAPI) List(ctx context.Context, request ListProvidersRequest) *listing.PaginatingIterator[ListProvidersRequest, *ListProvidersResponse, ProviderInfo] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ProvidersAPI) ListShares(ctx context.Context, request ListSharesRequest) *listing.PaginatingIterator[ListSharesRequest, *ListProviderSharesResponse, ProviderShare] {
...
type RecipientsInterface interface {
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	List(ctx context.Context, request ListRecipientsRequest) *listing.PaginatingIterator[ListRecipientsRequest, *ListRecipientsResponse, RecipientInfo]
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *RecipientsAPI) List(ctx context.Context, request ListRecipientsRequest) *listing.PaginatingIterator[ListRecipientsRequest, *ListRecipientsResponse, RecipientInfo] {
...
type SharesInterface interface {
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	List(ctx context.Context) *listing.PaginatingIterator[struct{}, *ListSharesResponse, ShareInfo]
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *SharesAPI) List(ctx context.Context) *listing.PaginatingIterator[struct{}, *ListSharesResponse, ShareInfo] {
	request := struct{}{}
