...
func (a *CleanRoomsAPI) ListAll(ctx context.Context) ([]CleanRoomInfo, error) {
	...
	return response.CleanRooms, nil
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ProvidersAPI) ListAll(ctx context.Context, listing ListProvidersRequest) ([]ProviderInfo, error) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ProvidersAPI) ProviderInfoNameToMetastoreIdMap(ctx context.Context, listing ListProvidersRequest) (map[string]string, error) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ProvidersAPI) ListSharesAll(ctx context.Context, listing ListSharesRequest) ([]ProviderShare, error) {
	response, err := a.impl.ListShares(ctx, listing)
	if err != nil {
		return nil, err
	}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *RecipientsAPI) ListAll(ctx context.Context, listing ListRecipientsRequest) ([]RecipientInfo, error) {
	response, err := a.impl.List(ctx, listing)
	if err != nil {
		return nil, err
	}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *RecipientsAPI) RecipientInfoNameToMetastoreIdMap(ctx context.Context, listing ListRecipientsRequest) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
	result, err := a.ListAll(ctx, listing)
	if err != nil {
