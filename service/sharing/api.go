...
func (a *CleanRoomsAPI) List(ctx context.Context, request ListCleanRoomsRequest) *listing.IteratorImpl[ListCleanRoomsRequest, *ListCleanRoomsResponse, CleanRoomInfo] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ProvidersAPI) List(ctx context.Context, request ListProvidersRequest) *listing.IteratorImpl[ListProvidersRequest, *ListProvidersResponse, ProviderInfo] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ProvidersAPI) ListShares(ctx context.Context, request ListSharesRequest) *listing.IteratorImpl[ListSharesRequest, *ListProviderSharesResponse, ProviderShare] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *RecipientsAPI) List(ctx context.Context, request ListRecipientsRequest) *listing.IteratorImpl[ListRecipientsRequest, *ListRecipientsResponse, RecipientInfo] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *SharesAPI) List(ctx context.Context) *listing.IteratorImpl[struct{}, *ListSharesResponse, ShareInfo] {
	request := struct{}{}
