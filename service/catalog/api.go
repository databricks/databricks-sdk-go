...
// These APIs allow you to manage Account Metastore Assignments, Account Metastores, Account Storage Credentials, Artifact Allowlists, Catalogs, Connections, Credentials, Database Instances, External Locations, Functions, Grants, Metastores, Model Versions, Online Tables, Quality Monitors, Registered Models, Resource Quotas, Schemas, Storage Credentials, System Schemas, Table Constraints, Tables, Temporary Table Credentials, Volumes, Workspace Bindings, etc.
package catalog
...
type DatabaseInstancesInterface interface {
...
func NewDatabaseInstances(client *client.DatabricksClient) *DatabaseInstancesAPI {
	return &DatabaseInstancesAPI{
		databaseInstancesImpl: databaseInstancesImpl{
			client: client,
		},
	}
}
...
type DatabaseInstancesAPI struct {
	databaseInstancesImpl
}

// Delete a Database Catalog.
func (a *DatabaseInstancesAPI) DeleteDatabaseCatalogByName(ctx context.Context, name string) error {
	return a.databaseInstancesImpl.DeleteDatabaseCatalog(ctx, DeleteDatabaseCatalogRequest{
		Name: name,
	})
}

// Delete a Database Instance.
func (a *DatabaseInstancesAPI) DeleteDatabaseInstanceByName(ctx context.Context, name string) error {
	return a.databaseInstancesImpl.DeleteDatabaseInstance(ctx, DeleteDatabaseInstanceRequest{
		Name: name,
	})
}
...
// Get a Database Catalog.
func (a *DatabaseInstancesAPI) GetDatabaseCatalogByName(ctx context.Context, name string) (*DatabaseCatalog, error) {
	return a.databaseInstancesImpl.GetDatabaseCatalog(ctx, GetDatabaseCatalogRequest{
		Name: name,
	})
}
...
// Get a Synced Database Table.
func (a *DatabaseInstancesAPI) GetSyncedDatabaseTableByName(ctx context.Context, name string) (*SyncedDatabaseTable, error) {
	return a.databaseInstancesImpl.GetSyncedDatabaseTable(ctx, GetSyncedDatabaseTableRequest{
		Name: name,
	})
}
