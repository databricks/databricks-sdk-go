...
// MetastoreInfoNameToMetastoreIdMap calls [AccountMetastoresAPI.ListAll] and creates a map of results with [MetastoreInfo].Name as key and [MetastoreInfo].MetastoreId as value.
//
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *AccountMetastoresAPI) MetastoreInfoNameToMetastoreIdMap(ctx context.Context) (map[string]string, error) {
...
// GetByName calls [AccountMetastoresAPI.MetastoreInfoNameToMetastoreIdMap] and returns a single [MetastoreInfo].
//
// Returns an error if there's more than one [MetastoreInfo] with the same .Name.
//
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *AccountMetastoresAPI) GetByName(ctx context.Context, name string) (*MetastoreInfo, error) {
