...
func (a *AccountMetastoreAssignmentsAPI) List(ctx context.Context, request ListAccountMetastoreAssignmentsRequest) *listing.Iterator[ListAccountMetastoreAssignmentsRequest, *ListAccountMetastoreAssignmentsResponse, int64] {
...
func (a *AccountMetastoreAssignmentsAPI) ListAll(ctx context.Context, request ListAccountMetastoreAssignmentsRequest) ([]int64, error) {
	...
	return response.WorkspaceIds, nil
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *AccountMetastoresAPI) List(ctx context.Context) *listing.Iterator[struct{}, *ListMetastoresResponse, MetastoreInfo] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *CatalogsAPI) List(ctx context.Context) *listing.Iterator[struct{}, *ListCatalogsResponse, CatalogInfo] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ConnectionsAPI) List(ctx context.Context) *listing.Iterator[struct{}, *ListConnectionsResponse, ConnectionInfo] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ExternalLocationsAPI) List(ctx context.Context) *listing.Iterator[struct{}, *ListExternalLocationsResponse, ExternalLocationInfo] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *FunctionsAPI) List(ctx context.Context, request ListFunctionsRequest) *listing.Iterator[ListFunctionsRequest, *ListFunctionsResponse, FunctionInfo] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *MetastoresAPI) List(ctx context.Context) *listing.Iterator[struct{}, *ListMetastoresResponse, MetastoreInfo] {
	getNextPage := func(ctx context.Context, req struct{}) (*ListMetastoresResponse, error) {
		return a.impl.List(ctx)
	}
	getItems := func(resp *ListMetastoresResponse) []MetastoreInfo {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ModelVersionsAPI) List(ctx context.Context, request ListModelVersionsRequest) *listing.Iterator[ListModelVersionsRequest, *ListModelVersionsResponse, ModelVersionInfo] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *RegisteredModelsAPI) List(ctx context.Context, request ListRegisteredModelsRequest) *listing.Iterator[ListRegisteredModelsRequest, *ListRegisteredModelsResponse, RegisteredModelInfo] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *SchemasAPI) List(ctx context.Context, request ListSchemasRequest) *listing.Iterator[ListSchemasRequest, *ListSchemasResponse, SchemaInfo] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *StorageCredentialsAPI) List(ctx context.Context) *listing.Iterator[struct{}, *ListStorageCredentialsResponse, StorageCredentialInfo] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *SystemSchemasAPI) List(ctx context.Context, request ListSystemSchemasRequest) *listing.Iterator[ListSystemSchemasRequest, *ListSystemSchemasResponse, SystemSchemaInfo] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *TablesAPI) List(ctx context.Context, request ListTablesRequest) *listing.Iterator[ListTablesRequest, *ListTablesResponse, TableInfo] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *TablesAPI) ListSummaries(ctx context.Context, request ListSummariesRequest) *listing.Iterator[ListSummariesRequest, *ListTableSummariesResponse, TableSummary] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *VolumesAPI) List(ctx context.Context, request ListVolumesRequest) *listing.Iterator[ListVolumesRequest, *ListVolumesResponseContent, VolumeInfo] {
