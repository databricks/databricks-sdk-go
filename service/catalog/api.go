...
func (a *ConnectionsAPI) ListAll(ctx context.Context, request ListConnectionsRequest) ([]ConnectionInfo, error) {
	iterator := a.List(ctx, request)
	return listing.ToSliceN[ConnectionInfo, int](ctx, iterator, request.MaxResults)
...
// Additionally, the call must be made from the workspace where the monitor was
// created.
func (a *QualityMonitorsAPI) ListRefreshes(ctx context.Context, request ListRefreshesRequest) ([]MonitorRefreshInfo, error) {
...
// Additionally, the call must be made from the workspace where the monitor was
// created.
func (a *QualityMonitorsAPI) ListRefreshesByTableName(ctx context.Context, tableName string) ([]MonitorRefreshInfo, error) {
