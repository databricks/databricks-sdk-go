...
//
// This method is generated by Databricks SDK Code Generator.
func (a *FunctionsAPI) ListAll(ctx context.Context, listing ListFunctionsRequest) ([]FunctionInfo, error) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *FunctionsAPI) FunctionInfoNameToFullNameMap(ctx context.Context, listing ListFunctionsRequest) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *SchemasAPI) ListAll(ctx context.Context, listing ListSchemasRequest) ([]SchemaInfo, error) {
	response, err := a.impl.List(ctx, listing)
	if err != nil {
		return nil, err
	}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *SchemasAPI) SchemaInfoNameToFullNameMap(ctx context.Context, listing ListSchemasRequest) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
	result, err := a.ListAll(ctx, listing)
	if err != nil {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *SystemSchemasAPI) ListAll(ctx context.Context, listing ListSystemSchemasRequest) ([]SystemSchemaInfo, error) {
	response, err := a.impl.List(ctx, listing)
	if err != nil {
		return nil, err
	}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *TablesAPI) ListAll(ctx context.Context, listing ListTablesRequest) ([]TableInfo, error) {
	var results []TableInfo
	request := ListTablesInternal{
		CatalogName:          listing.CatalogName,
		IncludeDeltaMetadata: listing.IncludeDeltaMetadata,
		MaxResults:           listing.MaxResults,
		SchemaName:           listing.SchemaName,
	}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *TablesAPI) TableInfoNameToTableIdMap(ctx context.Context, listing ListTablesRequest) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
	result, err := a.ListAll(ctx, listing)
	if err != nil {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *TablesAPI) ListSummariesAll(ctx context.Context, listing ListSummariesRequest) ([]TableSummary, error) {
	var results []TableSummary
	request := ListSummariesInternal{
		CatalogName:       listing.CatalogName,
		MaxResults:        listing.MaxResults,
		SchemaNamePattern: listing.SchemaNamePattern,
		TableNamePattern:  listing.TableNamePattern,
	}
	ctx = useragent.InContext(ctx, "sdk-feature", "pagination")
	for {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *VolumesAPI) ListAll(ctx context.Context, listing ListVolumesRequest) ([]VolumeInfo, error) {
	response, err := a.impl.List(ctx, listing)
	if err != nil {
		return nil, err
	}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *VolumesAPI) VolumeInfoNameToVolumeIdMap(ctx context.Context, listing ListVolumesRequest) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
	result, err := a.ListAll(ctx, listing)
	if err != nil {
