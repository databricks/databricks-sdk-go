...
func (a *accountMetastoreAssignmentsImpl) Create(ctx context.Context, request AccountsCreateMetastoreAssignment) error {
	path := fmt.Sprintf("/api/2.0/accounts/%v/workspaces/%v/metastores/%v", a.client.ConfiguredAccountID(), strings.TrimPrefix(fmt.Sprint(request.WorkspaceId), "/"), strings.TrimPrefix(fmt.Sprint(request.MetastoreId), "/"))
...
func (a *accountMetastoreAssignmentsImpl) Get(ctx context.Context, request GetAccountMetastoreAssignmentRequest) (*AccountsMetastoreAssignment, error) {
	...
	path := fmt.Sprintf("/api/2.0/accounts/%v/workspaces/%v/metastore", a.client.ConfiguredAccountID(), strings.TrimPrefix(fmt.Sprint(request.WorkspaceId), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
...
func (a *accountMetastoreAssignmentsImpl) List(ctx context.Context, request ListAccountMetastoreAssignmentsRequest) (*ListAccountMetastoreAssignmentsResponse, error) {
	...
	path := fmt.Sprintf("/api/2.0/accounts/%v/metastores/%v/workspaces", a.client.ConfiguredAccountID(), strings.TrimPrefix(fmt.Sprint(request.MetastoreId), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
...
func (a *accountMetastoresImpl) Delete(ctx context.Context, request DeleteAccountMetastoreRequest) error {
	path := fmt.Sprintf("/api/2.0/accounts/%v/metastores/%v", a.client.ConfiguredAccountID(), strings.TrimPrefix(fmt.Sprint(request.MetastoreId), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodDelete, path, headers, request, nil)
	return err
...
func (a *accountStorageCredentialsImpl) Create(ctx context.Context, request AccountsCreateStorageCredential) (*AccountsStorageCredentialInfo, error) {
	...
	path := fmt.Sprintf("/api/2.0/accounts/%v/metastores/%v/storage-credentials", a.client.ConfiguredAccountID(), strings.TrimPrefix(fmt.Sprint(request.MetastoreId), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
...
func (a *accountStorageCredentialsImpl) Delete(ctx context.Context, request DeleteAccountStorageCredentialRequest) error {
	path := fmt.Sprintf("/api/2.0/accounts/%v/metastores/%v/storage-credentials/%v", a.client.ConfiguredAccountID(), strings.TrimPrefix(fmt.Sprint(request.MetastoreId), "/"), strings.TrimPrefix(fmt.Sprint(request.StorageCredentialName), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodDelete, path, headers, request, nil)
	return err
...
func (a *artifactAllowlistsImpl) Get(ctx context.Context, request GetArtifactAllowlistRequest) (*ArtifactAllowlistInfo, error) {
	...
	path := fmt.Sprintf("/api/2.1/unity-catalog/artifact-allowlists/%v", strings.TrimPrefix(fmt.Sprint(request.ArtifactType), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
...
func (a *catalogsImpl) Delete(ctx context.Context, request DeleteCatalogRequest) error {
	path := fmt.Sprintf("/api/2.1/unity-catalog/catalogs/%v", strings.TrimPrefix(fmt.Sprint(request.Name), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodDelete, path, headers, request, nil)
	return err
...
func (a *connectionsImpl) Delete(ctx context.Context, request DeleteConnectionRequest) error {
	path := fmt.Sprintf("/api/2.1/unity-catalog/connections/%v", strings.TrimPrefix(fmt.Sprint(request.NameArg), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodDelete, path, headers, request, nil)
	return err
...
func (a *externalLocationsImpl) Delete(ctx context.Context, request DeleteExternalLocationRequest) error {
	path := fmt.Sprintf("/api/2.1/unity-catalog/external-locations/%v", strings.TrimPrefix(fmt.Sprint(request.Name), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodDelete, path, headers, request, nil)
	return err
...
func (a *functionsImpl) Delete(ctx context.Context, request DeleteFunctionRequest) error {
	path := fmt.Sprintf("/api/2.1/unity-catalog/functions/%v", strings.TrimPrefix(fmt.Sprint(request.Name), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodDelete, path, headers, request, nil)
	return err
...
func (a *grantsImpl) Get(ctx context.Context, request GetGrantRequest) (*PermissionsList, error) {
	...
	path := fmt.Sprintf("/api/2.1/unity-catalog/permissions/%v/%v", strings.TrimPrefix(fmt.Sprint(request.SecurableType), "/"), strings.TrimPrefix(fmt.Sprint(request.FullName), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
...
func (a *grantsImpl) GetEffective(ctx context.Context, request GetEffectiveRequest) (*EffectivePermissionsList, error) {
	...
	path := fmt.Sprintf("/api/2.1/unity-catalog/effective-permissions/%v/%v", strings.TrimPrefix(fmt.Sprint(request.SecurableType), "/"), strings.TrimPrefix(fmt.Sprint(request.FullName), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
...
func (a *metastoresImpl) Assign(ctx context.Context, request CreateMetastoreAssignment) error {
	path := fmt.Sprintf("/api/2.1/unity-catalog/workspaces/%v/metastore", strings.TrimPrefix(fmt.Sprint(request.WorkspaceId), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	headers["Content-Type"] = "application/json"
	err := a.client.Do(ctx, http.MethodPut, path, headers, request, nil)
...
func (a *metastoresImpl) Delete(ctx context.Context, request DeleteMetastoreRequest) error {
	path := fmt.Sprintf("/api/2.1/unity-catalog/metastores/%v", strings.TrimPrefix(fmt.Sprint(request.Id), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodDelete, path, headers, request, nil)
	return err
...
func (a *modelVersionsImpl) Delete(ctx context.Context, request DeleteModelVersionRequest) error {
	path := fmt.Sprintf("/api/2.1/unity-catalog/models/%v/versions/%v", strings.TrimPrefix(fmt.Sprint(request.FullName), "/"), strings.TrimPrefix(fmt.Sprint(request.Version), "/"))
	headers := make(map[string]string)
	err := a.client.Do(ctx, http.MethodDelete, path, headers, request, nil)
	return err
}
...
func (a *modelVersionsImpl) GetByAlias(ctx context.Context, request GetByAliasRequest) (*ModelVersionInfo, error) {
	...
	path := fmt.Sprintf("/api/2.1/unity-catalog/models/%v/aliases/%v", strings.TrimPrefix(fmt.Sprint(request.FullName), "/"), strings.TrimPrefix(fmt.Sprint(request.Alias), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
...
func (a *modelVersionsImpl) List(ctx context.Context, request ListModelVersionsRequest) (*ListModelVersionsResponse, error) {
	...
	path := fmt.Sprintf("/api/2.1/unity-catalog/models/%v/versions", strings.TrimPrefix(fmt.Sprint(request.FullName), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
...
func (a *registeredModelsImpl) Delete(ctx context.Context, request DeleteRegisteredModelRequest) error {
	path := fmt.Sprintf("/api/2.1/unity-catalog/models/%v", strings.TrimPrefix(fmt.Sprint(request.FullName), "/"))
	headers := make(map[string]string)
	err := a.client.Do(ctx, http.MethodDelete, path, headers, request, nil)
	return err
}
...
func (a *schemasImpl) Delete(ctx context.Context, request DeleteSchemaRequest) error {
	path := fmt.Sprintf("/api/2.1/unity-catalog/schemas/%v", strings.TrimPrefix(fmt.Sprint(request.FullName), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodDelete, path, headers, request, nil)
	return err
...
func (a *storageCredentialsImpl) Delete(ctx context.Context, request DeleteStorageCredentialRequest) error {
	path := fmt.Sprintf("/api/2.1/unity-catalog/storage-credentials/%v", strings.TrimPrefix(fmt.Sprint(request.Name), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodDelete, path, headers, request, nil)
	return err
...
func (a *systemSchemasImpl) Disable(ctx context.Context, request DisableRequest) error {
	path := fmt.Sprintf("/api/2.1/unity-catalog/metastores/%v/systemschemas/%v", strings.TrimPrefix(fmt.Sprint(request.MetastoreId), "/"), strings.TrimPrefix(fmt.Sprint(request.SchemaName), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodDelete, path, headers, request, nil)
	return err
...
func (a *systemSchemasImpl) List(ctx context.Context, request ListSystemSchemasRequest) (*ListSystemSchemasResponse, error) {
	...
	path := fmt.Sprintf("/api/2.1/unity-catalog/metastores/%v/systemschemas", strings.TrimPrefix(fmt.Sprint(request.MetastoreId), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
...
func (a *tableConstraintsImpl) Delete(ctx context.Context, request DeleteTableConstraintRequest) error {
	path := fmt.Sprintf("/api/2.1/unity-catalog/constraints/%v", strings.TrimPrefix(fmt.Sprint(request.FullName), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodDelete, path, headers, request, nil)
	return err
...
func (a *tablesImpl) Delete(ctx context.Context, request DeleteTableRequest) error {
	path := fmt.Sprintf("/api/2.1/unity-catalog/tables/%v", strings.TrimPrefix(fmt.Sprint(request.FullName), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
	err := a.client.Do(ctx, http.MethodDelete, path, headers, request, nil)
	return err
...
func (a *volumesImpl) Delete(ctx context.Context, request DeleteVolumeRequest) error {
	path := fmt.Sprintf("/api/2.1/unity-catalog/volumes/%v", strings.TrimPrefix(fmt.Sprint(request.FullNameArg), "/"))
	headers := make(map[string]string)
	err := a.client.Do(ctx, http.MethodDelete, path, headers, request, nil)
	return err
}
...
func (a *workspaceBindingsImpl) Get(ctx context.Context, request GetWorkspaceBindingRequest) (*CurrentWorkspaceBindings, error) {
	...
	path := fmt.Sprintf("/api/2.1/unity-catalog/workspace-bindings/catalogs/%v", strings.TrimPrefix(fmt.Sprint(request.Name), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
...
func (a *workspaceBindingsImpl) GetBindings(ctx context.Context, request GetBindingsRequest) (*WorkspaceBindingsResponse, error) {
	...
	path := fmt.Sprintf("/api/2.1/unity-catalog/bindings/%v/%v", strings.TrimPrefix(fmt.Sprint(request.SecurableType), "/"), strings.TrimPrefix(fmt.Sprint(request.SecurableName), "/"))
	headers := make(map[string]string)
	headers["Accept"] = "application/json"
