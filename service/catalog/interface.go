...
type CredentialsService interface {
	...
	// Delete a credential.
	//
	// Deletes a credential from the metastore. The caller must be an owner of
	// the credential.
	...
	// Get a credential.
	//
	// Gets a credential from the metastore. The caller must be a metastore
	// admin, the owner of the credential, or have any permission on the
	// credential.
