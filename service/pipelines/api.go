...
func (a *PipelinesAPI) ListPipelineEventsAll(ctx context.Context, request ListPipelineEvents) ([]PipelineEvent, error) {
...
func (a *PipelinesAPI) ListPipelineEventsByPipelineId(ctx context.Context, pipelineId string) (*ListPipelineEventsResponse, error) {
	return a.impl.ListPipelineEvents(ctx, ListPipelineEvents{
		PipelineId: pipelineId,
	})
}
