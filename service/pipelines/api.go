...
func (a *PipelinesAPI) ListPipelineEventsAll(ctx context.Context, listing ListPipelineEventsRequest) ([]PipelineEvent, error) {
	var results []PipelineEvent
	request := ListPipelineEventsInternal{
		Filter:     listing.Filter,
		MaxResults: listing.MaxResults,
		OrderBy:    listing.OrderBy,
		PipelineId: listing.PipelineId,
	}
...
func (a *PipelinesAPI) ListPipelineEventsByPipelineId(ctx context.Context, pipelineId string) (*ListPipelineEventsResponse, error) {
	return a.impl.ListPipelineEvents(ctx, ListPipelineEventsInternal{
		PipelineId: pipelineId,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *PipelinesAPI) ListPipelinesAll(ctx context.Context, listing ListPipelinesRequest) ([]PipelineStateInfo, error) {
	var results []PipelineStateInfo
	request := ListPipelinesInternal{
		Filter:     listing.Filter,
		MaxResults: listing.MaxResults,
		OrderBy:    listing.OrderBy,
	}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *PipelinesAPI) PipelineStateInfoNameToPipelineIdMap(ctx context.Context, listing ListPipelinesRequest) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
	result, err := a.ListPipelinesAll(ctx, listing)
	if err != nil {
		return nil, err
	}
