...
func (a *PipelinesAPI) ListPipelineEvents(ctx context.Context, request ListPipelineEventsRequest) *listing.IteratorImpl[ListPipelineEventsRequest, *ListPipelineEventsResponse, PipelineEvent] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *PipelinesAPI) ListPipelines(ctx context.Context, request ListPipelinesRequest) *listing.IteratorImpl[ListPipelinesRequest, *ListPipelinesResponse, PipelineStateInfo] {
