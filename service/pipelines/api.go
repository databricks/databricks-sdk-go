...
type PipelinesInterface interface {
	...
	ListPipelineEvents(ctx context.Context, request ListPipelineEventsRequest) *listing.PaginatingIterator[ListPipelineEventsRequest, *ListPipelineEventsResponse, PipelineEvent]
	...
	//
	// This method is generated by Databricks SDK Code Generator.
	ListPipelines(ctx context.Context, request ListPipelinesRequest) *listing.PaginatingIterator[ListPipelinesRequest, *ListPipelinesResponse, PipelineStateInfo]
	...
	//
	// Resets a pipeline.
	Reset(ctx context.Context, resetRequest ResetRequest) (*WaitGetPipelineRunning[any], error)
	...
	Stop(ctx context.Context, stopRequest StopRequest) (*WaitGetPipelineIdle[any], error)
