...
func (a *PipelinesAPI) ListPipelineEvents(ctx context.Context, request ListPipelineEventsRequest) *listing.Iterator[ListPipelineEventsRequest, *ListPipelineEventsResponse, PipelineEvent] {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *PipelinesAPI) ListPipelines(ctx context.Context, request ListPipelinesRequest) *listing.Iterator[ListPipelinesRequest, *ListPipelinesResponse, PipelineStateInfo] {
