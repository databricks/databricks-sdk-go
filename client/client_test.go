...
func (m *mockConfig) Authenticate(r *http.Request) error {
	if m.auth == nil {
		return nil
	}
	return m.auth(r)
...
func (m *mockConfig) EnsureResolved() error {
	return nil
}
func (m *mockConfig) GetAuthType() string {
	return "mock"
}
func (m *mockConfig) GetAccountID() string {
	return "mock"
}
func (m *mockConfig) GetHost() string {
	return "https://mock"
}
func (m *mockConfig) GetRetryTimeoutSeconds() int {
	return 0
}
func (m *mockConfig) GetRateLimitPerSecond() int {
	return 0
}
func (m *mockConfig) GetDebugTruncateBytes() int {
	return 0
}
func (m *mockConfig) IsDebugHeaders() bool {
	return m.DebugHeaders
}
func (m *mockConfig) IsInsecureSkipVerify() bool {
	return false
}
func (m *mockConfig) IsAws() bool {
	return false
}
func (m *mockConfig) IsAzure() bool {
	return false
}
func (m *mockConfig) IsGcp() bool {
	return false
}
