...
type gitCredentialsBaseClient struct {
	gitCredentialsImpl
}
...
func (a *gitCredentialsBaseClient) DeleteByCredentialId(ctx context.Context, credentialId int64) (*DeleteCredentialsResponse, error) {
...
func (a *gitCredentialsBaseClient) GetByCredentialId(ctx context.Context, credentialId int64) (*GetCredentialsResponse, error) {
	return a.gitCredentialsImpl.Get(ctx, GetCredentialsRequest{
		CredentialId: credentialId,
	})
}

// CredentialInfoGitProviderToCredentialIdMap calls [gitCredentialsBaseClient.ListAll] and creates a map of results with [CredentialInfo].GitProvider as key and [CredentialInfo].CredentialId as value.
//
...
func (a *gitCredentialsBaseClient) CredentialInfoGitProviderToCredentialIdMap(ctx context.Context) (map[string]int64, error) {
...
// GetByGitProvider calls [gitCredentialsBaseClient.CredentialInfoGitProviderToCredentialIdMap] and returns a single [CredentialInfo].
//
// Returns an error if there's more than one [CredentialInfo] with the same .GitProvider.
//
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *gitCredentialsBaseClient) GetByGitProvider(ctx context.Context, name string) (*CredentialInfo, error) {
...
func (a *reposBaseClient) DeleteByRepoId(ctx context.Context, repoId int64) (*DeleteRepoResponse, error) {
...
func (a *reposBaseClient) GetByRepoId(ctx context.Context, repoId int64) (*GetRepoResponse, error) {
...
func (a *reposBaseClient) GetPermissionLevelsByRepoId(ctx context.Context, repoId string) (*GetRepoPermissionLevelsResponse, error) {
...
// object.
func (a *reposBaseClient) GetPermissionsByRepoId(ctx context.Context, repoId string) (*RepoPermissions, error) {
	return a.reposImpl.GetPermissions(ctx, GetRepoPermissionsRequest{
		RepoId: repoId,
	})
}

// RepoInfoPathToIdMap calls [reposBaseClient.ListAll] and creates a map of results with [RepoInfo].Path as key and [RepoInfo].Id as value.
//
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *reposBaseClient) RepoInfoPathToIdMap(ctx context.Context, request ListReposRequest) (map[string]int64, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]int64{}
...
// GetByPath calls [reposBaseClient.RepoInfoPathToIdMap] and returns a single [RepoInfo].
//
// Returns an error if there's more than one [RepoInfo] with the same .Path.
//
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *reposBaseClient) GetByPath(ctx context.Context, name string) (*RepoInfo, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "get-by-name")
...
// call.
func (a *secretsBaseClient) DeleteScopeByScope(ctx context.Context, scope string) (*DeleteScopeResponse, error) {
...
// `PERMISSION_DENIED` if the user does not have permission to make this API
// call.
func (a *secretsBaseClient) ListAclsByScope(ctx context.Context, scope string) (*ListAclsResponse, error) {
...
// `PERMISSION_DENIED` if the user does not have permission to make this API
// call.
func (a *secretsBaseClient) ListSecretsByScope(ctx context.Context, scope string) (*ListSecretsResponse, error) {
	return a.secretsImpl.internalListSecrets(ctx, ListSecretsRequest{
		Scope: scope,
	})
}

type workspaceBaseClient struct {
	workspaceImpl
}
...
//
// Gets the permission levels that a user can have on an object.
func (a *workspaceBaseClient) GetPermissionLevelsByWorkspaceObjectTypeAndWorkspaceObjectId(ctx context.Context, workspaceObjectType string, workspaceObjectId string) (*GetWorkspaceObjectPermissionLevelsResponse, error) {
...
func (a *workspaceBaseClient) GetPermissionsByWorkspaceObjectTypeAndWorkspaceObjectId(ctx context.Context, workspaceObjectType string, workspaceObjectId string) (*WorkspaceObjectPermissions, error) {
...
func (a *workspaceBaseClient) GetStatusByPath(ctx context.Context, path string) (*ObjectInfo, error) {
	return a.workspaceImpl.GetStatus(ctx, GetStatusRequest{
		Path: path,
	})
}

// ObjectInfoPathToObjectIdMap calls [workspaceBaseClient.ListAll] and creates a map of results with [ObjectInfo].Path as key and [ObjectInfo].ObjectId as value.
//
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *workspaceBaseClient) ObjectInfoPathToObjectIdMap(ctx context.Context, request ListWorkspaceRequest) (map[string]int64, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]int64{}
	result, err := a.ListAll(ctx, request)
	if err != nil {
...
// GetByPath calls [workspaceBaseClient.ObjectInfoPathToObjectIdMap] and returns a single [ObjectInfo].
//
// Returns an error if there's more than one [ObjectInfo] with the same .Path.
//
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *workspaceBaseClient) GetByPath(ctx context.Context, name string) (*ObjectInfo, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "get-by-name")
...
func (a *workspaceBaseClient) MkdirsByPath(ctx context.Context, path string) (*MkdirsResponse, error) {
