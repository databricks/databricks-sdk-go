...
type ExportRequest struct {
	// Flag to enable direct download. If it is `true`, the response is the
	// exported file itself. Otherwise, by default, the response contains
	// content in the form of a base64 encoded string.
