...
// These APIs allow you to manage Git Credentials Preview, Repos Preview, Secrets Preview, Workspace Preview, etc.
...
type GitCredentialsPreviewInterface interface {
	...
	// CredentialInfoGitProviderToCredentialIdMap calls [GitCredentialsPreviewAPI.ListAll] and creates a map of results with [CredentialInfo].GitProvider as key and [CredentialInfo].CredentialId as value.
	//
	...
	// GetByGitProvider calls [GitCredentialsPreviewAPI.CredentialInfoGitProviderToCredentialIdMap] and returns a single [CredentialInfo].
	//
	// Returns an error if there's more than one [CredentialInfo] with the same .GitProvider.
	//
...
func NewGitCredentialsPreview(client *client.DatabricksClient) *GitCredentialsPreviewAPI {
	return &GitCredentialsPreviewAPI{
...
type GitCredentialsPreviewAPI struct {
	gitCredentialsPreviewImpl
}

// Delete a credential.
//
// Deletes the specified Git credential.
func (a *GitCredentialsPreviewAPI) DeleteByCredentialId(ctx context.Context, credentialId int64) error {
	return a.gitCredentialsPreviewImpl.Delete(ctx, DeleteCredentialsRequest{
...
//
// Gets the Git credential with the specified credential ID.
func (a *GitCredentialsPreviewAPI) GetByCredentialId(ctx context.Context, credentialId int64) (*GetCredentialsResponse, error) {
	return a.gitCredentialsPreviewImpl.Get(ctx, GetCredentialsRequest{
		CredentialId: credentialId,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *GitCredentialsPreviewAPI) CredentialInfoGitProviderToCredentialIdMap(ctx context.Context) (map[string]int64, error) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *GitCredentialsPreviewAPI) GetByGitProvider(ctx context.Context, name string) (*CredentialInfo, error) {
...
type ReposPreviewInterface interface {
	...
	// RepoInfoPathToIdMap calls [ReposPreviewAPI.ListAll] and creates a map of results with [RepoInfo].Path as key and [RepoInfo].Id as value.
	//
	...
	// GetByPath calls [ReposPreviewAPI.RepoInfoPathToIdMap] and returns a single [RepoInfo].
	//
	// Returns an error if there's more than one [RepoInfo] with the same .Path.
	//
...
func NewReposPreview(client *client.DatabricksClient) *ReposPreviewAPI {
	return &ReposPreviewAPI{
		reposPreviewImpl: reposPreviewImpl{
			client: client,
		},
	}
}
...
//
// Deletes the specified repo.
func (a *ReposPreviewAPI) DeleteByRepoId(ctx context.Context, repoId int64) error {
	return a.reposPreviewImpl.Delete(ctx, DeleteRepoRequest{
		RepoId: repoId,
	})
}
...
//
// Returns the repo with the given repo ID.
func (a *ReposPreviewAPI) GetByRepoId(ctx context.Context, repoId int64) (*GetRepoResponse, error) {
	return a.reposPreviewImpl.Get(ctx, GetRepoRequest{
		RepoId: repoId,
	})
}
...
//
// Gets the permission levels that a user can have on an object.
func (a *ReposPreviewAPI) GetPermissionLevelsByRepoId(ctx context.Context, repoId string) (*GetRepoPermissionLevelsResponse, error) {
	return a.reposPreviewImpl.GetPermissionLevels(ctx, GetRepoPermissionLevelsRequest{
		RepoId: repoId,
	})
}
...
// Gets the permissions of a repo. Repos can inherit permissions from their root
// object.
func (a *ReposPreviewAPI) GetPermissionsByRepoId(ctx context.Context, repoId string) (*RepoPermissions, error) {
	return a.reposPreviewImpl.GetPermissions(ctx, GetRepoPermissionsRequest{
		RepoId: repoId,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ReposPreviewAPI) RepoInfoPathToIdMap(ctx context.Context, request ListReposRequest) (map[string]int64, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]int64{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ReposPreviewAPI) GetByPath(ctx context.Context, name string) (*RepoInfo, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "get-by-name")
...
type SecretsPreviewInterface interface {
...
func NewSecretsPreview(client *client.DatabricksClient) *SecretsPreviewAPI {
	return &SecretsPreviewAPI{
		secretsPreviewImpl: secretsPreviewImpl{
			client: client,
		},
	}
}
...
// `PERMISSION_DENIED` if the user does not have permission to make this API
// call.
func (a *SecretsPreviewAPI) DeleteScopeByScope(ctx context.Context, scope string) error {
	return a.secretsPreviewImpl.DeleteScope(ctx, DeleteScope{
		Scope: scope,
	})
}
...
// `PERMISSION_DENIED` if the user does not have permission to make this API
// call.
func (a *SecretsPreviewAPI) ListAclsByScope(ctx context.Context, scope string) (*ListAclsResponse, error) {
	return a.secretsPreviewImpl.internalListAcls(ctx, ListAclsRequest{
		Scope: scope,
	})
}
...
// `PERMISSION_DENIED` if the user does not have permission to make this API
// call.
func (a *SecretsPreviewAPI) ListSecretsByScope(ctx context.Context, scope string) (*ListSecretsResponse, error) {
	return a.secretsPreviewImpl.internalListSecrets(ctx, ListSecretsRequest{
		Scope: scope,
	})
}

type WorkspacePreviewInterface interface {
	...
	// ObjectInfoPathToObjectIdMap calls [WorkspacePreviewAPI.ListAll] and creates a map of results with [ObjectInfo].Path as key and [ObjectInfo].ObjectId as value.
	//
	...
	// GetByPath calls [WorkspacePreviewAPI.ObjectInfoPathToObjectIdMap] and returns a single [ObjectInfo].
	//
	// Returns an error if there's more than one [ObjectInfo] with the same .Path.
	//
...
func NewWorkspacePreview(client *client.DatabricksClient) *WorkspacePreviewAPI {
	return &WorkspacePreviewAPI{
		workspacePreviewImpl: workspacePreviewImpl{
			client: client,
		},
	}
}
...
type WorkspacePreviewAPI struct {
	workspacePreviewImpl
}

// Get workspace object permission levels.
//
// Gets the permission levels that a user can have on an object.
func (a *WorkspacePreviewAPI) GetPermissionLevelsByWorkspaceObjectTypeAndWorkspaceObjectId(ctx context.Context, workspaceObjectType string, workspaceObjectId string) (*GetWorkspaceObjectPermissionLevelsResponse, error) {
	return a.workspacePreviewImpl.GetPermissionLevels(ctx, GetWorkspaceObjectPermissionLevelsRequest{
...
// Gets the permissions of a workspace object. Workspace objects can inherit
// permissions from their parent objects or root object.
func (a *WorkspacePreviewAPI) GetPermissionsByWorkspaceObjectTypeAndWorkspaceObjectId(ctx context.Context, workspaceObjectType string, workspaceObjectId string) (*WorkspaceObjectPermissions, error) {
	return a.workspacePreviewImpl.GetPermissions(ctx, GetWorkspaceObjectPermissionsRequest{
		WorkspaceObjectType: workspaceObjectType,
		WorkspaceObjectId:   workspaceObjectId,
	})
}
...
// Gets the status of an object or a directory. If `path` does not exist, this
// call returns an error `RESOURCE_DOES_NOT_EXIST`.
func (a *WorkspacePreviewAPI) GetStatusByPath(ctx context.Context, path string) (*ObjectInfo, error) {
	return a.workspacePreviewImpl.GetStatus(ctx, GetStatusRequest{
		Path: path,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *WorkspacePreviewAPI) ObjectInfoPathToObjectIdMap(ctx context.Context, request ListWorkspaceRequest) (map[string]int64, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]int64{}
	result, err := a.ListAll(ctx, request)
	if err != nil {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *WorkspacePreviewAPI) GetByPath(ctx context.Context, name string) (*ObjectInfo, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "get-by-name")
...
// Note that if this operation fails it may have succeeded in creating some of
// the necessary parent directories.
func (a *WorkspacePreviewAPI) MkdirsByPath(ctx context.Context, path string) error {
	return a.workspacePreviewImpl.Mkdirs(ctx, Mkdirs{
		Path: path,
	})
}
