...
* [Breaking] Removed [a.AccountGroups](https://pkg.go.dev/github.com/databricks/databricks-sdk-go/service/iam#AccountGroupsAPI) account-level service, [a.AccountServicePrincipals](https://pkg.go.dev/github.com/databricks/databricks-sdk-go/service/iam#AccountServicePrincipalsAPI) account-level service, [a.AccountUsers](https://pkg.go.dev/github.com/databricks/databricks-sdk-go/service/iam#AccountUsersAPI) account-level service, [w.Groups](https://pkg.go.dev/github.com/databricks/databricks-sdk-go/service/iam#GroupsAPI) workspace-level service, [w.ServicePrincipals](https://pkg.go.dev/github.com/databricks/databricks-sdk-go/service/iam#ServicePrincipalsAPI) workspace-level service and [w.Users](https://pkg.go.dev/github.com/databricks/databricks-sdk-go/service/iam#UsersAPI) workspace-level service.
* [Breaking] Removed `AccountId` field for [iam.User](https://pkg.go.dev/github.com/databricks/databricks-sdk-go/service/iam#User).