...
* [Breaking] Changed waiter for [ClustersAPI.Create](https://pkg.go.dev/github.com/databricks/databricks-sdk-go/service/compute#ClustersAPI.Create).
* [Breaking] Changed waiter for [ClustersAPI.Delete](https://pkg.go.dev/github.com/databricks/databricks-sdk-go/service/compute#ClustersAPI.Delete).
* [Breaking] Changed waiter for [ClustersAPI.Edit](https://pkg.go.dev/github.com/databricks/databricks-sdk-go/service/compute#ClustersAPI.Edit).
* [Breaking] Changed waiter for [ClustersAPI.Get](https://pkg.go.dev/github.com/databricks/databricks-sdk-go/service/compute#ClustersAPI.Get).
* [Breaking] Changed waiter for [ClustersAPI.Resize](https://pkg.go.dev/github.com/databricks/databricks-sdk-go/service/compute#ClustersAPI.Resize).
* [Breaking] Changed waiter for [ClustersAPI.Restart](https://pkg.go.dev/github.com/databricks/databricks-sdk-go/service/compute#ClustersAPI.Restart).
* [Breaking] Changed waiter for [ClustersAPI.Start](https://pkg.go.dev/github.com/databricks/databricks-sdk-go/service/compute#ClustersAPI.Start).
* [Breaking] Changed waiter for [ClustersAPI.Update](https://pkg.go.dev/github.com/databricks/databricks-sdk-go/service/compute#ClustersAPI.Update).
