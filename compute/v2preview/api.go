...
// These APIs allow you to manage Cluster Policies Preview, Clusters Preview, Command Execution Preview, Global Init Scripts Preview, Instance Pools Preview, Instance Profiles Preview, Libraries Preview, Policy Compliance For Clusters Preview, Policy Families Preview, etc.
...
type ClusterPoliciesPreviewInterface interface {
	...
	// PolicyNameToPolicyIdMap calls [ClusterPoliciesPreviewAPI.ListAll] and creates a map of results with [Policy].Name as key and [Policy].PolicyId as value.
	//
	...
	// GetByName calls [ClusterPoliciesPreviewAPI.PolicyNameToPolicyIdMap] and returns a single [Policy].
	//
	// Returns an error if there's more than one [Policy] with the same .Name.
	//
...
func NewClusterPoliciesPreview(client *client.DatabricksClient) *ClusterPoliciesPreviewAPI {
	return &ClusterPoliciesPreviewAPI{
		clusterPoliciesPreviewImpl: clusterPoliciesPreviewImpl{
			client: client,
		},
	}
}
...
type ClusterPoliciesPreviewAPI struct {
	clusterPoliciesPreviewImpl
}
...
// Delete a policy for a cluster. Clusters governed by this policy can still
// run, but cannot be edited.
func (a *ClusterPoliciesPreviewAPI) DeleteByPolicyId(ctx context.Context, policyId string) error {
	return a.clusterPoliciesPreviewImpl.Delete(ctx, DeletePolicy{
		PolicyId: policyId,
	})
}
...
// Get a cluster policy entity. Creation and editing is available to admins
// only.
func (a *ClusterPoliciesPreviewAPI) GetByPolicyId(ctx context.Context, policyId string) (*Policy, error) {
	return a.clusterPoliciesPreviewImpl.Get(ctx, GetClusterPolicyRequest{
		PolicyId: policyId,
	})
}
...
//
// Gets the permission levels that a user can have on an object.
func (a *ClusterPoliciesPreviewAPI) GetPermissionLevelsByClusterPolicyId(ctx context.Context, clusterPolicyId string) (*GetClusterPolicyPermissionLevelsResponse, error) {
	return a.clusterPoliciesPreviewImpl.GetPermissionLevels(ctx, GetClusterPolicyPermissionLevelsRequest{
...
// Gets the permissions of a cluster policy. Cluster policies can inherit
// permissions from their root object.
func (a *ClusterPoliciesPreviewAPI) GetPermissionsByClusterPolicyId(ctx context.Context, clusterPolicyId string) (*ClusterPolicyPermissions, error) {
	return a.clusterPoliciesPreviewImpl.GetPermissions(ctx, GetClusterPolicyPermissionsRequest{
		ClusterPolicyId: clusterPolicyId,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ClusterPoliciesPreviewAPI) PolicyNameToPolicyIdMap(ctx context.Context, request ListClusterPoliciesRequest) (map[string]string, error) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ClusterPoliciesPreviewAPI) GetByName(ctx context.Context, name string) (*Policy, error) {
...
type ClustersPreviewInterface interface {
	...
	// ClusterDetailsClusterNameToClusterIdMap calls [ClustersPreviewAPI.ListAll] and creates a map of results with [ClusterDetails].ClusterName as key and [ClusterDetails].ClusterId as value.
	//
	...
	// GetByClusterName calls [ClustersPreviewAPI.ClusterDetailsClusterNameToClusterIdMap] and returns a single [ClusterDetails].
	//
	// Returns an error if there's more than one [ClusterDetails] with the same .ClusterName.
	//
...
func NewClustersPreview(client *client.DatabricksClient) *ClustersPreviewAPI {
	return &ClustersPreviewAPI{
		clustersPreviewImpl: clustersPreviewImpl{
			client: client,
		},
	}
}
...
type ClustersPreviewAPI struct {
	clustersPreviewImpl
}
...
// `TERMINATED` state. If the cluster is already in a `TERMINATING` or
// `TERMINATED` state, nothing will happen.
func (a *ClustersPreviewAPI) DeleteByClusterId(ctx context.Context, clusterId string) error {
	return a.clustersPreviewImpl.Delete(ctx, DeleteCluster{
		ClusterId: clusterId,
	})
}
...
// Retrieves the information for a cluster given its identifier. Clusters can be
// described while they are running, or up to 60 days after they are terminated.
func (a *ClustersPreviewAPI) GetByClusterId(ctx context.Context, clusterId string) (*ClusterDetails, error) {
	return a.clustersPreviewImpl.Get(ctx, GetClusterRequest{
		ClusterId: clusterId,
	})
}
...
//
// Gets the permission levels that a user can have on an object.
func (a *ClustersPreviewAPI) GetPermissionLevelsByClusterId(ctx context.Context, clusterId string) (*GetClusterPermissionLevelsResponse, error) {
	return a.clustersPreviewImpl.GetPermissionLevels(ctx, GetClusterPermissionLevelsRequest{
		ClusterId: clusterId,
	})
}
...
// Gets the permissions of a cluster. Clusters can inherit permissions from
// their root object.
func (a *ClustersPreviewAPI) GetPermissionsByClusterId(ctx context.Context, clusterId string) (*ClusterPermissions, error) {
	return a.clustersPreviewImpl.GetPermissions(ctx, GetClusterPermissionsRequest{
		ClusterId: clusterId,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ClustersPreviewAPI) ClusterDetailsClusterNameToClusterIdMap(ctx context.Context, request ListClustersRequest) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
	result, err := a.ListAll(ctx, request)
	if err != nil {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ClustersPreviewAPI) GetByClusterName(ctx context.Context, name string) (*ClusterDetails, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "get-by-name")
...
// cluster list, and API users can no longer perform any action on permanently
// deleted clusters.
func (a *ClustersPreviewAPI) PermanentDeleteByClusterId(ctx context.Context, clusterId string) error {
	return a.clustersPreviewImpl.PermanentDelete(ctx, PermanentDeleteCluster{
		ClusterId: clusterId,
	})
}
...
// ListClusters API. Pinning a cluster that is already pinned will have no
// effect. This API can only be called by workspace admins.
func (a *ClustersPreviewAPI) PinByClusterId(ctx context.Context, clusterId string) error {
	return a.clustersPreviewImpl.Pin(ctx, PinCluster{
		ClusterId: clusterId,
	})
}
...
// nodes. * If the cluster is not currently in a `TERMINATED` state, nothing
// will happen. * Clusters launched to run a job cannot be started.
func (a *ClustersPreviewAPI) StartByClusterId(ctx context.Context, clusterId string) error {
	return a.clustersPreviewImpl.Start(ctx, StartCluster{
		ClusterId: clusterId,
	})
}
...
// ListClusters API. Unpinning a cluster that is not pinned will have no effect.
// This API can only be called by workspace admins.
func (a *ClustersPreviewAPI) UnpinByClusterId(ctx context.Context, clusterId string) error {
	return a.clustersPreviewImpl.Unpin(ctx, UnpinCluster{
		ClusterId: clusterId,
	})
}

type CommandExecutionPreviewInterface interface {
...
func NewCommandExecutionPreview(client *client.DatabricksClient) *CommandExecutionPreviewAPI {
	return &CommandExecutionPreviewAPI{
		commandExecutionPreviewImpl: commandExecutionPreviewImpl{
			client: client,
		},
	}
}
...
type CommandExecutionPreviewAPI struct {
	commandExecutionPreviewImpl
}

type GlobalInitScriptsPreviewInterface interface {
	...
	// GlobalInitScriptDetailsNameToScriptIdMap calls [GlobalInitScriptsPreviewAPI.ListAll] and creates a map of results with [GlobalInitScriptDetails].Name as key and [GlobalInitScriptDetails].ScriptId as value.
	//
	...
	// GetByName calls [GlobalInitScriptsPreviewAPI.GlobalInitScriptDetailsNameToScriptIdMap] and returns a single [GlobalInitScriptDetails].
	//
	// Returns an error if there's more than one [GlobalInitScriptDetails] with the same .Name.
	//
...
func NewGlobalInitScriptsPreview(client *client.DatabricksClient) *GlobalInitScriptsPreviewAPI {
	return &GlobalInitScriptsPreviewAPI{
...
// code.
type GlobalInitScriptsPreviewAPI struct {
	globalInitScriptsPreviewImpl
}

// Delete init script.
//
// Deletes a global init script.
func (a *GlobalInitScriptsPreviewAPI) DeleteByScriptId(ctx context.Context, scriptId string) error {
	return a.globalInitScriptsPreviewImpl.Delete(ctx, DeleteGlobalInitScriptRequest{
		ScriptId: scriptId,
	})
}
...
//
// Gets all the details of a script, including its Base64-encoded contents.
func (a *GlobalInitScriptsPreviewAPI) GetByScriptId(ctx context.Context, scriptId string) (*GlobalInitScriptDetailsWithContent, error) {
	return a.globalInitScriptsPreviewImpl.Get(ctx, GetGlobalInitScriptRequest{
		ScriptId: scriptId,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *GlobalInitScriptsPreviewAPI) GlobalInitScriptDetailsNameToScriptIdMap(ctx context.Context) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *GlobalInitScriptsPreviewAPI) GetByName(ctx context.Context, name string) (*GlobalInitScriptDetails, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "get-by-name")
	result, err := a.ListAll(ctx)
	if err != nil {
		return nil, err
...
type InstancePoolsPreviewInterface interface {
	...
	// InstancePoolAndStatsInstancePoolNameToInstancePoolIdMap calls [InstancePoolsPreviewAPI.ListAll] and creates a map of results with [InstancePoolAndStats].InstancePoolName as key and [InstancePoolAndStats].InstancePoolId as value.
	//
	...
	// GetByInstancePoolName calls [InstancePoolsPreviewAPI.InstancePoolAndStatsInstancePoolNameToInstancePoolIdMap] and returns a single [InstancePoolAndStats].
	//
	// Returns an error if there's more than one [InstancePoolAndStats] with the same .InstancePoolName.
	//
...
func NewInstancePoolsPreview(client *client.DatabricksClient) *InstancePoolsPreviewAPI {
	return &InstancePoolsPreviewAPI{
		instancePoolsPreviewImpl: instancePoolsPreviewImpl{
			client: client,
		},
	}
}
...
type InstancePoolsPreviewAPI struct {
...
// Deletes the instance pool permanently. The idle instances in the pool are
// terminated asynchronously.
func (a *InstancePoolsPreviewAPI) DeleteByInstancePoolId(ctx context.Context, instancePoolId string) error {
	return a.instancePoolsPreviewImpl.Delete(ctx, DeleteInstancePool{
...
//
// Retrieve the information for an instance pool based on its identifier.
func (a *InstancePoolsPreviewAPI) GetByInstancePoolId(ctx context.Context, instancePoolId string) (*GetInstancePool, error) {
	return a.instancePoolsPreviewImpl.Get(ctx, GetInstancePoolRequest{
		InstancePoolId: instancePoolId,
	})
}
...
//
// Gets the permission levels that a user can have on an object.
func (a *InstancePoolsPreviewAPI) GetPermissionLevelsByInstancePoolId(ctx context.Context, instancePoolId string) (*GetInstancePoolPermissionLevelsResponse, error) {
	return a.instancePoolsPreviewImpl.GetPermissionLevels(ctx, GetInstancePoolPermissionLevelsRequest{
		InstancePoolId: instancePoolId,
	})
}
...
// Gets the permissions of an instance pool. Instance pools can inherit
// permissions from their root object.
func (a *InstancePoolsPreviewAPI) GetPermissionsByInstancePoolId(ctx context.Context, instancePoolId string) (*InstancePoolPermissions, error) {
	return a.instancePoolsPreviewImpl.GetPermissions(ctx, GetInstancePoolPermissionsRequest{
		InstancePoolId: instancePoolId,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *InstancePoolsPreviewAPI) InstancePoolAndStatsInstancePoolNameToInstancePoolIdMap(ctx context.Context) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
	result, err := a.ListAll(ctx)
	if err != nil {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *InstancePoolsPreviewAPI) GetByInstancePoolName(ctx context.Context, name string) (*InstancePoolAndStats, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "get-by-name")
	result, err := a.ListAll(ctx)
	if err != nil {
		return nil, err
...
type InstanceProfilesPreviewInterface interface {
...
func NewInstanceProfilesPreview(client *client.DatabricksClient) *InstanceProfilesPreviewAPI {
	return &InstanceProfilesPreviewAPI{
		instanceProfilesPreviewImpl: instanceProfilesPreviewImpl{
			client: client,
		},
	}
}
...
type InstanceProfilesPreviewAPI struct {
...
//
// This API is only accessible to admin users.
func (a *InstanceProfilesPreviewAPI) RemoveByInstanceProfileArn(ctx context.Context, instanceProfileArn string) error {
	return a.instanceProfilesPreviewImpl.Remove(ctx, RemoveInstanceProfile{
		InstanceProfileArn: instanceProfileArn,
	})
}

type LibrariesPreviewInterface interface {
...
func NewLibrariesPreview(client *client.DatabricksClient) *LibrariesPreviewAPI {
	return &LibrariesPreviewAPI{
		librariesPreviewImpl: librariesPreviewImpl{
			client: client,
		},
	}
}
...
type LibrariesPreviewAPI struct {
	librariesPreviewImpl
}
...
// installed on this cluster or, but are now marked for removal, in no
// particular order, are returned last.
func (a *LibrariesPreviewAPI) ClusterStatusByClusterId(ctx context.Context, clusterId string) (*ClusterLibraryStatuses, error) {
	return a.librariesPreviewImpl.internalClusterStatus(ctx, ClusterStatus{
		ClusterId: clusterId,
	})
}

type PolicyComplianceForClustersPreviewInterface interface {
...
func NewPolicyComplianceForClustersPreview(client *client.DatabricksClient) *PolicyComplianceForClustersPreviewAPI {
	return &PolicyComplianceForClustersPreviewAPI{
		policyComplianceForClustersPreviewImpl: policyComplianceForClustersPreviewImpl{
			client: client,
		},
	}
}
...
type PolicyComplianceForClustersPreviewAPI struct {
...
// Returns the policy compliance status of a cluster. Clusters could be out of
// compliance if their policy was updated after the cluster was last edited.
func (a *PolicyComplianceForClustersPreviewAPI) GetComplianceByClusterId(ctx context.Context, clusterId string) (*GetClusterComplianceResponse, error) {
	return a.policyComplianceForClustersPreviewImpl.GetCompliance(ctx, GetClusterComplianceRequest{
		ClusterId: clusterId,
	})
}

type PolicyFamiliesPreviewInterface interface {
...
func NewPolicyFamiliesPreview(client *client.DatabricksClient) *PolicyFamiliesPreviewAPI {
	return &PolicyFamiliesPreviewAPI{
		policyFamiliesPreviewImpl: policyFamiliesPreviewImpl{
			client: client,
		},
	}
}
...
type PolicyFamiliesPreviewAPI struct {
...
// Retrieve the information for an policy family based on its identifier and
// version
func (a *PolicyFamiliesPreviewAPI) GetByPolicyFamilyId(ctx context.Context, policyFamilyId string) (*PolicyFamily, error) {
	return a.policyFamiliesPreviewImpl.Get(ctx, GetPolicyFamilyRequest{
