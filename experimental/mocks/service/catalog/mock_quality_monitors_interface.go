...
func (_m *MockQualityMonitorsInterface) ListRefreshes(ctx context.Context, request catalog.ListRefreshesRequest) ([]catalog.MonitorRefreshInfo, error) {
	ret := _m.Called(ctx, request)
...
func (_c *MockQualityMonitorsInterface_ListRefreshes_Call) Return(_a0 []catalog.MonitorRefreshInfo, _a1 error) *MockQualityMonitorsInterface_ListRefreshes_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQualityMonitorsInterface_ListRefreshes_Call) RunAndReturn(run func(context.Context, catalog.ListRefreshesRequest) ([]catalog.MonitorRefreshInfo, error)) *MockQualityMonitorsInterface_ListRefreshes_Call {
	_c.Call.Return(run)
	return _c
}

// ListRefreshesByTableName provides a mock function with given fields: ctx, tableName
func (_m *MockQualityMonitorsInterface) ListRefreshesByTableName(ctx context.Context, tableName string) ([]catalog.MonitorRefreshInfo, error) {
	ret := _m.Called(ctx, tableName)
...
func (_c *MockQualityMonitorsInterface_ListRefreshesByTableName_Call) Return(_a0 []catalog.MonitorRefreshInfo, _a1 error) *MockQualityMonitorsInterface_ListRefreshesByTableName_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQualityMonitorsInterface_ListRefreshesByTableName_Call) RunAndReturn(run func(context.Context, string) ([]catalog.MonitorRefreshInfo, error)) *MockQualityMonitorsInterface_ListRefreshesByTableName_Call {
	_c.Call.Return(run)
	return _c
}
