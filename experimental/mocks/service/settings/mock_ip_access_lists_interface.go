...
func (_m *MockIpAccessListsInterface) List(ctx context.Context) *listing.PaginatingIterator[struct{}, *settings.ListIpAccessListResponse, settings.IpAccessListInfo] {
	ret := _m.Called(ctx)
...
func (_c *MockIpAccessListsInterface_List_Call) Return(_a0 *listing.PaginatingIterator[struct{}, *settings.ListIpAccessListResponse, settings.IpAccessListInfo]) *MockIpAccessListsInterface_List_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockIpAccessListsInterface_List_Call) RunAndReturn(run func(context.Context) *listing.PaginatingIterator[struct{}, *settings.ListIpAccessListResponse, settings.IpAccessListInfo]) *MockIpAccessListsInterface_List_Call {
	_c.Call.Return(run)
	return _c
}
