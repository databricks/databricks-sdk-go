...
func (_m *MockServingEndpointDataPlaneInterface) WaitGetServingEndpointNotUpdating(ctx context.Context, name string, timeout time.Duration, callback func(*serving.ServingEndpointDetailed)) (*serving.ServingEndpointDetailed, error) {
...
// MockServingEndpointDataPlaneInterface_WaitGetServingEndpointNotUpdating_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'WaitGetServingEndpointNotUpdating'
type MockServingEndpointDataPlaneInterface_WaitGetServingEndpointNotUpdating_Call struct {
	*mock.Call
}
...
func (_e *MockServingEndpointDataPlaneInterface_Expecter) WaitGetServingEndpointNotUpdating(ctx interface{}, name interface{}, timeout interface{}, callback interface{}) *MockServingEndpointDataPlaneInterface_WaitGetServingEndpointNotUpdating_Call {
	return &MockServingEndpointDataPlaneInterface_WaitGetServingEndpointNotUpdating_Call{Call: _e.mock.On("WaitGetServingEndpointNotUpdating", ctx, name, timeout, callback)}
}

func (_c *MockServingEndpointDataPlaneInterface_WaitGetServingEndpointNotUpdating_Call) Run(run func(ctx context.Context, name string, timeout time.Duration, callback func(*serving.ServingEndpointDetailed))) *MockServingEndpointDataPlaneInterface_WaitGetServingEndpointNotUpdating_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockServingEndpointDataPlaneInterface_WaitGetServingEndpointNotUpdating_Call) Return(_a0 *serving.ServingEndpointDetailed, _a1 error) *MockServingEndpointDataPlaneInterface_WaitGetServingEndpointNotUpdating_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockServingEndpointDataPlaneInterface_WaitGetServingEndpointNotUpdating_Call) RunAndReturn(run func(context.Context, string, time.Duration, func(*serving.ServingEndpointDetailed)) (*serving.ServingEndpointDetailed, error)) *MockServingEndpointDataPlaneInterface_WaitGetServingEndpointNotUpdating_Call {
	_c.Call.Return(run)
	return _c
}
