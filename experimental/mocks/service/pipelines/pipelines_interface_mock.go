...
func (_e *MockPipelinesInterface_Expecter) Reset(ctx interface{}, resetRequest interface{}) *MockPipelinesInterface_Reset_Call {
	return &MockPipelinesInterface_Reset_Call{Call: _e.mock.On("Reset", ctx, resetRequest)}
}

func (_c *MockPipelinesInterface_Reset_Call) Run(run func(ctx context.Context, resetRequest pipelines.ResetRequest)) *MockPipelinesInterface_Reset_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_m *MockPipelinesInterface) ResetAndWait(ctx context.Context, resetRequest pipelines.ResetRequest, options ...retries.Option[pipelines.GetPipelineResponse]) (*pipelines.GetPipelineResponse, error) {
...
func (_e *MockPipelinesInterface_Expecter) ResetAndWait(ctx interface{}, resetRequest interface{}, options ...interface{}) *MockPipelinesInterface_ResetAndWait_Call {
	return &MockPipelinesInterface_ResetAndWait_Call{Call: _e.mock.On("ResetAndWait",
		append([]interface{}{ctx, resetRequest}, options...)...)}
}

func (_c *MockPipelinesInterface_ResetAndWait_Call) Run(run func(ctx context.Context, resetRequest pipelines.ResetRequest, options ...retries.Option[pipelines.GetPipelineResponse])) *MockPipelinesInterface_ResetAndWait_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockPipelinesInterface_ResetAndWait_Call) Return(_a0 *pipelines.GetPipelineResponse, _a1 error) *MockPipelinesInterface_ResetAndWait_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockPipelinesInterface_ResetAndWait_Call) RunAndReturn(run func(context.Context, pipelines.ResetRequest, ...retries.Option[pipelines.GetPipelineResponse]) (*pipelines.GetPipelineResponse, error)) *MockPipelinesInterface_ResetAndWait_Call {
	_c.Call.Return(run)
	return _c
}
