...
func (_m *MockGenieInterface) GenieCreateEvalRun(ctx context.Context, request dashboards.GenieCreateEvalRunRequest) (*dashboards.GenieEvalRunResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GenieCreateEvalRun")
	}

	var r0 *dashboards.GenieEvalRunResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, dashboards.GenieCreateEvalRunRequest) (*dashboards.GenieEvalRunResponse, error)); ok {
		return rf(ctx, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, dashboards.GenieCreateEvalRunRequest) *dashboards.GenieEvalRunResponse); ok {
		r0 = rf(ctx, request)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*dashboards.GenieEvalRunResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, dashboards.GenieCreateEvalRunRequest) error); ok {
		r1 = rf(ctx, request)
	} else {
		r1 = ret.Error(1)
	}
...
// MockGenieInterface_GenieCreateEvalRun_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GenieCreateEvalRun'
type MockGenieInterface_GenieCreateEvalRun_Call struct {
	*mock.Call
}

// GenieCreateEvalRun is a helper method to define mock.On call
//   - ctx context.Context
//   - request dashboards.GenieCreateEvalRunRequest
func (_e *MockGenieInterface_Expecter) GenieCreateEvalRun(ctx interface{}, request interface{}) *MockGenieInterface_GenieCreateEvalRun_Call {
	return &MockGenieInterface_GenieCreateEvalRun_Call{Call: _e.mock.On("GenieCreateEvalRun", ctx, request)}
}

func (_c *MockGenieInterface_GenieCreateEvalRun_Call) Run(run func(ctx context.Context, request dashboards.GenieCreateEvalRunRequest)) *MockGenieInterface_GenieCreateEvalRun_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(dashboards.GenieCreateEvalRunRequest))
	})
	return _c
}

func (_c *MockGenieInterface_GenieCreateEvalRun_Call) Return(_a0 *dashboards.GenieEvalRunResponse, _a1 error) *MockGenieInterface_GenieCreateEvalRun_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockGenieInterface_GenieCreateEvalRun_Call) RunAndReturn(run func(context.Context, dashboards.GenieCreateEvalRunRequest) (*dashboards.GenieEvalRunResponse, error)) *MockGenieInterface_GenieCreateEvalRun_Call {
	_c.Call.Return(run)
	return _c
}

// GenieGetEvalResultDetails provides a mock function with given fields: ctx, request
func (_m *MockGenieInterface) GenieGetEvalResultDetails(ctx context.Context, request dashboards.GenieGetEvalResultDetailsRequest) (*dashboards.GenieEvalResultDetails, error) {
	ret := _m.Called(ctx, request)

	if len(ret) == 0 {
		panic("no return value specified for GenieGetEvalResultDetails")
	}

	var r0 *dashboards.GenieEvalResultDetails
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, dashboards.GenieGetEvalResultDetailsRequest) (*dashboards.GenieEvalResultDetails, error)); ok {
		return rf(ctx, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, dashboards.GenieGetEvalResultDetailsRequest) *dashboards.GenieEvalResultDetails); ok {
		r0 = rf(ctx, request)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*dashboards.GenieEvalResultDetails)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, dashboards.GenieGetEvalResultDetailsRequest) error); ok {
		r1 = rf(ctx, request)
	} else {
		r1 = ret.Error(1)
	}
...
// MockGenieInterface_GenieGetEvalResultDetails_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GenieGetEvalResultDetails'
type MockGenieInterface_GenieGetEvalResultDetails_Call struct {
	*mock.Call
}

// GenieGetEvalResultDetails is a helper method to define mock.On call
//   - ctx context.Context
//   - request dashboards.GenieGetEvalResultDetailsRequest
func (_e *MockGenieInterface_Expecter) GenieGetEvalResultDetails(ctx interface{}, request interface{}) *MockGenieInterface_GenieGetEvalResultDetails_Call {
	return &MockGenieInterface_GenieGetEvalResultDetails_Call{Call: _e.mock.On("GenieGetEvalResultDetails", ctx, request)}
}

func (_c *MockGenieInterface_GenieGetEvalResultDetails_Call) Run(run func(ctx context.Context, request dashboards.GenieGetEvalResultDetailsRequest)) *MockGenieInterface_GenieGetEvalResultDetails_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(dashboards.GenieGetEvalResultDetailsRequest))
	})
	return _c
}

func (_c *MockGenieInterface_GenieGetEvalResultDetails_Call) Return(_a0 *dashboards.GenieEvalResultDetails, _a1 error) *MockGenieInterface_GenieGetEvalResultDetails_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockGenieInterface_GenieGetEvalResultDetails_Call) RunAndReturn(run func(context.Context, dashboards.GenieGetEvalResultDetailsRequest) (*dashboards.GenieEvalResultDetails, error)) *MockGenieInterface_GenieGetEvalResultDetails_Call {
	_c.Call.Return(run)
	return _c
}

// GenieGetEvalRun provides a mock function with given fields: ctx, request
func (_m *MockGenieInterface) GenieGetEvalRun(ctx context.Context, request dashboards.GenieGetEvalRunRequest) (*dashboards.GenieEvalRunResponse, error) {
	ret := _m.Called(ctx, request)

	if len(ret) == 0 {
		panic("no return value specified for GenieGetEvalRun")
	}

	var r0 *dashboards.GenieEvalRunResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, dashboards.GenieGetEvalRunRequest) (*dashboards.GenieEvalRunResponse, error)); ok {
		return rf(ctx, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, dashboards.GenieGetEvalRunRequest) *dashboards.GenieEvalRunResponse); ok {
		r0 = rf(ctx, request)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*dashboards.GenieEvalRunResponse)
	...
	if rf, ok := ret.Get(1).(func(context.Context, dashboards.GenieGetEvalRunRequest) error); ok {
		r1 = rf(ctx, request)
	} else {
		r1 = ret.Error(1)
	}
...
// MockGenieInterface_GenieGetEvalRun_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GenieGetEvalRun'
type MockGenieInterface_GenieGetEvalRun_Call struct {
	*mock.Call
}

// GenieGetEvalRun is a helper method to define mock.On call
//   - ctx context.Context
//   - request dashboards.GenieGetEvalRunRequest
func (_e *MockGenieInterface_Expecter) GenieGetEvalRun(ctx interface{}, request interface{}) *MockGenieInterface_GenieGetEvalRun_Call {
	return &MockGenieInterface_GenieGetEvalRun_Call{Call: _e.mock.On("GenieGetEvalRun", ctx, request)}
}

func (_c *MockGenieInterface_GenieGetEvalRun_Call) Run(run func(ctx context.Context, request dashboards.GenieGetEvalRunRequest)) *MockGenieInterface_GenieGetEvalRun_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(dashboards.GenieGetEvalRunRequest))
	})
	return _c
}

func (_c *MockGenieInterface_GenieGetEvalRun_Call) Return(_a0 *dashboards.GenieEvalRunResponse, _a1 error) *MockGenieInterface_GenieGetEvalRun_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockGenieInterface_GenieGetEvalRun_Call) RunAndReturn(run func(context.Context, dashboards.GenieGetEvalRunRequest) (*dashboards.GenieEvalRunResponse, error)) *MockGenieInterface_GenieGetEvalRun_Call {
	_c.Call.Return(run)
	return _c
}

// GenieListEvalResults provides a mock function with given fields: ctx, request
func (_m *MockGenieInterface) GenieListEvalResults(ctx context.Context, request dashboards.GenieListEvalResultsRequest) (*dashboards.GenieListEvalResultsResponse, error) {
	ret := _m.Called(ctx, request)

	if len(ret) == 0 {
		panic("no return value specified for GenieListEvalResults")
	}

	var r0 *dashboards.GenieListEvalResultsResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, dashboards.GenieListEvalResultsRequest) (*dashboards.GenieListEvalResultsResponse, error)); ok {
		return rf(ctx, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, dashboards.GenieListEvalResultsRequest) *dashboards.GenieListEvalResultsResponse); ok {
		r0 = rf(ctx, request)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*dashboards.GenieListEvalResultsResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, dashboards.GenieListEvalResultsRequest) error); ok {
		r1 = rf(ctx, request)
	} else {
		r1 = ret.Error(1)
	}
...
// MockGenieInterface_GenieListEvalResults_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GenieListEvalResults'
type MockGenieInterface_GenieListEvalResults_Call struct {
	*mock.Call
}

// GenieListEvalResults is a helper method to define mock.On call
//   - ctx context.Context
//   - request dashboards.GenieListEvalResultsRequest
func (_e *MockGenieInterface_Expecter) GenieListEvalResults(ctx interface{}, request interface{}) *MockGenieInterface_GenieListEvalResults_Call {
	return &MockGenieInterface_GenieListEvalResults_Call{Call: _e.mock.On("GenieListEvalResults", ctx, request)}
}

func (_c *MockGenieInterface_GenieListEvalResults_Call) Run(run func(ctx context.Context, request dashboards.GenieListEvalResultsRequest)) *MockGenieInterface_GenieListEvalResults_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(dashboards.GenieListEvalResultsRequest))
	})
	return _c
}

func (_c *MockGenieInterface_GenieListEvalResults_Call) Return(_a0 *dashboards.GenieListEvalResultsResponse, _a1 error) *MockGenieInterface_GenieListEvalResults_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockGenieInterface_GenieListEvalResults_Call) RunAndReturn(run func(context.Context, dashboards.GenieListEvalResultsRequest) (*dashboards.GenieListEvalResultsResponse, error)) *MockGenieInterface_GenieListEvalResults_Call {
	_c.Call.Return(run)
	return _c
}

// GenieListEvalRuns provides a mock function with given fields: ctx, request
func (_m *MockGenieInterface) GenieListEvalRuns(ctx context.Context, request dashboards.GenieListEvalRunsRequest) (*dashboards.GenieListEvalRunsResponse, error) {
	ret := _m.Called(ctx, request)

	if len(ret) == 0 {
		panic("no return value specified for GenieListEvalRuns")
	}

	var r0 *dashboards.GenieListEvalRunsResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, dashboards.GenieListEvalRunsRequest) (*dashboards.GenieListEvalRunsResponse, error)); ok {
		return rf(ctx, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, dashboards.GenieListEvalRunsRequest) *dashboards.GenieListEvalRunsResponse); ok {
		r0 = rf(ctx, request)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*dashboards.GenieListEvalRunsResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, dashboards.GenieListEvalRunsRequest) error); ok {
		r1 = rf(ctx, request)
	} else {
		r1 = ret.Error(1)
	}
...
// MockGenieInterface_GenieListEvalRuns_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GenieListEvalRuns'
type MockGenieInterface_GenieListEvalRuns_Call struct {
	*mock.Call
}

// GenieListEvalRuns is a helper method to define mock.On call
//   - ctx context.Context
//   - request dashboards.GenieListEvalRunsRequest
func (_e *MockGenieInterface_Expecter) GenieListEvalRuns(ctx interface{}, request interface{}) *MockGenieInterface_GenieListEvalRuns_Call {
	return &MockGenieInterface_GenieListEvalRuns_Call{Call: _e.mock.On("GenieListEvalRuns", ctx, request)}
}

func (_c *MockGenieInterface_GenieListEvalRuns_Call) Run(run func(ctx context.Context, request dashboards.GenieListEvalRunsRequest)) *MockGenieInterface_GenieListEvalRuns_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(dashboards.GenieListEvalRunsRequest))
	})
	return _c
}

func (_c *MockGenieInterface_GenieListEvalRuns_Call) Return(_a0 *dashboards.GenieListEvalRunsResponse, _a1 error) *MockGenieInterface_GenieListEvalRuns_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockGenieInterface_GenieListEvalRuns_Call) RunAndReturn(run func(context.Context, dashboards.GenieListEvalRunsRequest) (*dashboards.GenieListEvalRunsResponse, error)) *MockGenieInterface_GenieListEvalRuns_Call {
	_c.Call.Return(run)
	return _c
}
