...
func (_m *MockAccountGroupsInterface) List(ctx context.Context, request iam.ListAccountGroupsRequest) *listing.DeduplicatingIterator[iam.Group, string] {
	ret := _m.Called(ctx, request)
...
func (_c *MockAccountGroupsInterface_List_Call) Return(_a0 *listing.DeduplicatingIterator[iam.Group, string]) *MockAccountGroupsInterface_List_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAccountGroupsInterface_List_Call) RunAndReturn(run func(context.Context, iam.ListAccountGroupsRequest) *listing.DeduplicatingIterator[iam.Group, string]) *MockAccountGroupsInterface_List_Call {
	_c.Call.Return(run)
	return _c
}
