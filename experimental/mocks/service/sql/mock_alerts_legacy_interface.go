...
type MockAlertsLegacyInterface_GetByName_Call struct {
	*mock.Call
}
...
func (_e *MockAlertsLegacyInterface_Expecter) GetByName(ctx interface{}, name interface{}) *MockAlertsLegacyInterface_GetByName_Call {
	return &MockAlertsLegacyInterface_GetByName_Call{Call: _e.mock.On("GetByName", ctx, name)}
}
...
func (_m *MockAlertsLegacyInterface) LegacyAlertNameToIdMap(ctx context.Context) (map[string]string, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for LegacyAlertNameToIdMap")
	}
...
type MockAlertsLegacyInterface_LegacyAlertNameToIdMap_Call struct {
	*mock.Call
}
...
func (_e *MockAlertsLegacyInterface_Expecter) LegacyAlertNameToIdMap(ctx interface{}) *MockAlertsLegacyInterface_LegacyAlertNameToIdMap_Call {
	return &MockAlertsLegacyInterface_LegacyAlertNameToIdMap_Call{Call: _e.mock.On("LegacyAlertNameToIdMap", ctx)}
}
