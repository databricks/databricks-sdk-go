...
func (_m *MockPolicyFamiliesInterface) List(ctx context.Context, request compute.ListPolicyFamilies) listing.Iterator[compute.PolicyFamily] {
	ret := _m.Called(ctx, request)
	...
	if rf, ok := ret.Get(0).(func(context.Context, compute.ListPolicyFamilies) listing.Iterator[compute.PolicyFamily]); ok {
		r0 = rf(ctx, request)
	} else {
		if ret.Get(0) != nil {
...
//   - ctx context.Context
//   - request compute.ListPolicyFamilies
...
func (_c *MockPolicyFamiliesInterface_List_Call) Run(run func(ctx context.Context, request compute.ListPolicyFamilies)) *MockPolicyFamiliesInterface_List_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(compute.ListPolicyFamilies))
	})
	return _c
}
...
func (_c *MockPolicyFamiliesInterface_List_Call) RunAndReturn(run func(context.Context, compute.ListPolicyFamilies) listing.Iterator[compute.PolicyFamily]) *MockPolicyFamiliesInterface_List_Call {
	_c.Call.Return(run)
	return _c
}

// ListAll provides a mock function with given fields: ctx, request
func (_m *MockPolicyFamiliesInterface) ListAll(ctx context.Context, request compute.ListPolicyFamilies) ([]compute.PolicyFamily, error) {
	ret := _m.Called(ctx, request)
	...
	var r0 []compute.PolicyFamily
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, compute.ListPolicyFamilies) ([]compute.PolicyFamily, error)); ok {
		return rf(ctx, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, compute.ListPolicyFamilies) []compute.PolicyFamily); ok {
		r0 = rf(ctx, request)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]compute.PolicyFamily)
	...
	if rf, ok := ret.Get(1).(func(context.Context, compute.ListPolicyFamilies) error); ok {
		r1 = rf(ctx, request)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockPolicyFamiliesInterface_ListAll_Call) Run(run func(ctx context.Context, request compute.ListPolicyFamilies)) *MockPolicyFamiliesInterface_ListAll_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(compute.ListPolicyFamilies))
	})
	return _c
...
func (_c *MockPolicyFamiliesInterface_ListAll_Call) RunAndReturn(run func(context.Context, compute.ListPolicyFamilies) ([]compute.PolicyFamily, error)) *MockPolicyFamiliesInterface_ListAll_Call {
	_c.Call.Return(run)
	return _c
}
