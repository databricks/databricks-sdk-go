...
// PatchEndpointThroughput provides a mock function with given fields: ctx, request
func (_m *MockVectorSearchEndpointsInterface) PatchEndpointThroughput(ctx context.Context, request vectorsearch.PatchEndpointThroughputRequest) (*vectorsearch.PatchEndpointThroughputResponse, error) {
	ret := _m.Called(ctx, request)

	if len(ret) == 0 {
		panic("no return value specified for PatchEndpointThroughput")
	}

	var r0 *vectorsearch.PatchEndpointThroughputResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, vectorsearch.PatchEndpointThroughputRequest) (*vectorsearch.PatchEndpointThroughputResponse, error)); ok {
		return rf(ctx, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, vectorsearch.PatchEndpointThroughputRequest) *vectorsearch.PatchEndpointThroughputResponse); ok {
		r0 = rf(ctx, request)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*vectorsearch.PatchEndpointThroughputResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, vectorsearch.PatchEndpointThroughputRequest) error); ok {
		r1 = rf(ctx, request)
	} else {
		r1 = ret.Error(1)
	}
...
// MockVectorSearchEndpointsInterface_PatchEndpointThroughput_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PatchEndpointThroughput'
type MockVectorSearchEndpointsInterface_PatchEndpointThroughput_Call struct {
	*mock.Call
}

// PatchEndpointThroughput is a helper method to define mock.On call
//   - ctx context.Context
//   - request vectorsearch.PatchEndpointThroughputRequest
func (_e *MockVectorSearchEndpointsInterface_Expecter) PatchEndpointThroughput(ctx interface{}, request interface{}) *MockVectorSearchEndpointsInterface_PatchEndpointThroughput_Call {
	return &MockVectorSearchEndpointsInterface_PatchEndpointThroughput_Call{Call: _e.mock.On("PatchEndpointThroughput", ctx, request)}
}

func (_c *MockVectorSearchEndpointsInterface_PatchEndpointThroughput_Call) Run(run func(ctx context.Context, request vectorsearch.PatchEndpointThroughputRequest)) *MockVectorSearchEndpointsInterface_PatchEndpointThroughput_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(vectorsearch.PatchEndpointThroughputRequest))
	})
	return _c
}

func (_c *MockVectorSearchEndpointsInterface_PatchEndpointThroughput_Call) Return(_a0 *vectorsearch.PatchEndpointThroughputResponse, _a1 error) *MockVectorSearchEndpointsInterface_PatchEndpointThroughput_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockVectorSearchEndpointsInterface_PatchEndpointThroughput_Call) RunAndReturn(run func(context.Context, vectorsearch.PatchEndpointThroughputRequest) (*vectorsearch.PatchEndpointThroughputResponse, error)) *MockVectorSearchEndpointsInterface_PatchEndpointThroughput_Call {
	_c.Call.Return(run)
	return _c
}
