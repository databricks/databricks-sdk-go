...
func (_m *MockUpdateBranchOperationInterface) EXPECT() *MockUpdateBranchOperationInterface_Expecter {
	return &MockUpdateBranchOperationInterface_Expecter{mock: &_m.Mock}
}
...
func (_e *MockUpdateBranchOperationInterface_Expecter) Done() *MockUpdateBranchOperationInterface_Done_Call {
	return &MockUpdateBranchOperationInterface_Done_Call{Call: _e.mock.On("Done")}
}
...
func (_e *MockUpdateBranchOperationInterface_Expecter) Metadata() *MockUpdateBranchOperationInterface_Metadata_Call {
	return &MockUpdateBranchOperationInterface_Metadata_Call{Call: _e.mock.On("Metadata")}
}
...
func (_e *MockUpdateBranchOperationInterface_Expecter) Name() *MockUpdateBranchOperationInterface_Name_Call {
	return &MockUpdateBranchOperationInterface_Name_Call{Call: _e.mock.On("Name")}
}
...
func (_e *MockUpdateBranchOperationInterface_Expecter) Wait(ctx interface{}, opts ...interface{}) *MockUpdateBranchOperationInterface_Wait_Call {
	return &MockUpdateBranchOperationInterface_Wait_Call{Call: _e.mock.On("Wait",
...
// NewMockUpdateBranchOperationInterface creates a new instance of MockUpdateBranchOperationInterface. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockUpdateBranchOperationInterface(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockUpdateBranchOperationInterface {
	mock := &MockUpdateBranchOperationInterface{}
	mock.Mock.Test(t)
