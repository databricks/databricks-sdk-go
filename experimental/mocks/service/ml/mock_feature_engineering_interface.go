...
// PurgeFeatureEntities provides a mock function with given fields: ctx, request
func (_m *MockFeatureEngineeringInterface) PurgeFeatureEntities(ctx context.Context, request ml.PurgeFeatureEntitiesRequest) (ml.PurgeFeatureEntitiesOperationInterface, error) {
	ret := _m.Called(ctx, request)

	if len(ret) == 0 {
		panic("no return value specified for PurgeFeatureEntities")
	}

	var r0 ml.PurgeFeatureEntitiesOperationInterface
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ml.PurgeFeatureEntitiesRequest) (ml.PurgeFeatureEntitiesOperationInterface, error)); ok {
		return rf(ctx, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ml.PurgeFeatureEntitiesRequest) ml.PurgeFeatureEntitiesOperationInterface); ok {
		r0 = rf(ctx, request)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(ml.PurgeFeatureEntitiesOperationInterface)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, ml.PurgeFeatureEntitiesRequest) error); ok {
		r1 = rf(ctx, request)
	} else {
		r1 = ret.Error(1)
	}
...
// MockFeatureEngineeringInterface_PurgeFeatureEntities_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PurgeFeatureEntities'
type MockFeatureEngineeringInterface_PurgeFeatureEntities_Call struct {
	*mock.Call
}

// PurgeFeatureEntities is a helper method to define mock.On call
//   - ctx context.Context
//   - request ml.PurgeFeatureEntitiesRequest
func (_e *MockFeatureEngineeringInterface_Expecter) PurgeFeatureEntities(ctx interface{}, request interface{}) *MockFeatureEngineeringInterface_PurgeFeatureEntities_Call {
	return &MockFeatureEngineeringInterface_PurgeFeatureEntities_Call{Call: _e.mock.On("PurgeFeatureEntities", ctx, request)}
}

func (_c *MockFeatureEngineeringInterface_PurgeFeatureEntities_Call) Run(run func(ctx context.Context, request ml.PurgeFeatureEntitiesRequest)) *MockFeatureEngineeringInterface_PurgeFeatureEntities_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(ml.PurgeFeatureEntitiesRequest))
	})
	return _c
}

func (_c *MockFeatureEngineeringInterface_PurgeFeatureEntities_Call) Return(_a0 ml.PurgeFeatureEntitiesOperationInterface, _a1 error) *MockFeatureEngineeringInterface_PurgeFeatureEntities_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockFeatureEngineeringInterface_PurgeFeatureEntities_Call) RunAndReturn(run func(context.Context, ml.PurgeFeatureEntitiesRequest) (ml.PurgeFeatureEntitiesOperationInterface, error)) *MockFeatureEngineeringInterface_PurgeFeatureEntities_Call {
	_c.Call.Return(run)
	return _c
}
