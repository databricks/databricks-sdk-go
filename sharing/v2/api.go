...
func NewProviders(client *client.DatabricksClient,
) *ProvidersAPI {
	return &ProvidersAPI{
...
func NewRecipientActivation(client *client.DatabricksClient,
...
func NewRecipients(client *client.DatabricksClient,
) *RecipientsAPI {
...
func NewShares(client *client.DatabricksClient,
) *SharesAPI {
	return &SharesAPI{
