...
type providersBaseClient struct {
	providersImpl
}
...
func (a *providersBaseClient) DeleteByName(ctx context.Context, name string) (*DeleteResponse, error) {
...
// provider.
func (a *providersBaseClient) GetByName(ctx context.Context, name string) (*ProviderInfo, error) {
	return a.providersImpl.Get(ctx, GetProviderRequest{
		Name: name,
	})
}

// ProviderInfoNameToMetastoreIdMap calls [providersBaseClient.ListAll] and creates a map of results with [ProviderInfo].Name as key and [ProviderInfo].MetastoreId as value.
//
...
func (a *providersBaseClient) ProviderInfoNameToMetastoreIdMap(ctx context.Context, request ListProvidersRequest) (map[string]string, error) {
...
func (a *providersBaseClient) ListProviderShareAssetsByProviderNameAndShareName(ctx context.Context, providerName string, shareName string) (*ListProviderShareAssetsResponse, error) {
...
func (a *providersBaseClient) ListSharesByName(ctx context.Context, name string) (*ListProviderSharesResponse, error) {
	return a.providersImpl.internalListShares(ctx, ListSharesRequest{
		Name: name,
	})
}

type recipientActivationBaseClient struct {
...
func (a *recipientActivationBaseClient) GetActivationUrlInfoByActivationUrl(ctx context.Context, activationUrl string) (*GetActivationUrlInfoResponse, error) {
...
// any authentication.
func (a *recipientActivationBaseClient) RetrieveTokenByActivationUrl(ctx context.Context, activationUrl string) (*RetrieveTokenResponse, error) {
	return a.recipientActivationImpl.RetrieveToken(ctx, RetrieveTokenRequest{
		ActivationUrl: activationUrl,
	})
}

type recipientsBaseClient struct {
	recipientsImpl
}
...
func (a *recipientsBaseClient) DeleteByName(ctx context.Context, name string) (*DeleteResponse, error) {
...
func (a *recipientsBaseClient) GetByName(ctx context.Context, name string) (*RecipientInfo, error) {
...
func (a *recipientsBaseClient) SharePermissionsByName(ctx context.Context, name string) (*GetRecipientSharePermissionsResponse, error) {
	return a.recipientsImpl.SharePermissions(ctx, SharePermissionsRequest{
		Name: name,
	})
}

type sharesBaseClient struct {
	sharesImpl
}
...
// of the share.
func (a *sharesBaseClient) DeleteByName(ctx context.Context, name string) (*DeleteResponse, error) {
...
func (a *sharesBaseClient) GetByName(ctx context.Context, name string) (*ShareInfo, error) {
...
func (a *sharesBaseClient) SharePermissionsByName(ctx context.Context, name string) (*GetSharePermissionsResponse, error) {
