...
// These APIs allow you to manage Providers Preview, Recipient Activation Preview, Recipients Preview, Shares Preview, etc.
...
type ProvidersPreviewInterface interface {
	...
	// ProviderInfoNameToMetastoreIdMap calls [ProvidersPreviewAPI.ListAll] and creates a map of results with [ProviderInfo].Name as key and [ProviderInfo].MetastoreId as value.
	//
...
func NewProvidersPreview(client *client.DatabricksClient) *ProvidersPreviewAPI {
	return &ProvidersPreviewAPI{
		providersPreviewImpl: providersPreviewImpl{
			client: client,
		},
	}
}
...
// shared data.
type ProvidersPreviewAPI struct {
	providersPreviewImpl
}
...
// Deletes an authentication provider, if the caller is a metastore admin or is
// the owner of the provider.
func (a *ProvidersPreviewAPI) DeleteByName(ctx context.Context, name string) error {
	return a.providersPreviewImpl.Delete(ctx, DeleteProviderRequest{
		Name: name,
	})
}
...
// the provider, and must either be a metastore admin or the owner of the
// provider.
func (a *ProvidersPreviewAPI) GetByName(ctx context.Context, name string) (*ProviderInfo, error) {
	return a.providersPreviewImpl.Get(ctx, GetProviderRequest{
		Name: name,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *ProvidersPreviewAPI) ProviderInfoNameToMetastoreIdMap(ctx context.Context, request ListProvidersRequest) (map[string]string, error) {
...
//
// * the caller is a metastore admin, or * the caller is the owner.
func (a *ProvidersPreviewAPI) ListSharesByName(ctx context.Context, name string) (*ListProviderSharesResponse, error) {
	return a.providersPreviewImpl.internalListShares(ctx, ListSharesRequest{
		Name: name,
	})
}

type RecipientActivationPreviewInterface interface {
...
func NewRecipientActivationPreview(client *client.DatabricksClient) *RecipientActivationPreviewAPI {
	return &RecipientActivationPreviewAPI{
		recipientActivationPreviewImpl: recipientActivationPreviewImpl{
			client: client,
		},
	}
}
...
// their organization.
type RecipientActivationPreviewAPI struct {
	recipientActivationPreviewImpl
}

// Get a share activation URL.
//
// Gets an activation URL for a share.
func (a *RecipientActivationPreviewAPI) GetActivationUrlInfoByActivationUrl(ctx context.Context, activationUrl string) error {
	return a.recipientActivationPreviewImpl.GetActivationUrlInfo(ctx, GetActivationUrlInfoRequest{
...
// Retrieve access token with an activation url. This is a public API without
// any authentication.
func (a *RecipientActivationPreviewAPI) RetrieveTokenByActivationUrl(ctx context.Context, activationUrl string) (*RetrieveTokenResponse, error) {
	return a.recipientActivationPreviewImpl.RetrieveToken(ctx, RetrieveTokenRequest{
		ActivationUrl: activationUrl,
	})
}

type RecipientsPreviewInterface interface {
...
func NewRecipientsPreview(client *client.DatabricksClient) *RecipientsPreviewAPI {
	return &RecipientsPreviewAPI{
		recipientsPreviewImpl: recipientsPreviewImpl{
			client: client,
		},
	}
}
...
type RecipientsPreviewAPI struct {
	recipientsPreviewImpl
}
...
// Deletes the specified recipient from the metastore. The caller must be the
// owner of the recipient.
func (a *RecipientsPreviewAPI) DeleteByName(ctx context.Context, name string) error {
	return a.recipientsPreviewImpl.Delete(ctx, DeleteRecipientRequest{
		Name: name,
	})
}
...
//
// * the caller is the owner of the share recipient, or: * is a metastore admin
func (a *RecipientsPreviewAPI) GetByName(ctx context.Context, name string) (*RecipientInfo, error) {
	return a.recipientsPreviewImpl.Get(ctx, GetRecipientRequest{
		Name: name,
	})
}
...
// Gets the share permissions for the specified Recipient. The caller must be a
// metastore admin or the owner of the Recipient.
func (a *RecipientsPreviewAPI) SharePermissionsByName(ctx context.Context, name string) (*GetRecipientSharePermissionsResponse, error) {
	return a.recipientsPreviewImpl.SharePermissions(ctx, SharePermissionsRequest{
		Name: name,
	})
}

type SharesPreviewInterface interface {
	...
	// Gets the permissions for a data share from the metastore. The caller must be
	// a metastore admin or the owner of the share.
	SharePermissionsByName(ctx context.Context, name string) (*PermissionsList, error)
...
func NewSharesPreview(client *client.DatabricksClient) *SharesPreviewAPI {
	return &SharesPreviewAPI{
		sharesPreviewImpl: sharesPreviewImpl{
			client: client,
		},
	}
}
...
// Deletes a data object share from the metastore. The caller must be an owner
// of the share.
func (a *SharesPreviewAPI) DeleteByName(ctx context.Context, name string) error {
	return a.sharesPreviewImpl.Delete(ctx, DeleteShareRequest{
		Name: name,
	})
}
...
// Gets a data object share from the metastore. The caller must be a metastore
// admin or the owner of the share.
func (a *SharesPreviewAPI) GetByName(ctx context.Context, name string) (*ShareInfo, error) {
	return a.sharesPreviewImpl.Get(ctx, GetShareRequest{
		Name: name,
	})
}
...
// Gets the permissions for a data share from the metastore. The caller must be
// a metastore admin or the owner of the share.
func (a *SharesPreviewAPI) SharePermissionsByName(ctx context.Context, name string) (*PermissionsList, error) {
	return a.sharesPreviewImpl.SharePermissions(ctx, SharePermissionsRequest{
		Name: name,
	})
}
