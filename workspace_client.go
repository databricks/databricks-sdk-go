...
type WorkspaceClient struct {
	...
	AccountAccessControlProxy iam.AccountAccessControlProxyAPIInterface
	...
	ArtifactAllowlists catalog.ArtifactAllowlistsAPIInterface
	...
	Catalogs catalog.CatalogsAPIInterface
	...
	CleanRooms sharing.CleanRoomsAPIInterface
	...
	ClusterPolicies compute.ClusterPoliciesAPIInterface
	...
	Clusters compute.ClustersAPIInterface

	// This API allows execution of Python, Scala, SQL, or R commands on running
	// Databricks Clusters.
	CommandExecution compute.CommandExecutionAPIInterface
	...
	Connections catalog.ConnectionsAPIInterface
	...
	CredentialsManager settings.CredentialsManagerAPIInterface

	// This API allows retrieving information about currently authenticated user
	// or service principal.
	CurrentUser iam.CurrentUserAPIInterface
	...
	DashboardWidgets sql.DashboardWidgetsAPIInterface
	...
	// scheduled using the `sql_task` type of the Jobs API, e.g.
	// :method:jobs/create.
	Dashboards sql.DashboardsAPIInterface
	...
	DataSources sql.DataSourcesAPIInterface
	...
	DbsqlPermissions sql.DbsqlPermissionsAPIInterface
	...
	Experiments ml.ExperimentsAPIInterface
	...
	Functions catalog.FunctionsAPIInterface
	...
	GitCredentials workspace.GitCredentialsAPIInterface
	...
	GlobalInitScripts compute.GlobalInitScriptsAPIInterface
	...
	Grants catalog.GrantsAPIInterface
	...
	InstancePools compute.InstancePoolsAPIInterface
	...
	InstanceProfiles compute.InstanceProfilesAPIInterface
	...
	IpAccessLists settings.IpAccessListsAPIInterface
	...
	Libraries compute.LibrariesAPIInterface
	...
	Metastores catalog.MetastoresAPIInterface
	...
	// Models.
	ModelRegistry ml.ModelRegistryAPIInterface
	...
	ModelVersions catalog.ModelVersionsAPIInterface
	...
	Permissions iam.PermissionsAPIInterface
	...
	Pipelines pipelines.PipelinesAPIInterface
	...
	PolicyFamilies compute.PolicyFamiliesAPIInterface
	...
	Providers sharing.ProvidersAPIInterface
	...
	// scheduled using the `sql_task` type of the Jobs API, e.g.
	// :method:jobs/create.
	Queries sql.QueriesAPIInterface

	// Access the history of queries through SQL warehouses.
	QueryHistory sql.QueryHistoryAPIInterface

	// This is an evolving API that facilitates the addition and removal of
	// vizualisations from existing queries within the Databricks Workspace.
	// Data structures may change over time.
	QueryVisualizations sql.QueryVisualizationsAPIInterface
	...
	RecipientActivation sharing.RecipientActivationAPIInterface
	...
	Recipients sharing.RecipientsAPIInterface
	...
	// the securable type.
	RegisteredModels catalog.RegisteredModelsAPIInterface
	...
	Repos workspace.ReposAPIInterface
	...
	Schemas catalog.SchemasAPIInterface
	...
	Secrets workspace.SecretsAPIInterface
	...
	// data by accident.
	ServicePrincipals iam.ServicePrincipalsAPIInterface
	...
	ServingEndpoints serving.ServingEndpointsAPIInterface
	...
	Settings settings.SettingsAPIInterface
	...
	Shares sharing.SharesAPIInterface
	...
	StatementExecution sql.StatementExecutionAPIInterface
	...
	StorageCredentials catalog.StorageCredentialsAPIInterface
	...
	SystemSchemas catalog.SystemSchemasAPIInterface
	...
	// on existing tables.
	TableConstraints catalog.TableConstraintsAPIInterface
	...
	Tables catalog.TablesAPIInterface
	...
	TokenManagement settings.TokenManagementAPIInterface
	...
	Tokens settings.TokensAPIInterface
	...
	// ETL.
	Volumes catalog.VolumesAPIInterface
	...
	Warehouses sql.WarehousesAPIInterface
	...
	Workspace workspace.WorkspaceAPIInterface
	...
	WorkspaceBindings catalog.WorkspaceBindingsAPIInterface

	// This API allows updating known workspace settings for advanced users.
	WorkspaceConf settings.WorkspaceConfAPIInterface
}
