...
type PipelinesPreviewInterface interface {
	...
	// PipelineStateInfoNameToPipelineIdMap calls [PipelinesPreviewAPI.ListPipelinesAll] and creates a map of results with [PipelineStateInfo].Name as key and [PipelineStateInfo].PipelineId as value.
	//
	...
	// GetByName calls [PipelinesPreviewAPI.PipelineStateInfoNameToPipelineIdMap] and returns a single [PipelineStateInfo].
	//
	// Returns an error if there's more than one [PipelineStateInfo] with the same .Name.
	//
...
func NewPipelinesPreview(client *client.DatabricksClient) *PipelinesPreviewAPI {
	return &PipelinesPreviewAPI{
		pipelinesPreviewImpl: pipelinesPreviewImpl{
			client: client,
		},
	}
}
...
// those expectations.
type PipelinesPreviewAPI struct {
	pipelinesPreviewImpl
}

// Delete a pipeline.
//
// Deletes a pipeline.
func (a *PipelinesPreviewAPI) DeleteByPipelineId(ctx context.Context, pipelineId string) error {
	return a.pipelinesPreviewImpl.Delete(ctx, DeletePipelineRequest{
		PipelineId: pipelineId,
	})
}

// Get a pipeline.
func (a *PipelinesPreviewAPI) GetByPipelineId(ctx context.Context, pipelineId string) (*GetPipelineResponse, error) {
	return a.pipelinesPreviewImpl.Get(ctx, GetPipelineRequest{
		PipelineId: pipelineId,
	})
}
...
//
// Gets the permission levels that a user can have on an object.
func (a *PipelinesPreviewAPI) GetPermissionLevelsByPipelineId(ctx context.Context, pipelineId string) (*GetPipelinePermissionLevelsResponse, error) {
	return a.pipelinesPreviewImpl.GetPermissionLevels(ctx, GetPipelinePermissionLevelsRequest{
		PipelineId: pipelineId,
	})
}
...
// Gets the permissions of a pipeline. Pipelines can inherit permissions from
// their root object.
func (a *PipelinesPreviewAPI) GetPermissionsByPipelineId(ctx context.Context, pipelineId string) (*PipelinePermissions, error) {
	return a.pipelinesPreviewImpl.GetPermissions(ctx, GetPipelinePermissionsRequest{
		PipelineId: pipelineId,
	})
}
...
//
// Gets an update from an active pipeline.
func (a *PipelinesPreviewAPI) GetUpdateByPipelineIdAndUpdateId(ctx context.Context, pipelineId string, updateId string) (*GetUpdateResponse, error) {
	return a.pipelinesPreviewImpl.GetUpdate(ctx, GetUpdateRequest{
		PipelineId: pipelineId,
		UpdateId:   updateId,
	})
}
...
//
// Retrieves events for a pipeline.
func (a *PipelinesPreviewAPI) ListPipelineEventsByPipelineId(ctx context.Context, pipelineId string) (*ListPipelineEventsResponse, error) {
	return a.pipelinesPreviewImpl.internalListPipelineEvents(ctx, ListPipelineEventsRequest{
		PipelineId: pipelineId,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *PipelinesPreviewAPI) PipelineStateInfoNameToPipelineIdMap(ctx context.Context, request ListPipelinesRequest) (map[string]string, error) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *PipelinesPreviewAPI) GetByName(ctx context.Context, name string) (*PipelineStateInfo, error) {
...
//
// List updates for an active pipeline.
func (a *PipelinesPreviewAPI) ListUpdatesByPipelineId(ctx context.Context, pipelineId string) (*ListUpdatesResponse, error) {
	return a.pipelinesPreviewImpl.ListUpdates(ctx, ListUpdatesRequest{
		PipelineId: pipelineId,
	})
}
