...
type AccountClient struct {
	...
	// These APIs manage Log delivery configurations for this account. Log
	// delivery configs enable you to configure the delivery of the specified
	// type of logs to your storage account.
