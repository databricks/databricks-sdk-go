...
// These APIs allow you to manage Credentials Preview, Encryption Keys Preview, Networks Preview, Private Access Preview, Storage Preview, Vpc Endpoints Preview, Workspaces Preview, etc.
...
type CredentialsPreviewInterface interface {
	...
	// CredentialCredentialsNameToCredentialsIdMap calls [CredentialsPreviewAPI.List] and creates a map of results with [Credential].CredentialsName as key and [Credential].CredentialsId as value.
	//
	...
	// GetByCredentialsName calls [CredentialsPreviewAPI.CredentialCredentialsNameToCredentialsIdMap] and returns a single [Credential].
	//
	// Returns an error if there's more than one [Credential] with the same .CredentialsName.
	//
...
// specified by ID. You cannot delete a credential that is associated with any
// workspace.
func (a *CredentialsPreviewAPI) DeleteByCredentialsId(ctx context.Context, credentialsId string) error {
	return a.credentialsPreviewImpl.Delete(ctx, DeleteCredentialRequest{
...
// Gets a Databricks credential configuration object for an account, both
// specified by ID.
func (a *CredentialsPreviewAPI) GetByCredentialsId(ctx context.Context, credentialsId string) (*Credential, error) {
	return a.credentialsPreviewImpl.Get(ctx, GetCredentialRequest{
		CredentialsId: credentialsId,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *CredentialsPreviewAPI) CredentialCredentialsNameToCredentialsIdMap(ctx context.Context) (map[string]string, error) {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *CredentialsPreviewAPI) GetByCredentialsName(ctx context.Context, name string) (*Credential, error) {
...
type EncryptionKeysPreviewInterface interface {
...
func NewEncryptionKeysPreview(client *client.DatabricksClient) *EncryptionKeysPreviewAPI {
	return &EncryptionKeysPreviewAPI{
		encryptionKeysPreviewImpl: encryptionKeysPreviewImpl{
			client: client,
		},
	}
}
...
type EncryptionKeysPreviewAPI struct {
	encryptionKeysPreviewImpl
}
...
// Deletes a customer-managed key configuration object for an account. You
// cannot delete a configuration that is associated with a running workspace.
func (a *EncryptionKeysPreviewAPI) DeleteByCustomerManagedKeyId(ctx context.Context, customerManagedKeyId string) error {
	return a.encryptionKeysPreviewImpl.Delete(ctx, DeleteEncryptionKeyRequest{
...
// This operation is available only if your account is on the E2 version of the
// platform.",
func (a *EncryptionKeysPreviewAPI) GetByCustomerManagedKeyId(ctx context.Context, customerManagedKeyId string) (*CustomerManagedKey, error) {
	return a.encryptionKeysPreviewImpl.Get(ctx, GetEncryptionKeyRequest{
		CustomerManagedKeyId: customerManagedKeyId,
	})
}

type NetworksPreviewInterface interface {
	...
	// NetworkNetworkNameToNetworkIdMap calls [NetworksPreviewAPI.List] and creates a map of results with [Network].NetworkName as key and [Network].NetworkId as value.
	//
	...
	// GetByNetworkName calls [NetworksPreviewAPI.NetworkNetworkNameToNetworkIdMap] and returns a single [Network].
	//
	// Returns an error if there's more than one [Network] with the same .NetworkName.
	//
...
func NewNetworksPreview(client *client.DatabricksClient) *NetworksPreviewAPI {
	return &NetworksPreviewAPI{
		networksPreviewImpl: networksPreviewImpl{
			client: client,
		},
	}
}
...
type NetworksPreviewAPI struct {
	networksPreviewImpl
}
...
// This operation is available only if your account is on the E2 version of the
// platform.
func (a *NetworksPreviewAPI) DeleteByNetworkId(ctx context.Context, networkId string) error {
	return a.networksPreviewImpl.Delete(ctx, DeleteNetworkRequest{
		NetworkId: networkId,
	})
}
...
// Gets a Databricks network configuration, which represents a cloud VPC and its
// resources.
func (a *NetworksPreviewAPI) GetByNetworkId(ctx context.Context, networkId string) (*Network, error) {
	return a.networksPreviewImpl.Get(ctx, GetNetworkRequest{
		NetworkId: networkId,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *NetworksPreviewAPI) NetworkNetworkNameToNetworkIdMap(ctx context.Context) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
	result, err := a.List(ctx)
	if err != nil {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *NetworksPreviewAPI) GetByNetworkName(ctx context.Context, name string) (*Network, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "get-by-name")
	result, err := a.List(ctx)
	if err != nil {
		return nil, err
...
type PrivateAccessPreviewInterface interface {
	...
	// PrivateAccessSettingsPrivateAccessSettingsNameToPrivateAccessSettingsIdMap calls [PrivateAccessPreviewAPI.List] and creates a map of results with [PrivateAccessSettings].PrivateAccessSettingsName as key and [PrivateAccessSettings].PrivateAccessSettingsId as value.
	//
	...
	// GetByPrivateAccessSettingsName calls [PrivateAccessPreviewAPI.PrivateAccessSettingsPrivateAccessSettingsNameToPrivateAccessSettingsIdMap] and returns a single [PrivateAccessSettings].
	//
	// Returns an error if there's more than one [PrivateAccessSettings] with the same .PrivateAccessSettingsName.
	//
...
func NewPrivateAccessPreview(client *client.DatabricksClient) *PrivateAccessPreviewAPI {
	return &PrivateAccessPreviewAPI{
		privateAccessPreviewImpl: privateAccessPreviewImpl{
			client: client,
		},
	}
}
...
type PrivateAccessPreviewAPI struct {
	privateAccessPreviewImpl
}
...
// [AWS PrivateLink]: https://aws.amazon.com/privatelink
// [Databricks article about PrivateLink]: https://docs.databricks.com/administration-guide/cloud-configurations/aws/privatelink.html
func (a *PrivateAccessPreviewAPI) DeleteByPrivateAccessSettingsId(ctx context.Context, privateAccessSettingsId string) error {
	return a.privateAccessPreviewImpl.Delete(ctx, DeletePrivateAccesRequest{
...
// [AWS PrivateLink]: https://aws.amazon.com/privatelink
// [Databricks article about PrivateLink]: https://docs.databricks.com/administration-guide/cloud-configurations/aws/privatelink.html
func (a *PrivateAccessPreviewAPI) GetByPrivateAccessSettingsId(ctx context.Context, privateAccessSettingsId string) (*PrivateAccessSettings, error) {
	return a.privateAccessPreviewImpl.Get(ctx, GetPrivateAccesRequest{
		PrivateAccessSettingsId: privateAccessSettingsId,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *PrivateAccessPreviewAPI) PrivateAccessSettingsPrivateAccessSettingsNameToPrivateAccessSettingsIdMap(ctx context.Context) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
	result, err := a.List(ctx)
	if err != nil {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *PrivateAccessPreviewAPI) GetByPrivateAccessSettingsName(ctx context.Context, name string) (*PrivateAccessSettings, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "get-by-name")
	result, err := a.List(ctx)
	if err != nil {
		return nil, err
...
type StoragePreviewInterface interface {
	...
	// StorageConfigurationStorageConfigurationNameToStorageConfigurationIdMap calls [StoragePreviewAPI.List] and creates a map of results with [StorageConfiguration].StorageConfigurationName as key and [StorageConfiguration].StorageConfigurationId as value.
	//
	...
	// GetByStorageConfigurationName calls [StoragePreviewAPI.StorageConfigurationStorageConfigurationNameToStorageConfigurationIdMap] and returns a single [StorageConfiguration].
	//
	// Returns an error if there's more than one [StorageConfiguration] with the same .StorageConfigurationName.
	//
...
func NewStoragePreview(client *client.DatabricksClient) *StoragePreviewAPI {
	return &StoragePreviewAPI{
		storagePreviewImpl: storagePreviewImpl{
			client: client,
		},
	}
}
...
// Deletes a Databricks storage configuration. You cannot delete a storage
// configuration that is associated with any workspace.
func (a *StoragePreviewAPI) DeleteByStorageConfigurationId(ctx context.Context, storageConfigurationId string) error {
	return a.storagePreviewImpl.Delete(ctx, DeleteStorageRequest{
...
//
// Gets a Databricks storage configuration for an account, both specified by ID.
func (a *StoragePreviewAPI) GetByStorageConfigurationId(ctx context.Context, storageConfigurationId string) (*StorageConfiguration, error) {
	return a.storagePreviewImpl.Get(ctx, GetStorageRequest{
		StorageConfigurationId: storageConfigurationId,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *StoragePreviewAPI) StorageConfigurationStorageConfigurationNameToStorageConfigurationIdMap(ctx context.Context) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
	result, err := a.List(ctx)
	if err != nil {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *StoragePreviewAPI) GetByStorageConfigurationName(ctx context.Context, name string) (*StorageConfiguration, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "get-by-name")
	result, err := a.List(ctx)
	if err != nil {
		return nil, err
...
type VpcEndpointsPreviewInterface interface {
	...
	// VpcEndpointVpcEndpointNameToVpcEndpointIdMap calls [VpcEndpointsPreviewAPI.List] and creates a map of results with [VpcEndpoint].VpcEndpointName as key and [VpcEndpoint].VpcEndpointId as value.
	//
	...
	// GetByVpcEndpointName calls [VpcEndpointsPreviewAPI.VpcEndpointVpcEndpointNameToVpcEndpointIdMap] and returns a single [VpcEndpoint].
	//
	// Returns an error if there's more than one [VpcEndpoint] with the same .VpcEndpointName.
	//
...
func NewVpcEndpointsPreview(client *client.DatabricksClient) *VpcEndpointsPreviewAPI {
	return &VpcEndpointsPreviewAPI{
		vpcEndpointsPreviewImpl: vpcEndpointsPreviewImpl{
			client: client,
		},
	}
}
...
type VpcEndpointsPreviewAPI struct {
	vpcEndpointsPreviewImpl
}
...
// [AWS VPC endpoint]: https://docs.aws.amazon.com/vpc/latest/privatelink/concepts.html
// [Databricks article about PrivateLink]: https://docs.databricks.com/administration-guide/cloud-configurations/aws/privatelink.html
func (a *VpcEndpointsPreviewAPI) DeleteByVpcEndpointId(ctx context.Context, vpcEndpointId string) error {
	return a.vpcEndpointsPreviewImpl.Delete(ctx, DeleteVpcEndpointRequest{
...
// [AWS PrivateLink]: https://aws.amazon.com/privatelink
// [VPC endpoint]: https://docs.aws.amazon.com/vpc/latest/privatelink/concepts.html
func (a *VpcEndpointsPreviewAPI) GetByVpcEndpointId(ctx context.Context, vpcEndpointId string) (*VpcEndpoint, error) {
	return a.vpcEndpointsPreviewImpl.Get(ctx, GetVpcEndpointRequest{
		VpcEndpointId: vpcEndpointId,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *VpcEndpointsPreviewAPI) VpcEndpointVpcEndpointNameToVpcEndpointIdMap(ctx context.Context) (map[string]string, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
	mapping := map[string]string{}
	result, err := a.List(ctx)
	if err != nil {
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *VpcEndpointsPreviewAPI) GetByVpcEndpointName(ctx context.Context, name string) (*VpcEndpoint, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "get-by-name")
	result, err := a.List(ctx)
	if err != nil {
		return nil, err
...
type WorkspacesPreviewInterface interface {
	...
	// WorkspaceWorkspaceNameToWorkspaceIdMap calls [WorkspacesPreviewAPI.List] and creates a map of results with [Workspace].WorkspaceName as key and [Workspace].WorkspaceId as value.
	//
	...
	// GetByWorkspaceName calls [WorkspacesPreviewAPI.WorkspaceWorkspaceNameToWorkspaceIdMap] and returns a single [Workspace].
	//
	// Returns an error if there's more than one [Workspace] with the same .WorkspaceName.
	//
...
func NewWorkspacesPreview(client *client.DatabricksClient) *WorkspacesPreviewAPI {
	return &WorkspacesPreviewAPI{
		workspacesPreviewImpl: workspacesPreviewImpl{
			client: client,
		},
	}
}
...
// platform or on a select custom plan that allows multiple workspaces per
// account.
type WorkspacesPreviewAPI struct {
...
// platform or on a select custom plan that allows multiple workspaces per
// account.
func (a *WorkspacesPreviewAPI) DeleteByWorkspaceId(ctx context.Context, workspaceId int64) error {
	return a.workspacesPreviewImpl.Delete(ctx, DeleteWorkspaceRequest{
...
//
// [Create a new workspace using the Account API]: http://docs.databricks.com/administration-guide/account-api/new-workspace.html
func (a *WorkspacesPreviewAPI) GetByWorkspaceId(ctx context.Context, workspaceId int64) (*Workspace, error) {
	return a.workspacesPreviewImpl.Get(ctx, GetWorkspaceRequest{
		WorkspaceId: workspaceId,
	})
}
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *WorkspacesPreviewAPI) WorkspaceWorkspaceNameToWorkspaceIdMap(ctx context.Context) (map[string]int64, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "name-to-id")
...
//
// This method is generated by Databricks SDK Code Generator.
func (a *WorkspacesPreviewAPI) GetByWorkspaceName(ctx context.Context, name string) (*Workspace, error) {
	ctx = useragent.InContext(ctx, "sdk-feature", "get-by-name")
	result, err := a.List(ctx)
	if err != nil {
		return nil, err
