...
func (a *workspacesBaseClient) Create(ctx context.Context, createWorkspaceRequest CreateWorkspaceRequest) (*WorkspacesCreateWaiter, error) {
...
// [Create a new workspace using the Account API]: http://docs.databricks.com/administration-guide/account-api/new-workspace.html
func (a *workspacesBaseClient) Update(ctx context.Context, updateWorkspaceRequest UpdateWorkspaceRequest) (*WorkspacesUpdateWaiter, error) {
